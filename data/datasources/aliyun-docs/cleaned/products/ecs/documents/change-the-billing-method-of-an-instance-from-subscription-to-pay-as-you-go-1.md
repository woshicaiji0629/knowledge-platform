...
如需转换多个实例，可使用[在实例列表页执行批量操作](user-guide/batch-operation-of-ecs-instances-through-the-ecs-console.md)功能，单次最多支持转换20台实例。
## API
可以通过API接口[ModifyInstanceChargeType](api-modifyinstancechargetype.md)将包年包月ECS实例转换为按量付费ECS实例。
## 常见问题
