...
在自定义购买页，系统将自动填充地域与镜像信息，根据界面提示完成其他[配置项](create-an-instance-by-using-the-wizard.md)后单击确认下单。
## CLI
...
## API
在通过[RunInstances](../developer-reference/api-ecs-2014-05-26-runinstances.md)或[CreateInstance](../developer-reference/api-ecs-2014-05-26-createinstance.md)创建实例时，可配置ImageId为需要使用的自定义镜像的ID。
## 后续操作
...
## 计费说明
基于付费商业镜像制作的镜像创建ECS实例时会产生[额外费用](../images.md)。
## 常见问题
