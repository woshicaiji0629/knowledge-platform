...
调用[AttachPolicyToRole](../../../ram/documents/developer-reference/api-ram-2015-05-01-attachpolicytorole.md)接口为实例RAM角色授权。
### 步骤二：为ECS实例授予RAM角色
将创建好的角色身份赋予指定的ECS实例。
控制台
...
访问阿里云OpenAPI时，如果在代码中硬编码明文AK，容易因代码仓库权限管理不当造成AK泄露，建议通过非AccessKey硬编码的方式编程，[使用访问凭据访问阿里云](../../../ram/documents/use-cases/best-practices-for-programmatic-access-to-alibaba-cloud.md)[OpenAPI](../../../ram/documents/use-cases/best-practices-for-programmatic-access-to-alibaba-cloud.md)。
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
