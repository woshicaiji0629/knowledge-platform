...
### 计费说明
计费项及计费规则
弹性临时盘收取云盘容量费，支持按量付费和包年包月。详细的计费规则，请参见[弹性临时盘计费](../block-storage-devices.md)。
定价
...
### 实例规格限制
弹性临时盘支持以下实例规格族：
[海光通用型实例规格族](general-purpose-instance-families.md)[g9h](general-purpose-instance-families.md)
[存储增强通用型实例规格族](overview-of-instance-families.md)[g8ise](overview-of-instance-families.md)
[通用型实例规格族](general-purpose-instance-families.md)[g8a](general-purpose-instance-families.md)
[通用型实例规格族](general-purpose-instance-families.md)[g8i](general-purpose-instance-families.md)
[通用型实例规格族](general-purpose-instance-families.md)[g8y](general-purpose-instance-families.md)
[计算型实例规格族](compute-optimized-instance-families.md)[c8a](compute-optimized-instance-families.md)
[计算型实例规格族](compute-optimized-instance-families.md)[c8i](compute-optimized-instance-families.md)
[计算型实例规格族](compute-optimized-instance-families.md)[c8y](compute-optimized-instance-families.md)
[内存型实例规格族](memory-optimized-instance-families-1.md)[r8a](memory-optimized-instance-families-1.md)
[内存型实例规格族](memory-optimized-instance-families-1.md)[r8i](memory-optimized-instance-families-1.md)
[内存型实例规格族](memory-optimized-instance-families-1.md)[r8y](memory-optimized-instance-families-1.md)
...
### 其他操作
弹性临时盘与云盘功能相比有一些使用限制，仅支持以下操作。使用限制的详细信息，请参见[功能限制](elastic-ephemeral-disks.md)。
支持的详细操作可参考云盘相关文档：
[挂载数据盘](attach-a-data-disk.md)
[初始化数据盘](initialize-a-data-disk.md)
[扩容云盘](resize-cloud-disks.md)
[修改云盘标签](modify-the-tags-of-a-disk.md)
[转换云盘计费方式](../switch-the-billing-method-of-a-disk.md)
[卸载数据盘](detach-a-data-disk.md)
[释放云盘](release-a-disk.md)
## 常见问题
如何理解弹性临时盘的可靠性？
