...
## 账单查询
请参见[查看抢占式实例账单](view-billing-details.md)。
## 欠费说明
如果账号内存在欠费账单，您无法正常使用抢占式实例资源。欠费会导致ECS实例停机，甚至释放资源。请尽快充值结清欠费账单，避免因资源的停机或释放而影响业务。
## 相关文档
[什么是抢占式实例](user-guide/what-is-a-spot-instance.md)
[创建抢占式实例](user-guide/create-a-spot-instance.md)
[抢占式实例最佳实践](use-cases/best-practices-for-preemptible-instances.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
