...
## 相关API
[查询域名配置](../developer-reference/api-cdn-2018-05-10-describecdndomainconfigs.md)
[域名配置功能函数](../developer-reference/parameters-for-configuring-features-for-domain-names.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
