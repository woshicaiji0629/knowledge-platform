...
## 前提条件
源站服务器支持HTTP Range请求。
关闭[忽略参数](ignore-parameters.md)功能。
## 文件格式说明
...
## 相关文档
[批量配置域名](../api-batchsetcdndomainconfig.md)来实现视频点播功能，更多信息请参考[域名配置功能函数](../developer-reference/parameters-for-configuring-features-for-domain-names.md)。
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
