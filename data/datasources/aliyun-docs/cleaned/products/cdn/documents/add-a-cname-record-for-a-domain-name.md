...
## 前提条件
您已开通了CDN服务。如果未开通，请先[开通](activate-alibaba-cloud-cdn.md)[CDN](activate-alibaba-cloud-cdn.md)[服务](activate-alibaba-cloud-cdn.md)。
您已成功添加了加速域名。如果没有添加，请参见[添加加速域名](add-a-domain-name.md)。
## 注意事项
...
[解决](cname-record-does-not-take-effect.md)[CNAME](cname-record-does-not-take-effect.md)[解析未生效](cname-record-does-not-take-effect.md)
[CDN](use-cases/accelerate-the-retrieval-of-resources-from-an-oss-bucket-in-the-alibaba-cloud-cdn-console.md)[加速](use-cases/accelerate-the-retrieval-of-resources-from-an-oss-bucket-in-the-alibaba-cloud-cdn-console.md)[OSS](use-cases/accelerate-the-retrieval-of-resources-from-an-oss-bucket-in-the-alibaba-cloud-cdn-console.md)[资源实践](use-cases/accelerate-the-retrieval-of-resources-from-an-oss-bucket-in-the-alibaba-cloud-cdn-console.md)
[CDN](support/too-many-redirects-occur-after-my-domain-name-is-accelerated-by-alibaba-cloud-cdn.md)[加速后提示重定向的次数过多解决方案](support/too-many-redirects-occur-after-my-domain-name-is-accelerated-by-alibaba-cloud-cdn.md)
[解决](user-guide/configure-an-ssl-certificate.md)[CDN](user-guide/configure-an-ssl-certificate.md)[加速后提示使用了不受支持协议的问题](user-guide/configure-an-ssl-certificate.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
