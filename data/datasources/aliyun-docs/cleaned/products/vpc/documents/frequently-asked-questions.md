# 网络规划配置与连通FAQ-专有网络VPC-阿里云

Source: https://help.aliyun.com/zh/vpc/frequently-asked-questions

# 专有网络FAQ
本文汇总了用户在使用专有网络VPC时遇到的常见问题，旨在帮助您快速解决问题、理解产品能力或优化您的网络架构。
网络连通问题
[如何实现不同](frequently-asked-questions.md)[VPC](frequently-asked-questions.md)[互连，从而实现不同](frequently-asked-questions.md)[VPC](frequently-asked-questions.md)[中的资源互访？](frequently-asked-questions.md)
[VPC](frequently-asked-questions.md)[对等连接不通如何排查？](frequently-asked-questions.md)
[对等连接配置时网段冲突如何解决？](frequently-asked-questions.md)
[添加对等连接后部分](frequently-asked-questions.md)[IP](frequently-asked-questions.md)[无法访问如何排查？](frequently-asked-questions.md)
[对等连接为什么发起端可以](frequently-asked-questions.md)[ping](frequently-asked-questions.md)[通接收端，但反向](frequently-asked-questions.md)[ping](frequently-asked-questions.md)[不通？](frequently-asked-questions.md)
[我建立了](frequently-asked-questions.md)[A](frequently-asked-questions.md)[到](frequently-asked-questions.md)[B](frequently-asked-questions.md)[和](frequently-asked-questions.md)[B](frequently-asked-questions.md)[到](frequently-asked-questions.md)[C](frequently-asked-questions.md)[的](frequently-asked-questions.md)[VPC](frequently-asked-questions.md)[对等连接，为什么](frequently-asked-questions.md)[A](frequently-asked-questions.md)[和](frequently-asked-questions.md)[C](frequently-asked-questions.md)[无法通信？](frequently-asked-questions.md)
...
[VPC](frequently-asked-questions.md)[内能否自定义](frequently-asked-questions.md)[DNS](frequently-asked-questions.md)[服务器？](frequently-asked-questions.md)
网段配置问题
[什么是](frequently-asked-questions.md)[CIDR？](frequently-asked-questions.md)
[如何修改](frequently-asked-questions.md)[VPC](frequently-asked-questions.md)[的网段？](frequently-asked-questions.md)
[如何修改交换机的网段？](frequently-asked-questions.md)
[创建](frequently-asked-questions.md)[VPC](frequently-asked-questions.md)[时应该选择哪个网段？](frequently-asked-questions.md)
[如何为](frequently-asked-questions.md)[VPC](frequently-asked-questions.md)[分配](frequently-asked-questions.md)[IPv6](frequently-asked-questions.md)[网段？IPv6](frequently-asked-questions.md)[如何访问公网？](frequently-asked-questions.md)
[VPC](frequently-asked-questions.md)[是否可以只分配](frequently-asked-questions.md)[IPv6](frequently-asked-questions.md)[网段（即](frequently-asked-questions.md)[IPv6 only）？](frequently-asked-questions.md)
...
| 安全性 | 较低 | 更高 |
如何实现VPC与经典网络互通？
您可参考：[使用](using-classiclink.md)[ClassicLink](using-classiclink.md)[连通经典网络与](using-classiclink.md)[VPC](using-classiclink.md)。
如何把阿里云VPC和线下公司机房的IDC网络进行打通？阿里云VPC与AWS/腾讯云如何互通？
您可参考：[VPC](connect-vpc-to-local-idc-office-terminal-other-cloud.md)[连接本地数据中心/其他云](connect-vpc-to-local-idc-office-terminal-other-cloud.md)。
VPC与其他VPC或线下网络网段冲突时能互通吗？
您可参考：
[使用 VPC NAT 网关解决地址冲突](../../nat-gateway/documents/use-cases/access-when-vpc-addresses-conflict-through-vpc-nat-gateway.md)。
[VPC NAT](../../nat-gateway/documents/use-cases/use-a-vpc-nat-gateway-and-an-express-connect-circuit-to-connect-a-data-center-to-a-vpc.md)[网关配合物理专线实现本地](../../nat-gateway/documents/use-cases/use-a-vpc-nat-gateway-and-an-express-connect-circuit-to-connect-a-data-center-to-a-vpc.md)[IDC](../../nat-gateway/documents/use-cases/use-a-vpc-nat-gateway-and-an-express-connect-circuit-to-connect-a-data-center-to-a-vpc.md)[与云上互访](../../nat-gateway/documents/use-cases/use-a-vpc-nat-gateway-and-an-express-connect-circuit-to-connect-a-data-center-to-a-vpc.md)。
[VPC NAT](../../nat-gateway/documents/use-cases/use-a-vpc-nat-gateway-and-a-vpn-gateway-to-connect-a-data-center-and-a-vpc.md)[网关联动](../../nat-gateway/documents/use-cases/use-a-vpc-nat-gateway-and-a-vpn-gateway-to-connect-a-data-center-and-a-vpc.md)[VPN](../../nat-gateway/documents/use-cases/use-a-vpc-nat-gateway-and-a-vpn-gateway-to-connect-a-data-center-and-a-vpc.md)[网关实现云上与云下私网互访](../../nat-gateway/documents/use-cases/use-a-vpc-nat-gateway-and-a-vpn-gateway-to-connect-a-data-center-and-a-vpc.md)。
如何让ECS服务器访问公网？ECS服务器如何通过IPv6地址访问公网？
您可参考：[选择公网](public-network-access.md)[IP](public-network-access.md)[地址类型](public-network-access.md)。
如何统一多个ECS的公网出口IP？
您可参考：
[用](public-network-access.md)[NAT](public-network-access.md)[网关统一公网流量出口](public-network-access.md)。
[使用](../../nat-gateway/documents/use-cases/create-vpc-peering-connections-to-enable-multiple-vpcs-to-use-the-same-internet-nat-gateway.md)[VPC](../../nat-gateway/documents/use-cases/create-vpc-peering-connections-to-enable-multiple-vpcs-to-use-the-same-internet-nat-gateway.md)[对等连接实现多个](../../nat-gateway/documents/use-cases/create-vpc-peering-connections-to-enable-multiple-vpcs-to-use-the-same-internet-nat-gateway.md)[VPC](../../nat-gateway/documents/use-cases/create-vpc-peering-connections-to-enable-multiple-vpcs-to-use-the-same-internet-nat-gateway.md)[共用公网](../../nat-gateway/documents/use-cases/create-vpc-peering-connections-to-enable-multiple-vpcs-to-use-the-same-internet-nat-gateway.md)[NAT](../../nat-gateway/documents/use-cases/create-vpc-peering-connections-to-enable-multiple-vpcs-to-use-the-same-internet-nat-gateway.md)[网关](../../nat-gateway/documents/use-cases/create-vpc-peering-connections-to-enable-multiple-vpcs-to-use-the-same-internet-nat-gateway.md)。
[使用转发路由器实现多个](../../nat-gateway/documents/use-cases/use-a-transit-router-to-enable-vpcs-to-share-an-internet-nat-gateway.md)[VPC](../../nat-gateway/documents/use-cases/use-a-transit-router-to-enable-vpcs-to-share-an-internet-nat-gateway.md)[共用](../../nat-gateway/documents/use-cases/use-a-transit-router-to-enable-vpcs-to-share-an-internet-nat-gateway.md)[NAT](../../nat-gateway/documents/use-cases/use-a-transit-router-to-enable-vpcs-to-share-an-internet-nat-gateway.md)[网关](../../nat-gateway/documents/use-cases/use-a-transit-router-to-enable-vpcs-to-share-an-internet-nat-gateway.md)。
IPv4网关和公网NAT网关有什么区别？
...
如何迁移ECS到另一个VPC？
您可参考：[更换](../../ecs/documents/user-guide/change-the-vpc-of-an-ecs-instance.md)[ECS](../../ecs/documents/user-guide/change-the-vpc-of-an-ecs-instance.md)[实例的](../../ecs/documents/user-guide/change-the-vpc-of-an-ecs-instance.md)[VPC](../../ecs/documents/user-guide/change-the-vpc-of-an-ecs-instance.md)。
VPC内能否自定义DNS服务器？
...
## 网络运维与监控问题
VPC如何监控公网流量？
您可以通过VPC的[流日志](https://vpc.console.aliyun.com/flowlog/cn-hangzhou/flowlogs)功能或者[网络智能服务-流量分析器](https://nis.console.aliyun.com/flowAnalyzer)功能，采集公网NAT网关、IPv4网关等公网组件的流量信息，从而实现公网流量监控。详情可参考[流日志](vpc-flow-logs.md)、[流量分析器](https://help.aliyun.com/zh/nis/user-guide/traffic-analyzer/)。
如何查看VPC网络拓扑图？
您可以使用[网络智能服务-专有网络拓扑](https://nis.console.aliyun.com/netTopology/vpc)功能，自助生成VPC网络拓扑图。
## 计费问题
VPC如何计费？
VPC收费功能：
