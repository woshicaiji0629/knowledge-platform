...
## API
调用[CreateRouteTable](developer-reference/api-vpc-2016-04-28-createroutetable.md)新建路由表。
调用[DeleteRouteTable](developer-reference/api-vpc-2016-04-28-deleteroutetable.md)删除自定义路由表。
## Terraform
...
## API
调用[AssociateRouteTable](developer-reference/api-vpc-2016-04-28-associateroutetable.md)将路由表和交换机绑定。
调用[AssociateRouteTableWithGateway](developer-reference/api-vpc-2016-04-28-associateroutetablewithgateway.md)将路由表和IPv4/IPv6网关绑定。
警告
解绑路由表前，请充分评估路由条目变化带来的相关业务影响，避免导致业务受损。
调用[UnassociateRouteTable](developer-reference/api-vpc-2016-04-28-unassociateroutetable.md)将路由表和交换机解绑。
调用[DissociateRouteTableFromGateway](developer-reference/api-vpc-2016-04-28-dissociateroutetablefromgateway.md)将路由表和IPv4/IPv6网关解绑。
## Terraform
...
## API
调用[CreateRouteEntry](developer-reference/api-vpc-2016-04-28-createrouteentry.md)添加单个路由条目；调用[CreateRouteEntries](developer-reference/api-vpc-2016-04-28-createrouteentries.md)批量添加路由条目。
警告
删除路由条目前，请充分评估相关业务影响，避免因删除操作导致业务受损。
调用[DeleteRouteEntry](developer-reference/api-vpc-2016-04-28-deleterouteentry.md)删除单个自定义路由条目；调用[DeleteRouteEntries](developer-reference/api-vpc-2016-04-28-deleterouteentries.md)批量删除自定义路由条目。
## Terraform
...
## API
调用[ModifyRouteEntry](developer-reference/api-vpc-2016-04-28-modifyrouteentry.md)更改已绑定交换机的路由表的路由条目下一跳。
调用[UpdateGatewayRouteTableEntryAttribute](developer-reference/api-vpc-2016-04-28-updategatewayroutetableentryattribute.md)更改已绑定IPv4/IPv6网关的路由表的路由条目下一跳。
## Terraform
