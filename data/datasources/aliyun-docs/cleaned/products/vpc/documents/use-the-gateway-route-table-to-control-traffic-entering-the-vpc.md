...
已创建2个[自定义路由表](network-traffic-management-using-custom-routing-tables.md)，分别与交换机1、交换机2绑定。
## 操作步骤
...
在删除路由表对话框，单击确定。
## 相关文档
您可以查看[IPv4](ipv4-gateway-overview.md)[网关](ipv4-gateway-overview.md)，了解IPv4网关使用指引与相关限制。
您可以通过调用以下API来管理网关路由表：
[绑定网关路由表和网关](developer-reference/api-vpc-2016-04-28-associateroutetablewithgateway.md)
[解绑网关路由表和网关](developer-reference/api-vpc-2016-04-28-dissociateroutetablefromgateway.md)
[修改网关路由表的下一跳类型和下一跳](developer-reference/api-vpc-2016-04-28-updategatewayroutetableentryattribute.md)
[查询网关路由表列表信息](developer-reference/api-vpc-2016-04-28-listgatewayroutetableentries.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
