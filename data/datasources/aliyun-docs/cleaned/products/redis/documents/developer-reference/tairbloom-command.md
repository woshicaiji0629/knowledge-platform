...
## 更多最佳实践
[使用](../use-cases/use-bloom-filter-to-avoid-repeated-push-to-players.md)[Bloom Filter](../use-cases/use-bloom-filter-to-avoid-repeated-push-to-players.md)[高效管理游戏活动推送](../use-cases/use-bloom-filter-to-avoid-repeated-push-to-players.md)
## 原理介绍
