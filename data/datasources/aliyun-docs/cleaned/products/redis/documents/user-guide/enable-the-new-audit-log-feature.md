...
| API | 说明 |
| --- | --- |
| [修改审计日志设置](../developer-reference/api-r-kvstore-2015-01-01-modifyauditlogconfig-redis.md) | 设置实例的审计日志开关与保留时长。 |
| [查询审计日志配置](../developer-reference/api-r-kvstore-2015-01-01-describeauditlogconfig-redis.md) | 查询实例审计日志是否已开通、日志保存时间等配置信息。 |
| [查询实例的审计日志](../developer-reference/api-r-kvstore-2015-01-01-describeauditrecords-redis.md) | 查询实例的审计日志。 |
## 相关文档
[查询审计日志](view-audit-logs.md)
[下载审计日志](download-audit-logs.md)
[订阅审计日志报表](subscribe-to-audit-log-reports.md)
[通过日志服务实现日志的实时消费](../../../sls/documents/overview-of-real-time-consumption.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
