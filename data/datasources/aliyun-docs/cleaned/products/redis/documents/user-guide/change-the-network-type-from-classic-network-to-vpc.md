...
| API 接口 | 说明 |
| --- | --- |
| [SwitchNetwork](../developer-reference/api-r-kvstore-2015-01-01-switchnetwork-redis.md) | 切换实例的专有网络 VPC。如果实例为经典网络，则会将其切换为专有网络。 |
## 相关文档
[连接问题排查流程](../support/how-do-i-troubleshoot-connection-issues-in-apsaradb-for-redis.md)
[修改专有网络](change-the-vpc-or-vswitch-of-an-instance.md)[VPC](change-the-vpc-or-vswitch-of-an-instance.md)[或交换机](change-the-vpc-or-vswitch-of-an-instance.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
