...
跨专有网络之间如果通过[云企业网](../../../cen/documents/product-overview/what-is-cen.md)[CEN](../../../cen/documents/product-overview/what-is-cen.md)实现互通，则被视为同一专有网络。
...
开启专有网络免密后的连接示例如下。
说明
关于如何获取实例的连接地址和密码，请参见[查看连接地址](view-endpoints.md)。
## redis-cli免密登录
...
| API 接口 | 说明 |
| --- | --- |
| [ModifyInstanceVpcAuthMode](../developer-reference/api-r-kvstore-2015-01-01-modifyinstancevpcauthmode-redis.md) | 开启或关闭专有网络免密访问。 |
## 常见问题
