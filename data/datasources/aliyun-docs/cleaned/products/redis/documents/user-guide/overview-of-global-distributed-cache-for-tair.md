...
## 费用说明
该功能免费，仅会根据子实例Tair（企业版）内存型的规格收费，详情请参见[计费项](../product-overview/billable-items.md)。
## 使用说明
重要
...
## 相关文档
[创建分布式实例](create-a-distributed-instance.md)
[创建分布式子实例](add-a-child-instance-to-a-distributed-instance.md)
[全球多活使用限制](limits-of-global-distributed-cache-for-redis.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
