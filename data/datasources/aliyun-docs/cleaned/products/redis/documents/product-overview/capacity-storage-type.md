...
以下规格适用于标准架构与集群架构直连模式的磁盘（SSD）型实例，更多信息关于SSD的信息请参见[本地盘](../../../ecs/documents/user-guide/local-disks.md)。
...
## 相关文档
[磁盘（ESSD）型性能白皮书](../support/performance-white-paper-of-essd-based-instances.md)
