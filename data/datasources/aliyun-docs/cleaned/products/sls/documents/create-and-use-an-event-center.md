...
如果在创建集群时，已选中安装 node-problem-detector 并创建事件中心，可直接按照[步骤二](../../ack/documents/ack-managed-and-ack-dedicated/user-guide/event-monitoring.md)查看Kubernetes事件中心。关于如何通过创建集群时安装NPD组件，请参见[创建](../../ack/documents/ack-managed-and-ack-dedicated/user-guide/create-an-ack-managed-cluster-2.md)[ACK](../../ack/documents/ack-managed-and-ack-dedicated/user-guide/create-an-ack-managed-cluster-2.md)[托管集群](../../ack/documents/ack-managed-and-ack-dedicated/user-guide/create-an-ack-managed-cluster-2.md)。
