...
## 前提条件
已创建K8s事件中心并接入Kubernetes集群数据。具体操作，请参见[创建并使用](create-and-use-an-event-center.md)[K8s](create-and-use-an-event-center.md)[事件中心](create-and-use-an-event-center.md)。
## 背景信息
