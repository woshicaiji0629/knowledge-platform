...
## 前提条件
已创建Standard Logstore。具体操作，请参见[创建基础](manage-a-logstore.md)[LogStore](manage-a-logstore.md)。
已采集日志。具体操作，请参见[数据采集](data-collection-overview.md)。
已配置索引。具体操作，请参见[配置索引](create-indexes.md)。
## 背景信息
