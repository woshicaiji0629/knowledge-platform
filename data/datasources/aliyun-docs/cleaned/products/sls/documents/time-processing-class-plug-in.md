...
### 功能入口
当您需要使用Logtail插件处理日志时，您可以在创建或修改Logtail配置时，添加插件。具体操作，请参见[处理插件概述](overview-22.md)。
## 原生插件与拓展插件的区别
原生插件：C++实现，性能更强。
...
说明
如果原始日志中的时间字段包含毫秒、微秒或纳秒级精度，且需在日志服务中保留该精度，请参见[日志采集支持纳秒精度时间戳](log-collection-supports-nanosecond-precision-timestamps.md)。
...
## 相关文档
通过API接口配置Logtail流水线：
[获取](developer-reference/api-sls-2020-12-30-getlogtailpipelineconfig.md)[Logtail](developer-reference/api-sls-2020-12-30-getlogtailpipelineconfig.md)[流水线配置](developer-reference/api-sls-2020-12-30-getlogtailpipelineconfig.md)
[罗列](developer-reference/api-sls-2020-12-30-listlogtailpipelineconfig.md)[Logtail](developer-reference/api-sls-2020-12-30-listlogtailpipelineconfig.md)[流水线配置](developer-reference/api-sls-2020-12-30-listlogtailpipelineconfig.md)
[创建](developer-reference/api-sls-2020-12-30-createlogtailpipelineconfig.md)[Logtail](developer-reference/api-sls-2020-12-30-createlogtailpipelineconfig.md)[流水线配置](developer-reference/api-sls-2020-12-30-createlogtailpipelineconfig.md)
[删除](developer-reference/api-sls-2020-12-30-deletelogtailpipelineconfig.md)[Logtail](developer-reference/api-sls-2020-12-30-deletelogtailpipelineconfig.md)[流水线配置](developer-reference/api-sls-2020-12-30-deletelogtailpipelineconfig.md)
[更新](developer-reference/api-sls-2020-12-30-updatelogtailpipelineconfig.md)[Logtail](developer-reference/api-sls-2020-12-30-updatelogtailpipelineconfig.md)[流水线配置](developer-reference/api-sls-2020-12-30-updatelogtailpipelineconfig.md)
通过控制台配置处理插件：
[持续采集主机文本日志](host-text-log-collection-auto-install.md)
[通过控制台采集集群容器日志（标准输出/文件）](collect-kubernetes-cluster-text-logs-daemonset.md)
[通过](collect-text-logs-of-self-built-k8s-clusters-deploy-logtail-in-daemonset-mode-2.md)[Kubernetes CRD](collect-text-logs-of-self-built-k8s-clusters-deploy-logtail-in-daemonset-mode-2.md)[采集集群容器日志（标准输出/文件）](collect-text-logs-of-self-built-k8s-clusters-deploy-logtail-in-daemonset-mode-2.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
