...
## 前提条件
开通CDN服务：参考[开通](../../cdn/documents/activate-alibaba-cloud-cdn.md)[CDN](../../cdn/documents/activate-alibaba-cloud-cdn.md)[服务](../../cdn/documents/activate-alibaba-cloud-cdn.md)开通了CDN产品，并且添加了加速域名。
开通SLS服务：参考[日志服务快速入门](getting-started.md)开通了SLS日志服务产品。
配置实时日志推送：参考[配置实时日志推送](../../cdn/documents/user-guide/configure-real-time-log-delivery.md)为需要分析用户访问数据的CDN加速域名配置实时日志推送。
...
具体使用方法您可以参考以下几个章节：
[预制报表：CDN](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)[基础数据](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)
[预制报表：CDN](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)[访问错误](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)
[预制报表：CDN](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)[热门资源](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)
[预制报表：CDN](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)[用户构成](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)
[订阅报表模板数据](ship-and-analyze-alibaba-cloud-cdn-real-time-logs-in-log-service.md)
### 自定义日志分析
...
## 创建实时日志推送Project
您可以参考[配置实时日志推送](../../cdn/documents/user-guide/configure-real-time-log-delivery.md)创建一个SLS日志服务的project，用于存储CDN产品指定域名（例如：aliyun.example.com）推送的实时日志。
