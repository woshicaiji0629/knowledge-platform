...
## 前提条件
已在服务器上安装Linux Logtail 0.16.18及以上版本。具体操作，请参见[安装](install-logtail-on-a-linux-server.md)[Logtail（Linux](install-logtail-on-a-linux-server.md)[系统）](install-logtail-on-a-linux-server.md)。
## 限制说明
