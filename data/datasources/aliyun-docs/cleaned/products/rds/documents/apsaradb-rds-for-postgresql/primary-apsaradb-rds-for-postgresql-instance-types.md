...
底层操作系统：约500~700 MB。
RDS相关管理服务：约500 MB。
RDS PostgreSQL云盘实例只支持专有网络，创建实例时，网络类型请配置为专有网络。如果使用API配置，参数InstanceNetworkType必须配置为VPC，更多信息，请参见[创建一个](../api-create-an-instance.md)[RDS](../api-create-an-instance.md)[实例](../api-create-an-instance.md)。
## 规格清单
重要
标准版和倚天版的区别，请参见[产品类型](../product-overview/product-types.md)。
实际最大IOPS：受存储类型、存储空间大小和实例规格共同影响，详情请参见[最大](../product-overview/primary-apsaradb-rds-instance-types.md)[IOPS](../product-overview/primary-apsaradb-rds-instance-types.md)[计算公式](../product-overview/primary-apsaradb-rds-instance-types.md)。
实际最大吞吐量：受存储类型、存储空间大小和实例规格共同影响，详情请参见[最大吞吐量计算公式](../product-overview/primary-apsaradb-rds-instance-types.md)。
### 基础系列规格
标准版规格
...
基础系列倚天版的规格相对较小，如需在生产环境中使用，建议[升级配置](change-the-specifications-of-an-apsaradb-rds-for-postgresql-instance.md)至基础系列的更高规格，或选择升级至[高可用系列](upgrade-an-apsaradb-rds-for-postgresql-instance-from-basic-edition-to-high-availability-edition.md)及[集群系列](upgrade-the-rds-edition-from-rds-basic-edition-or-rds-high-availability-edition-to-rds-cluster-edition.md)。
| 规格族 | 规格代码 | CPU 和内存 | 最大连接数 | 最大 IOPS | 最大 IO 带宽 （MB/s） | 存储空间 |
| --- | --- | --- | --- | --- | --- | --- |
...
RDS PostgreSQL实例支持将标准版规格变更为倚天版规格，更多信息，请参见[变更配置](change-the-specifications-of-an-apsaradb-rds-for-postgresql-instance.md)。
规格列表
...
| pg.n1.micro.1 | 1 | 1 GB | 100 | 见 [IOPS](../product-overview/primary-apsaradb-rds-instance-types.md) |
...
| pg.n2.medium.1 | 2 | 4 GB | 400 | 见 [IOPS](../product-overview/primary-apsaradb-rds-instance-types.md) |
