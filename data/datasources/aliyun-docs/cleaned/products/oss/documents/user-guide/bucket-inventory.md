...
涉及Object较多时，生成清单文件需要一定的时间。可以通过两种方式判断是否已生成清单文件，详情请参见[如何判断是否已生成清单文件？](../how-to-determine-whether-inventory-lists-are-generated.md)。
## SDK
Java
...
## API
可直接调用[PutBucketInventory](../developer-reference/putbucketinventory.md)来配置或修改清单规则。需要手动构造 HTTP 请求并计算签名，适用于对流程有高度自定义需求的场景。
### 解析清单报告
...
## API
可直接调用[PutBucketInventory](../developer-reference/putbucketinventory.md)来配置或修改清单规则。这需要手动构造 HTTP 请求并计算签名，适用于对流程有高度自定义需求的场景。
### 解析清单报告
...
## 常见问题
[为什么清单规则创建失败？](../the-reason-why-you-fail-to-create-inventories.md)
[为什么很长时间没有产生清单结果？](../inventory-lists-are-not-generated-for-an-extended-period-of-time.md)
[如何判断是否已生成清单文件？](../how-to-determine-whether-inventory-lists-are-generated.md)
[哪些因素会影响清单导出速度？](../factors-affect-the-export-speed-of-inventory.md)
[为什么找不到指定日期的清单导出结果文件？](../the-reason-why-you-unable-to-find-the-exported-inventory-list-of-the-specified-date.md)
[配置的清单规则何时生效？](../when-inventories-take-effect.md)
[为什么会出现相同日期的两份按天导出的清单结果文件？](../why-do-daily-exported-inventory-results-files-of-the-same-date-exist.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
