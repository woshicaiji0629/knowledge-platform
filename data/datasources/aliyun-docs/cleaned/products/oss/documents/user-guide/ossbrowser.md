...
已[安装](../developer-reference/installing-the-ossbrowser-2-0.md)[ossbrowser 2.0](../developer-reference/installing-the-ossbrowser-2-0.md)。
已[登录](../developer-reference/login-to-ossbrowser-2-0.md)[ossbrowser 2.0](../developer-reference/login-to-ossbrowser-2-0.md)。
## 管理Object
