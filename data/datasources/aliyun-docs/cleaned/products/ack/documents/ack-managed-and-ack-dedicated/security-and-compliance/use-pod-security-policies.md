...
## 前提条件
您已完成以下操作：
[创建一个](../user-guide/create-an-ack-managed-cluster-2.md)[Kubernetes](../user-guide/create-an-ack-managed-cluster-2.md)[集群](../user-guide/create-an-ack-managed-cluster-2.md)。
[获取集群](../user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[KubeConfig](../user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[并通过](../user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[kubectl](../user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[工具连接集群](../user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)。
说明
本文档仅适用于1.26以下版本的集群。
## ACK默认的Pod安全策略
