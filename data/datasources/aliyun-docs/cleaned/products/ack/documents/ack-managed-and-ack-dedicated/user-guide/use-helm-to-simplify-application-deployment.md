...
连接集群。
## 云端
[在](use-kubectl-on-cloud-shell-to-manage-ack-clusters-1690962464408.md)[Workbench](use-kubectl-on-cloud-shell-to-manage-ack-clusters-1690962464408.md)[或](use-kubectl-on-cloud-shell-to-manage-ack-clusters-1690962464408.md)[CloudShell](use-kubectl-on-cloud-shell-to-manage-ack-clusters-1690962464408.md)[上使用](use-kubectl-on-cloud-shell-to-manage-ack-clusters-1690962464408.md)[kubectl](use-kubectl-on-cloud-shell-to-manage-ack-clusters-1690962464408.md)[连接集群](use-kubectl-on-cloud-shell-to-manage-ack-clusters-1690962464408.md)。
...
## 相关文档
为确保集群安全并使用更完善的功能，建议[将](update-helm-v2-to-helm-v3.md)[Helm V2](update-helm-v2-to-helm-v3.md)[升级迁移至](update-helm-v2-to-helm-v3.md)[Helm V3](update-helm-v2-to-helm-v3.md)。
