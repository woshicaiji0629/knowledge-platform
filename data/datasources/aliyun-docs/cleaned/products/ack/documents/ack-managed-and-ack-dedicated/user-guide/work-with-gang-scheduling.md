...
## 前提条件
已创建1.16及以上版本的[ACK](create-an-ack-managed-cluster-2.md)[托管集群](create-an-ack-managed-cluster-2.md)[Pro](create-an-ack-managed-cluster-2.md)[版](create-an-ack-managed-cluster-2.md)。如需升级集群，请参见[手动升级集群](update-the-kubernetes-version-of-an-ack-cluster.md)。
## 功能介绍
