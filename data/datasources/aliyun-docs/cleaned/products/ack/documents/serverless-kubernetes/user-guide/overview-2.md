...
## 相关文档
[安装](install-the-nginx-ingress-controller.md)[Nginx Ingress Controller](install-the-nginx-ingress-controller.md)
[创建并使用](create-an-nginx-ingress.md)[Nginx Ingress](create-an-nginx-ingress.md)[对外暴露服务](create-an-nginx-ingress.md)
[Ingress](advanced-ingress-configurations.md)[高级用法](advanced-ingress-configurations.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
