...
## 更多信息
有关ACK的历史功能发布记录，请参见[历史功能发布记录（2025](historical-release-notes.md)[年及之前）](historical-release-notes.md)。
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
