# 支持时区-容器服务 Kubernetes 版 ACK-阿里云

Source: https://help.aliyun.com/zh/ack/product-overview/supported-time-zones

# 支持时区
由于世界各国家与地区经度不同，地方时也有所不同，因此会划分为不同的时区。本文主要介绍容器服务ACK支持的时区。
## 世界标准时间
| 时区 | 时差 |
| --- | --- |
| UTC | +00:00 |
