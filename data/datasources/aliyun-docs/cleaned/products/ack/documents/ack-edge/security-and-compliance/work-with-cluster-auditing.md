...
## 计费说明
您可以在费用账单的账单总览页面，查看计费明细，包含审计日志的费用信息。具体操作，请参见[账单查询](../../ack-managed-and-ack-dedicated/product-overview/view-your-bills.md)。关于审计日志的计费方式，请参见[按使用功能计费](../../../../sls/documents/pay-as-you-go.md)。
...
## 相关文档
如您想使用容器内部的操作审计功能，即通过kubectl exec进入到容器内部执行的命令的审计，请参见[使用容器内部操作审计功能](../../ack-managed-and-ack-dedicated/security-and-compliance/use-container-auditing.md)。
关于为企业安全管理运维人员提供使用集群的安全最佳实践，请参见[安全最佳实践](../../ack-managed-and-ack-dedicated/security-and-compliance/best-practices-for-security-1.md)。
[容器安全](../../ack-managed-and-ack-dedicated/security-and-compliance/faq-about-container-security.md)[FAQ](../../ack-managed-and-ack-dedicated/security-and-compliance/faq-about-container-security.md)。
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
