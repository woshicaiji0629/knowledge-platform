...
## 如何处理边缘节点接入失败的问题？
当脚本执行时出现问题，请参考以下常见问题列表进行处理。若出现以下表格中不存在的问题，请收集节点诊断信息后，[提交工单](https://selfservice.console.aliyun.com/ticket/createIndex)排查处理。关于如何收集边缘节点诊断信息，请参见[如何收集](diagnose-edge-node-problems.md)[ACK Edge](diagnose-edge-node-problems.md)[集群节点的诊断信息？](diagnose-edge-node-problems.md)
| 接入失败信息 | 失败原因 | 处理建议 |
| --- | --- | --- |
