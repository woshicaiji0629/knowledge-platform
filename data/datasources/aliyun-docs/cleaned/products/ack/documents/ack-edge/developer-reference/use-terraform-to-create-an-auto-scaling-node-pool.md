...
## 相关文档
[节点池](../../ack-managed-and-ack-dedicated/user-guide/node-pool-overview.md)
[启用节点自动伸缩](../../ack-managed-and-ack-dedicated/user-guide/auto-scaling-of-nodes.md)
[通过](../../ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-ack-managed-cluster.md)[Terraform](../../ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-ack-managed-cluster.md)[创建](../../ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-ack-managed-cluster.md)[ACK](../../ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-ack-managed-cluster.md)[托管集群](../../ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-ack-managed-cluster.md)
