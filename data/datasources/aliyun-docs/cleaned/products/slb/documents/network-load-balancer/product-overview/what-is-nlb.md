...
# 什么是网络型负载均衡NLB
网络型负载均衡NLB（Network Load Balancer ）是阿里云面向万物互联时代推出的新一代四层负载均衡，支持超高性能和自动弹性能力，单实例可以达到1亿并发连接。[NLB](restrictions-on-use.md)[产品性能及使用限制](restrictions-on-use.md)
## 前置概念
阅读本文前，您可能需要了解如下概念：
...
[网络型负载均衡](https://slb.console.aliyun.com/nlb)[NLB](https://slb.console.aliyun.com/nlb)[控制台](https://slb.console.aliyun.com/nlb)：具有交互式操作的Web服务页面。您可登录控制台完成NLB实例的创建、使用或释放，具体操作，请参见[创建和管理](../user-guide/create-and-manage-an-nlb-instance.md)[NLB](../user-guide/create-and-manage-an-nlb-instance.md)[实例](../user-guide/create-and-manage-an-nlb-instance.md)。
...
## 相关文档
[功能特性](functions-and-features.md)
[NLB](../getting-started/nlb-quickly-implements-load-balancing-for-ipv4-services.md)[快速实现](../getting-started/nlb-quickly-implements-load-balancing-for-ipv4-services.md)[IPv4](../getting-started/nlb-quickly-implements-load-balancing-for-ipv4-services.md)[服务的负载均衡](../getting-started/nlb-quickly-implements-load-balancing-for-ipv4-services.md)
[NLB](nlb-billable-items.md)[计费规则](nlb-billable-items.md)
该文章对您有帮助吗？
反馈
### 为什么选择阿里云
