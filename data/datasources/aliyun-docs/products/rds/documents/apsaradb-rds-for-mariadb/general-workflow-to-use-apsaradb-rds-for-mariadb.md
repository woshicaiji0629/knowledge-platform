# 从创建到连接RDS MariaDB实例的完整流程-云数据库 RDS-阿里云

Source: https://help.aliyun.com/zh/rds/apsaradb-rds-for-mariadb/general-workflow-to-use-apsaradb-rds-for-mariadb
...
快速入门旨在介绍如何创建RDS MariaDB实例、进行基本设置以及连接实例数据库，使用户能够了解从购买RDS实例到开始使用实例的流程。

## 快速入门

若您初次使用阿里云RDS，请先了解[阿里云](products/rds/documents/apsaradb-rds-for-mariadb/limits-of-rds-mariadb.md)[RDS](products/rds/documents/apsaradb-rds-for-mariadb/limits-of-rds-mariadb.md)[使用限制](products/rds/documents/apsaradb-rds-for-mariadb/limits-of-rds-mariadb.md)。

通常，从新购实例到可以开始使用实例，您需要完成如下操作。

- [创建](products/rds/documents/apsaradb-rds-for-mariadb/create-an-apsaradb-rds-for-mariadb-instance.md)[RDS MariaDB](products/rds/documents/apsaradb-rds-for-mariadb/create-an-apsaradb-rds-for-mariadb-instance.md)[实例](products/rds/documents/apsaradb-rds-for-mariadb/create-an-apsaradb-rds-for-mariadb-instance.md)
...
[上一篇：快速入门](products/rds/documents/apsaradb-rds-for-mariadb/getting-started.md)[下一篇：快速创建RDS MariaDB实例](products/rds/documents/apsaradb-rds-for-mariadb/create-an-apsaradb-rds-for-mariadb-instance.md)
