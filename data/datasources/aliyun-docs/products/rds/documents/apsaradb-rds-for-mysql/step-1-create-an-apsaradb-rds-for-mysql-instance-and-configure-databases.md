...
不同[产品系列](https://help.aliyun.com/zh/document_detail/2787304.html)和[存储类型](https://help.aliyun.com/zh/document_detail/2545944.html)的实例会限制[部分产品功能](products/rds/documents/apsaradb-rds-for-mysql/features.md)的使用。
...
RDS MySQL提供了多种实例规格，您可以根据实际业务需要进行选择。如果购买后发现此规格无法满足需求，可以[变更规格配置](products/rds/documents/apsaradb-rds-for-mysql/change-the-specifications-of-an-apsaradb-rds-for-mysql-instance.md)。
...
您可以在页面右侧查看与确认待购买实例的配置，将鼠标悬浮在查看明细上时，可以在弹窗中查看实例的费用明细。[RDS](products/rds/documents/apsaradb-rds-for-mysql/billable-items-billing-methods-and-pricing.md)[实例费用](products/rds/documents/apsaradb-rds-for-mysql/billable-items-billing-methods-and-pricing.md)与其付费方式、系列、规格、存储类型和存储空间大小等参数相关。
...
普通账号：仅对被授权数据库有部分操作权限，可通过[控制台、API](products/rds/documents/apsaradb-rds-for-mysql/create-an-account-on-an-apsaradb-rds-for-mysql-instance.md)[和](products/rds/documents/apsaradb-rds-for-mysql/create-an-account-on-an-apsaradb-rds-for-mysql-instance.md)[SQL](products/rds/documents/apsaradb-rds-for-mysql/create-an-account-on-an-apsaradb-rds-for-mysql-instance.md)[命令创建](products/rds/documents/apsaradb-rds-for-mysql/create-an-account-on-an-apsaradb-rds-for-mysql-instance.md)。如您需要使用SQL命令创建普通账号（如CREATE USER），需要先创建高权限账号，再通过高权限账号登录数据库执行命令。

## 下一步

[第二步：连接](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)[RDS MySQL](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)[实例](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)
...
请参见[指定账号从特定](products/rds/documents/apsaradb-rds-for-mysql/authorize-an-account-to-access-its-authorized-databases-from-specified-ip-addresses-in-an-apsaradb-rds-for-mysql-instance.md)[IP](products/rds/documents/apsaradb-rds-for-mysql/authorize-an-account-to-access-its-authorized-databases-from-specified-ip-addresses-in-an-apsaradb-rds-for-mysql-instance.md)[地址访问数据库](products/rds/documents/apsaradb-rds-for-mysql/authorize-an-account-to-access-its-authorized-databases-from-specified-ip-addresses-in-an-apsaradb-rds-for-mysql-instance.md)或[限制账号只能访问指定表、视图、字段](products/rds/documents/apsaradb-rds-for-mysql/authorize-accounts-to-manage-tables-views-and-fields.md)。
...
通过API创建RDS实例：[创建](products/rds/documents/apsaradb-rds-for-mysql/api-rds-2014-08-15-createdbinstance-mysql.md)[RDS](products/rds/documents/apsaradb-rds-for-mysql/api-rds-2014-08-15-createdbinstance-mysql.md)[实例](products/rds/documents/apsaradb-rds-for-mysql/api-rds-2014-08-15-createdbinstance-mysql.md)
...
[SQL Server](products/rds/documents/apsaradb-rds-for-sql-server/create-a-database-and-account.md)[创建数据库和账号](products/rds/documents/apsaradb-rds-for-sql-server/create-a-database-and-account.md)

- 

[PostgreSQL](products/rds/documents/apsaradb-rds-for-postgresql/create-a-database-and-an-account-on-an-apsaradb-rds-for-postgresql-instance.md)[创建数据库和账号](products/rds/documents/apsaradb-rds-for-postgresql/create-a-database-and-an-account-on-an-apsaradb-rds-for-postgresql-instance.md)

- 

[MariaDB](products/rds/documents/apsaradb-rds-for-mariadb/create-a-database-and-an-account-on-an-apsaradb-rds-for-mariadb-instance.md)[创建数据库和账号](products/rds/documents/apsaradb-rds-for-mariadb/create-a-database-and-an-account-on-an-apsaradb-rds-for-mariadb-instance.md)

[上一篇：准备工作](products/rds/documents/apsaradb-rds-for-mysql/get-ready-to-use-apsaradb-rds-for-mysql.md)[下一篇：第二步：连接RDS MySQL实例](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)
