...
创建RDS MySQL实例会产生[实例规格费用与存储费用](products/rds/documents/apsaradb-rds-for-mysql/billable-items-billing-methods-and-pricing.md)，其与实例的付费方式、系列、规格、存储类型和存储空间大小等参数相关。
...
您需要将您的IP地址或应用服务器的IP地址[写入](products/rds/documents/apsaradb-rds-for-mysql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-mysql-instance.md)[RDS MySQL](products/rds/documents/apsaradb-rds-for-mysql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-mysql-instance.md)[实例的](products/rds/documents/apsaradb-rds-for-mysql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-mysql-instance.md)[IP](products/rds/documents/apsaradb-rds-for-mysql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-mysql-instance.md)[白名单](products/rds/documents/apsaradb-rds-for-mysql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-mysql-instance.md)后才能正常访问实例。设置IP白名单后才能进行后续获取内网或外网连接地址的操作。
...
若选择KMS凭证登录方式，请参见[数据管理](products/kms/documents/key-management-service/user-guide/integrate-apsaradb-rds-secrets-into-dms.md)[DMS](products/kms/documents/key-management-service/user-guide/integrate-apsaradb-rds-secrets-into-dms.md)[集成](products/kms/documents/key-management-service/user-guide/integrate-apsaradb-rds-secrets-into-dms.md)[RDS](products/kms/documents/key-management-service/user-guide/integrate-apsaradb-rds-secrets-into-dms.md)[凭据](products/kms/documents/key-management-service/user-guide/integrate-apsaradb-rds-secrets-into-dms.md)。
...
登录账号无目标数据库的访问权限：您可前往RDS实例详情页的账号管理页面手动[调整账号权限](products/rds/documents/apsaradb-rds-for-mysql/modify-the-permissions-of-a-standard-account-on-an-apsaradb-rds-for-mysql-instance.md)。
...
使用命令行方式连接需要[提前设置实例](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)[IP](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)[白名单并根据自身需求获取对应实例连接地址](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)。
...
登录到需要连接RDS实例的应用服务器。您可以从本地服务器连接，也可以[登录阿里云](products/ecs/documents/getting-started/create-and-manage-an-ecs-instance-by-using-the-ecs-console.md)[ECS](products/ecs/documents/getting-started/create-and-manage-an-ecs-instance-by-using-the-ecs-console.md)[实例](products/ecs/documents/getting-started/create-and-manage-an-ecs-instance-by-using-the-ecs-console.md)进行连接。
...
填入连接地址。您需要根据自身情况判断是否符合内网访问条件，并填入对应的实例连接地址，本教程以内网连接地址为例。如何获取实例内外网连接地址请见[本文准备工作](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)。
...
使用客户端方式连接实例需要[提前设置实例](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)[IP](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)[白名单并根据自身需求获取对应实例连接地址](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)。
...
填写Hostname。您需要根据自身情况判断是否符合内网访问条件，并填入对应的[实例连接地址](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)，本教程以内网连接地址为例。
...
（多数情况）RDS白名单设置错误，请参见[设置](products/rds/documents/apsaradb-rds-for-mysql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-mysql-instance.md)[IP](products/rds/documents/apsaradb-rds-for-mysql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-mysql-instance.md)[白名单](products/rds/documents/apsaradb-rds-for-mysql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-mysql-instance.md)。

- 

（少数情况）不满足内网互通的条件（ECS与RDS处于同一个专有网络VPC），却使用内网地址连接，[请获取外网地址并使用外网地址连接](products/rds/documents/apsaradb-rds-for-mysql/step-2-connect-to-an-apsaradb-rds-for-mysql-instance.md)。
...
路由冲突。参考[无法](products/rds/documents/support/destination-host-unreachable.md)[ping](products/rds/documents/support/destination-host-unreachable.md)[通](products/rds/documents/support/destination-host-unreachable.md)[RDS](products/rds/documents/support/destination-host-unreachable.md)[内网地址处理方法](products/rds/documents/support/destination-host-unreachable.md)解决。
...
ECS实例连接RDS实例：[ECS（Linux）连接](products/rds/documents/videos/connect-an-ecs-instance-running-linux-to-an-rds-instance.md)[RDS](products/rds/documents/videos/connect-an-ecs-instance-running-linux-to-an-rds-instance.md)

- 

数据库连接失败：[解决无法连接实例问题](products/rds/documents/support/what-do-i-do-if-i-fail-to-connect-to-an-apsaradb-rds-instance.md)
...
[连接](products/rds/documents/connect-to-sql-server-instance.md)[SQL Server](products/rds/documents/connect-to-sql-server-instance.md)[实例](products/rds/documents/connect-to-sql-server-instance.md)

- 

[连接](products/rds/documents/apsaradb-rds-for-postgresql/connect-to-an-apsaradb-rds-for-postgresql-instance-1.md)[PostgreSQL](products/rds/documents/apsaradb-rds-for-postgresql/connect-to-an-apsaradb-rds-for-postgresql-instance-1.md)[实例](products/rds/documents/apsaradb-rds-for-postgresql/connect-to-an-apsaradb-rds-for-postgresql-instance-1.md)
...
[上一篇：第一步：创建RDS MySQL实例与配置数据库](products/rds/documents/apsaradb-rds-for-mysql/step-1-create-an-apsaradb-rds-for-mysql-instance-and-configure-databases.md)[下一篇：第三步：自建数据库迁移至RDS MySQL实例](products/rds/documents/apsaradb-rds-for-mysql/step-3-migrate-a-user-created-database-to-an-rds-mysql-instance.md)
