# 百度云MySQL数据库迁移到阿里云的步骤-云数据库 RDS(RDS)-阿里云帮助中心

Source: https://help.aliyun.com/zh/rds/apsaradb-rds-for-mysql/migrate-mysql-databases-from-baidu-ai-cloud-to-alibaba-cloud
...
# 百度智能云云数据库RDS MySQL迁移到阿里云RDS MySQL
...
本文介绍百度智能云云数据库RDS MySQL迁移到阿里云云数据库RDS MySQL的注意事项及操作步骤。
...
| 源端及目标端 | 要求 | 相关参考 |  |
| --- | --- | --- | --- |
| 源端 | 百度智能云云数据库 RDS MySQL 实例 | 已开通公网访问，并获取外网连接地址及端口。 已创建高权限账号。 | [百度智能云云数据库](https://cloud.baidu.com/doc/RDS/index.html) [RDS](https://cloud.baidu.com/doc/RDS/index.html) [官方文档](https://cloud.baidu.com/doc/RDS/index.html) |
...
| 数据库类型 | 选择 MySQL 。 |  |
| 接入方式 | 选择 公网 IP 。 |  |
| 实例地区 | 选择百度智能云云数据库 RDS MySQL 所属地域。 说明 若选项中没有百度智能云云数据库 RDS MySQL 所属的地域，您可以选择一个该数据库距离最近的地域。 |  |
| 域名或 IP 地址 | 填入百度智能云云数据库 RDS MySQL 的访问地址 。 说明 您可以在百度智能云云数据库 RDS MySQL 实例的 基本信息 页面的 网络连接 区域，单击 获取 IP ，获取 外网 IPv4 。 |  |
| 端口 | 填入百度智能云云数据库 RDS MySQL 的服务端口，默认为 3306 。 说明 您可以在百度智能云云数据库 RDS MySQL 实例的 基本信息 页面的 网络连接 区域，获取数据库的 端口 。 |  |
| 数据库账号 | 填入百度智能云云数据库 RDS MySQL 的数据库账号，权限要求请参见 [数据库账号的权限要求](https://help.aliyun.com/zh/dts/user-guide/migrate-data-from-an-amazon-rds-for-mysql-instance-to-an-apsaradb-rds-for-mysql-instance#section-2g2-h0v-e69) 。 |  |
| 数据库密码 | 填入该数据库账号对应的密码。 |  |
...
| 数据库账号 | 填入目标 RDS MySQL 实例的数据库账号，权限要求请参见 [数据库账号的权限要求](https://help.aliyun.com/zh/dts/user-guide/migrate-data-from-an-amazon-rds-for-mysql-instance-to-an-apsaradb-rds-for-mysql-instance#section-2g2-h0v-e69) 。 |  |
| 数据库密码 | 填入该数据库账号对应的密码。 |  |
...
若您需要使用数据校验功能，配置方法请参见[配置数据校验](https://help.aliyun.com/zh/dts/user-guide/enable-data-verification)。
...
[上一篇：Google Cloud SQL for MySQL数据库迁移到阿里云](products/rds/documents/apsaradb-rds-for-mysql/migrate-data-from-a-google-cloud-sql-for-mysql-instance-to-an-apsaradb-rds-for-mysql-instance.md)[下一篇：华为云云数据库RDS MySQL迁移到阿里云](products/rds/documents/apsaradb-rds-for-mysql/migrate-mysql-databases-from-huawei-cloud-to-alibaba-cloud.md)
