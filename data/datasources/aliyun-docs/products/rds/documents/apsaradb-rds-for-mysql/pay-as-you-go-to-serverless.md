...
Serverless实例的适用场景，请参见[RDS MySQL Serverless](products/rds/documents/apsaradb-rds-for-mysql/rds-mysql-serverless.md)[实例](products/rds/documents/apsaradb-rds-for-mysql/rds-mysql-serverless.md)。
...
内核版本：大于等于以下版本且不属于[已下线版本](products/rds/documents/apsaradb-rds-for-mysql/release-notes-for-alisql.md)：
...
如果实例的付费类型是包年包月，[可以先转按量付费](products/rds/documents/apsaradb-rds-for-mysql/change-the-billing-method-of-an-apsaradb-rds-for-mysql-instance-from-subscription-to-pay-as-you-go.md)，再转Serverless。
...
按量付费转Serverless会导致实例切换，请确保应用具有自动重连机制。自动重连机制需要在您的应用程序中设置。实例切换的影响请参见[实例切换的影响](products/rds/documents/apsaradb-rds-for-mysql/untitled-document-1701914031929.md)。
...
A：由于Serverless实例为通用型规格的实例，[仅支持使用服务密钥（Default Service CMK）进行云盘加密](products/rds/documents/apsaradb-rds-for-mysql/announcements-change-of-cloud-disk-encryption-instance-creation-from-january-15-2024.md)。

- 

Q：按量付费转换为Serverless后，是否支持Sequence Engine?

A：支持，详情请参见[Sequence Engine](products/rds/documents/apsaradb-rds-for-mysql/sequence-engine.md)。
...
| API | 描述 |
| --- | --- |
| [变更](products/rds/documents/api-change-instance-configuration.md) [RDS](products/rds/documents/api-change-instance-configuration.md) [实例](products/rds/documents/api-change-instance-configuration.md) | 将付费类型由按量付费变更为 Serverless 时： 请确认实例原付费类型为按量付费，并且将 PayType 参数设置为 Serverless 。 请将 DBInstanceClass 参数设置为 mysql.n2.serverless.1c 。 其他参数（存储空间大小等）请传空值或与实例原参数值保持一致，不支持修改。 |


[上一篇：按量付费转包年包月](products/rds/documents/apsaradb-rds-for-mysql/change-the-billing-method-of-an-apsaradb-rds-for-mysql-instance-from-pay-as-you-go-to-subscription.md)[下一篇：Serverless转按量付费](products/rds/documents/apsaradb-rds-for-mysql/transfer-serverless-instances-to-pay-as-you-go-billing.md)
