...
RDS MySQL实例的大版本为5.7及以上。如需查看或升级大版本，请参见[变更配置](products/rds/documents/apsaradb-rds-for-mysql/change-the-specifications-of-an-apsaradb-rds-for-mysql-instance.md)。
...
[变更配置](products/rds/documents/apsaradb-rds-for-mysql/change-the-specifications-of-an-apsaradb-rds-for-mysql-instance.md)

- 

[实例变更项](products/rds/documents/apsaradb-rds-for-mysql/configuration-items-for-an-apsaradb-rds-for-mysql-instance.md)

[上一篇：变更配置](products/rds/documents/apsaradb-rds-for-mysql/change-the-specifications-of-an-apsaradb-rds-for-mysql-instance.md)[下一篇：存储压缩](products/rds/documents/apsaradb-rds-for-mysql/storage-compression.md)
