...
阿里云关系型数据库RDS（Relational Database Service）是一种安全稳定可靠、高性价比、可弹性伸缩的在线数据库服务。RDS支持[MySQL](products/rds/documents/apsaradb-rds-for-mysql/overview-3.md)、[SQL Server](products/rds/documents/apsaradb-rds-for-sql-server/overview-of-apsaradb-rds-for-sql-server.md)、[PostgreSQL](products/rds/documents/apsaradb-rds-for-postgresql/what-is-apsaradb-rds-for-postgresql.md)和[MariaDB](products/rds/documents/apsaradb-rds-for-mariadb/what-is-apsaradb-rds-for-mariadb.md)引擎，并且提供了容灾、备份、恢复、监控、迁移等方面的全套解决方案，帮助您解决数据库运维的烦恼。
...
更多选择理由，请参见[RDS](products/rds/documents/product-overview/competitive-advantages-of-apsaradb-rds-instances-over-self-managed-databases.md)[与自建数据库对比优势](products/rds/documents/product-overview/competitive-advantages-of-apsaradb-rds-instances-over-self-managed-databases.md)。
...
SDK：控制台上所有的操作都可以通过SDK实现。[查看](products/rds/documents/sdk-reference.md)[SDK](products/rds/documents/sdk-reference.md)[参考](products/rds/documents/sdk-reference.md)。

- 

API：控制台上所有的操作都可以通过API实现。[查看](products/rds/documents/list-of-operations-by-function.md)[API](products/rds/documents/list-of-operations-by-function.md)[概览](products/rds/documents/list-of-operations-by-function.md)。
...
[RDS](products/rds/documents/videos/create-an-rds-instance.md)[实例创建](products/rds/documents/videos/create-an-rds-instance.md)

- 

[账号及数据库管理](products/rds/documents/videos/account-and-database-management.md)

- 

[只读实例与读写分离](products/rds/documents/videos/read-only-instance-management-and-read-or-write-splitting.md)

- 

[监控、备份及克隆实例](products/rds/documents/videos/monitor-back-up-and-clone-an-rds-instance.md)
...
| 服务 | 说明 |
| --- | --- |
| [ECS](products/ecs/documents/user-guide/what-is-ecs.md) | ECS 是云服务器，通过内网访问同一地域的 RDS 时，可实现 RDS 的最佳性能。ECS 搭配 RDS 是典型的业务访问架构。 |
| [Redis](products/redis/documents/product-overview/what-is-apsaradb-for-redis.md) | Redis 提供持久化的内存数据库服务。当业务访问量较大时，ECS 、RDS 和 Redis 的组合可以支持更多的读请求，同时减少响应时间。 |
...
| [OSS](products/oss/documents/user-guide/what-is-oss.md) | 对象存储服务 OSS 是阿里云提供的海量、安全、低成本、高可靠的云存储服务。 |
...
| 项目 | 链接 |
| --- | --- |
| RDS 定价 | 请参见 [计费项](products/rds/documents/product-overview/billable-items-billing-methods-and-pricing.md) 。 |
| 提交建议 | 产品、功能或文档建议，请您通过 [聆听平台](https://connect.console.aliyun.com/create?spm=a2c4g.11186623.0.0.1b854dbe1Nh6Ah) 提交建议。 |
| 常见问题和故障处理 | 使用 RDS 时遇到的各类问题，例如 CPU 过高、实例锁定等，您可以在 [Q&A](products/rds/documents/product-overview/faq.md) 或 [常见问题](products/rds/documents/faq-overview.md) 内搜索查看，可以解决您的绝大部分问题。 |


[上一篇：产品简介](products/rds/documents/product-overview/product-introduction.md)[下一篇：功能特性](products/rds/documents/product-overview/features-2.md)
