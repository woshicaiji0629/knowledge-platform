# 使用RDKit插件进行化学分子计算检索-云数据库 RDS-阿里云

Source: https://help.aliyun.com/zh/rds/apsaradb-rds-for-postgresql/use-the-rdkit-plug-in
...
postgres=# show rdkit.tanimoto_threshold ; rdkit.tanimoto_threshold -------------------------- 0.5 (1 row) postgres=# show rdkit.dice_threshold; rdkit.dice_threshold ---------------------- 0.5 (1 row)
...
[上一篇：位图功能扩展（varbitx）](products/rds/documents/apsaradb-rds-for-postgresql/use-the-varbitx-plug-in.md)[下一篇：异构数据库访问](products/rds/documents/apsaradb-rds-for-postgresql/run-cross-database-queries.md)
