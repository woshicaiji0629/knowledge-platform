...
详情请参见[高可用系列](products/rds/documents/apsaradb-rds-for-mysql/rds-high-availability-edition.md)。

## 费用说明

升级版本的费用请参见[变更配置](products/rds/documents/product-overview/specification-changes.md)。
...
| --- | --- |
| 产品系列 | 选择 高可用系列 。 |
| 存储类型 | 选择实例的存储类型。详情请参见 [存储类型介绍](products/rds/documents/apsaradb-rds-for-postgresql/storage-types-of-apsaradb-rds-for-postgresql.md) 。 说明 仅当原实例的存储类型为 ESSD 云盘时，支持此参数。 |
...
| API | 描述 |
| --- | --- |
| [变更](products/rds/documents/api-change-instance-configuration.md) [RDS](products/rds/documents/api-change-instance-configuration.md) [实例](products/rds/documents/api-change-instance-configuration.md) | 变更 RDS 实例配置。 |


[上一篇：变更实例产品系列](products/rds/documents/apsaradb-rds-for-postgresql/change-the-instance-edition.md)[下一篇：PostgreSQL基础系列或高可用系列升级集群系列](products/rds/documents/apsaradb-rds-for-postgresql/upgrade-the-rds-edition-from-rds-basic-edition-or-rds-high-availability-edition-to-rds-cluster-edition.md)
