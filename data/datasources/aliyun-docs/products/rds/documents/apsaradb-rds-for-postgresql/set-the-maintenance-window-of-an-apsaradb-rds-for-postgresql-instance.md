# 设置RDS实例的可维护时间段-云数据库 RDS-阿里云

Source: https://help.aliyun.com/zh/rds/apsaradb-rds-for-postgresql/set-the-maintenance-window-of-an-apsaradb-rds-for-postgresql-instance
...
在弹出的修改可维护时间段窗口中，选择一个合适的可维护时间段，单击确定。

说明

显示的可维护时间段和登录控制台的电脑的时区一致。

## 相关API

| API | 描述 |
| --- | --- |
| [修改可维护时间段](products/rds/documents/api-modify-the-maintenance-time.md) | 修改 RDS 实例可维护时间。 |


[上一篇：临时混访方案（同时保留经典网络和专有网络地址）](products/rds/documents/apsaradb-rds-for-postgresql/configure-the-hybrid-access-solution-for-an-apsaradb-rds-for-postgresql-instance.md)[下一篇：设置存储空间自动扩容](products/rds/documents/apsaradb-rds-for-postgresql/configure-automatic-storage-expansion-for-an-apsaradb-rds-for-postgresql-instance.md)
