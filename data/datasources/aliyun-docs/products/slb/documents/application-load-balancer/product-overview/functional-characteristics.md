...
WAF增强版：在标准版之上，集成Web应用防火墙（[WAF 3.0](products/waf/documents/web-application-firewall-3-0/product-overview/what-is-waf.md)），为Web业务提供应用层安全防护。

- 

扩展版：基于灵活的“服务扩展”能力，提供身份认证、基于内容的路由等核心流量治理功能，并新增多模型代理、负载感知路由、Token限速等AI原生特性，打造面向AI及传统应用的一体化智能流量入口。

ALB的[实例性能指标](products/slb/documents/application-load-balancer/product-overview/what-is-alb.md)与功能版本无关。[ALB](products/slb/documents/product-overview/alb.md)[升级实例](products/slb/documents/product-overview/alb.md)支持通过[安全组](products/slb/documents/application-load-balancer/user-guide/add-an-alb-instance-to-a-security-group.md)或[访问控制策略组（ACL）](products/slb/documents/application-load-balancer/user-guide/network-acls.md)管理流量，而升级前的实例仅支持ACL。如需使用安全组，请[新建实例](products/slb/documents/application-load-balancer/user-guide/create-and-manage-alb-instances.md)或联系商务经理对存量实例进行升级。
...
| Web 应用安全防护（WAF） | 不支持 （可 [升级为](products/slb/documents/application-load-balancer/use-cases/enable-waf-protection-for-alb.md) [WAF](products/slb/documents/application-load-balancer/use-cases/enable-waf-protection-for-alb.md) [增强版](products/slb/documents/application-load-balancer/use-cases/enable-waf-protection-for-alb.md) ） | 不支持 （可 [升级为](products/slb/documents/application-load-balancer/use-cases/enable-waf-protection-for-alb.md) [WAF](products/slb/documents/application-load-balancer/use-cases/enable-waf-protection-for-alb.md) [增强版](products/slb/documents/application-load-balancer/use-cases/enable-waf-protection-for-alb.md) ） | 支持 | 暂不支持 |
...
[上一篇：ALB扩展版概述](products/slb/documents/application-load-balancer/product-overview/alb-extensible-edition-overview.md)[下一篇：配额与限制](products/slb/documents/application-load-balancer/product-overview/quotas-and-limits.md)
