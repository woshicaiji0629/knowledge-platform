...
公网ALB会被收取公网网络费用，公网ALB通过弹性公网IP（EIP）提供公网能力，ALB实例关联的EIP产生的公网网络费用由EIP收取，因此公网网络费用的计费周期、扣费及出账时间与按量付费EIP的计费周期、扣费及出账时间一致。更多信息，请参见[计费周期](products/eip/documents/billing-overview.md)。

## 产品定价

ALB产品目录价请参见[ALB](products/slb/documents/application-load-balancer/product-overview/alb-billing-rules.md)[计费规则](products/slb/documents/application-load-balancer/product-overview/alb-billing-rules.md)和[ALB](products/slb/documents/application-load-balancer/product-overview/introduction-to-alb-resource-plans.md)[资源包](products/slb/documents/application-load-balancer/product-overview/introduction-to-alb-resource-plans.md)。实际购买价格请以[购买页](https://common-buy.aliyun.com/?commodityCode=slb_ealb_public_cn)为准。
...
[上一篇：ALB支持的地域与可用区](products/slb/documents/application-load-balancer/product-overview/supported-regions-and-zones.md)[下一篇：ALB计费规则](products/slb/documents/application-load-balancer/product-overview/alb-billing-rules.md)
