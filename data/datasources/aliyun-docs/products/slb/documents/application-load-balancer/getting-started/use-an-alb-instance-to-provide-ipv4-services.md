...
您已在华东2（上海）地域创建了一个专有网络VPC1，并分别在可用区E和可用区G创建了一个交换机VSW1和VSW2。具体操作，请参见[创建专有网络和交换机](products/vpc/documents/user-guide/create-and-manage-a-vpc.md)。
...
关于创建ECS实例，请参见[自定义购买实例](products/ecs/documents/user-guide/create-an-instance-by-using-the-wizard.md)。
...
[负载均衡域名已升级](products/slb/documents/product-overview/alb-and-nlb-domain-name-upgrade-announcement.md)，不支持直接使用ALB提供的DNS域名进行访问。
...
了解ALB计费文档，请参见[ALB](products/slb/documents/alb-billing.md)[产品计费](products/slb/documents/alb-billing.md)。

[上一篇：快速入门](products/slb/documents/application-load-balancer/getting-started.md)[下一篇：ALB快速实现IPv6服务的负载均衡](products/slb/documents/application-load-balancer/getting-started/implement-load-balancing-for-ipv6-services.md)
