...
变量信息，请参见[EdgeScript](products/cdn/documents/user-guide/edgescript-built-in-variables.md)[内置变量表](products/cdn/documents/user-guide/edgescript-built-in-variables.md)。

- 

函数信息，请参见[EdgeScript](products/cdn/documents/user-guide/tag-overview.md)[内置函数库](products/cdn/documents/user-guide/tag-overview.md)。

- 

条件判断，请参见[条件判断相关](products/cdn/documents/user-guide/logical-functions.md)。
...
[上一篇：边缘脚本](products/cdn/documents/user-guide/edgescript.md)[下一篇：EdgeScript原理介绍](products/cdn/documents/user-guide/how-edgescript-works.md)
