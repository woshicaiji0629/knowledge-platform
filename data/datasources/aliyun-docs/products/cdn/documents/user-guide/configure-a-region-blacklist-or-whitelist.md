...
在[规则引擎](products/cdn/documents/user-guide/rules-engine.md)中配置如下规则：以HTTP协议访问/image路径的资源。
...
[上一篇：安全配置](products/cdn/documents/user-guide/security-configuration.md)[下一篇：QUIC协议](products/cdn/documents/user-guide/quic.md)
