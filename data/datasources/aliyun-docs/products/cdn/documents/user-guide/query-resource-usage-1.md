...
[DescribeDomainUsageData](products/cdn/documents/api-describedomainusagedata.md)：查询域名在特定计费区域的用量数据。

[上一篇：用量概述](products/cdn/documents/user-guide/resource-usage-overview.md)[下一篇：用量汇总](products/cdn/documents/user-guide/summarize-resource-usage.md)
