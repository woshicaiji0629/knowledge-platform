...
功能冲突：[条件源站](products/cdn/documents/user-guide/configure-a-conditional-origin.md)功能与高级回源功能存在功能冲突，只能二选一配置。
...
[上一篇：配置回源301/302跟随](products/cdn/documents/user-guide/configure-301-or-302-redirection.md)[下一篇：配置IPv6回源](products/cdn/documents/user-guide/configure-back-to-origin-routing-over-ipv6.md)
