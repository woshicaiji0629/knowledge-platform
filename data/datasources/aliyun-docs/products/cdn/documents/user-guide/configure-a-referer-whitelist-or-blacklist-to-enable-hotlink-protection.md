...
Referer黑/白名单只是防止CDN流量盗刷的一种方式，更多防护方式参见[防范流量盗刷最佳实践](products/cdn/documents/use-cases/best-practices-for-preventing-traffic-theft.md)。
...
根据业务需求，[填写](products/cdn/documents/user-guide/configure-a-referer-whitelist-or-blacklist-to-enable-hotlink-protection.md)[Referer](products/cdn/documents/user-guide/configure-a-referer-whitelist-or-blacklist-to-enable-hotlink-protection.md)[配置项](products/cdn/documents/user-guide/configure-a-referer-whitelist-or-blacklist-to-enable-hotlink-protection.md)。
...
[上一篇：配置IP黑/白名单](products/cdn/documents/user-guide/configure-an-ip-blacklist-or-whitelist.md)[下一篇：其他安全访问控制](products/cdn/documents/user-guide/other-security-access-control.md)
