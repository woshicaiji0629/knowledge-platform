# 开启HTTP/2提升HTTPS性能-CDN-阿里云

Source: https://help.aliyun.com/zh/cdn/user-guide/enable-http-or-2
...
如果您关闭了HTTPS证书功能，HTTP/2也会自动失效，HTTP/2设置系统默认置灰，无法开启。
...
[上一篇：配置HTTPS证书](products/cdn/documents/user-guide/configure-an-ssl-certificate.md)[下一篇：配置OCSP Stapling](products/cdn/documents/user-guide/configure-ocsp-stapling.md)
