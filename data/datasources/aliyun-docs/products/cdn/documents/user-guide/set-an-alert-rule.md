...
已成功添加域名，具体请参见[添加加速域名](products/cdn/documents/add-a-domain-name.md)。
...
[上一篇：跨账号迁移CDN域名](products/cdn/documents/user-guide/domain-name-transfer.md)[下一篇：标签管理](products/cdn/documents/user-guide/tags.md)
