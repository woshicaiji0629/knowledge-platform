...
[阿里云](products/cdn/documents/user-guide/access-control-faq.md)[CDN URL](products/cdn/documents/user-guide/access-control-faq.md)[鉴权和远程鉴权可以同时开启吗？](products/cdn/documents/user-guide/access-control-faq.md)

- 

[远程鉴权中鉴权服务器支持配置为内网地址吗？](products/cdn/documents/user-guide/access-control-faq.md)

- 

[鉴权服务器返回的状态码既不是成功状态码，也不是失败状态码，CDN](products/cdn/documents/user-guide/access-control-faq.md)[为什么会直接放行？](products/cdn/documents/user-guide/access-control-faq.md)

- 

[远程鉴权服务器发生故障或宕机时，CDN](products/cdn/documents/user-guide/access-control-faq.md)[会直接放行所有请求吗？](products/cdn/documents/user-guide/access-control-faq.md)

## 相关API

[BatchSetCdnDomainConfig](products/cdn/documents/api-batchsetcdndomainconfig.md)

[上一篇：鉴权代码示例](products/cdn/documents/user-guide/url-signing-examples.md)[下一篇：最佳实践](products/cdn/documents/user-guide/best-practices.md)
