...
您可以根据下方示例，快速进行配置。您也可以参考[参数说明](products/cdn/documents/user-guide/configure-an-ip-blacklist-or-whitelist.md)，添加适用于自身业务的配置。
...
高级配置-规则条件：在[规则引擎](products/cdn/documents/user-guide/rules-engine.md)页面配置一个规则，规则内容为URI包含/admin/*其中任意一个，忽略大小写。然后在规则条件选择此规则。
...
[IP](products/cdn/documents/user-guide/access-control-faq.md)[黑白名单配置时有](products/cdn/documents/user-guide/access-control-faq.md)[IP](products/cdn/documents/user-guide/access-control-faq.md)[地址数量限制，配置](products/cdn/documents/user-guide/access-control-faq.md)[IP](products/cdn/documents/user-guide/access-control-faq.md)[地址段算](products/cdn/documents/user-guide/access-control-faq.md)[1](products/cdn/documents/user-guide/access-control-faq.md)[个还是多个](products/cdn/documents/user-guide/access-control-faq.md)[IP](products/cdn/documents/user-guide/access-control-faq.md)[地址数？](products/cdn/documents/user-guide/access-control-faq.md)

- 

[需要在源站将](products/cdn/documents/user-guide/access-control-faq.md)[CDN](products/cdn/documents/user-guide/access-control-faq.md)[设置为访问白名单，能提供阿里云](products/cdn/documents/user-guide/access-control-faq.md)[CDN](products/cdn/documents/user-guide/access-control-faq.md)[访问源站的节点](products/cdn/documents/user-guide/access-control-faq.md)[IP](products/cdn/documents/user-guide/access-control-faq.md)[吗？](products/cdn/documents/user-guide/access-control-faq.md)

- 

[为什么](products/cdn/documents/user-guide/access-control-faq.md)[IP](products/cdn/documents/user-guide/access-control-faq.md)[黑名单中的](products/cdn/documents/user-guide/access-control-faq.md)[IP](products/cdn/documents/user-guide/access-control-faq.md)[仍可访问资源？](products/cdn/documents/user-guide/access-control-faq.md)

- 

[如何获取客户端真实](products/cdn/documents/user-guide/access-control-faq.md)[IP](products/cdn/documents/user-guide/access-control-faq.md)[地址？](products/cdn/documents/user-guide/access-control-faq.md)

## 相关API

添加IP黑/白名单配置

调用[BatchSetCdnDomainConfig](products/cdn/documents/developer-reference/api-cdn-2018-05-10-batchsetcdndomainconfig.md)接口配置IP黑/白名单，相关参数参考[配置](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)[IP](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)[白名单](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)和[配置](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)[IP](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)[黑名单](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)。

更新IP黑/白名单配置

调用[BatchSetCdnDomainConfig](products/cdn/documents/developer-reference/api-cdn-2018-05-10-batchsetcdndomainconfig.md)接口更新IP黑/白名单，相关参数参考[配置](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)[IP](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)[白名单](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)和[配置](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)[IP](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)[黑名单](products/cdn/documents/developer-reference/parameters-for-configuring-features-for-domain-names.md)。
...
调用[查询域名配置](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describecdndomainconfigs.md)接口，查询配置的ConfigId。如果您知道对应配置的ConfigId，请忽略此步骤，参考步骤二进行删除配置。

步骤二：删除配置

调用[DeleteSpecificConfig](products/cdn/documents/developer-reference/api-cdn-2018-05-10-deletespecificconfig.md)接口，使用ConfigId删除配置。

[上一篇：访问控制概述](products/cdn/documents/user-guide/access-control-overview.md)[下一篇：配置Referer黑/白名单](products/cdn/documents/user-guide/configure-a-referer-whitelist-or-blacklist-to-enable-hotlink-protection.md)
