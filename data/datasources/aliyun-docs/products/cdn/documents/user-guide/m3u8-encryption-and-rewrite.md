...
此功能不负责对视频内容进行加密。使用此功能前，必须在源站确保视频切片（TS 文件）已完成 HLS 标准加密（如 AES-128），且原始 M3U8 文件中已包含正确的#EXT-X-KEY标签。视频加密请参考[如何生成](products/cdn/documents/user-guide/m3u8-encryption-and-rewrite.md)[M3U8](products/cdn/documents/user-guide/m3u8-encryption-and-rewrite.md)[文件并加密](products/cdn/documents/user-guide/m3u8-encryption-and-rewrite.md)。
...
#EXT-X-KEY标签的作用是声明是否加密。更多关于M3U8文件标签的介绍请参见[M3U8](products/cdn/documents/user-guide/m3u8-encryption-and-rewrite.md)[标签简介](products/cdn/documents/user-guide/m3u8-encryption-and-rewrite.md)。
...
[上一篇：配置音视频试看](products/cdn/documents/user-guide/audio-and-video-preview.md)[下一篇：流量限制](products/cdn/documents/user-guide/traffic-throttling.md)
