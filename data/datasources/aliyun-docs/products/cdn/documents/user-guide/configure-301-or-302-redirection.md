...
配置回源301/302跟随之前，请先确认CDN是否配置了[默认回源](products/cdn/documents/user-guide/configure-the-default-origin-host.md)[HOST](products/cdn/documents/user-guide/configure-the-default-origin-host.md)或者[指定源站回源](products/cdn/documents/user-guide/specify-an-origin-host-for-each-origin.md)[HOST](products/cdn/documents/user-guide/specify-an-origin-host-for-each-origin.md)：
...
配置了默认回源HOST：当源站响应“301/302状态码+Location URL”给CDN节点时，回源请求的HOST头将使用CDN配置的HOST头。如果源站要求使用Location域名作为回源HOST，请使用[指定源站回源](products/cdn/documents/user-guide/specify-an-origin-host-for-each-origin.md)[HOST](products/cdn/documents/user-guide/specify-an-origin-host-for-each-origin.md)功能。
...
[上一篇：配置回源HTTP请求超时时间](products/cdn/documents/user-guide/configure-a-timeout-period-for-back-to-origin-http-requests.md)[下一篇：高级回源](products/cdn/documents/user-guide/configure-advanced-origin-settings.md)
