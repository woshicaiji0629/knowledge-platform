...
为CDN加速域名配置HTTPS证书，能够加密客户端与CDN节点间的通信链路，防止数据在公网传输中被窃取或篡改，提升业务安全。在阿里云数字证书管理服务（原SSL）中购买的证书支持批量部署至CDN平台，具体操作请参见：[批量配置](products/cdn/documents/user-guide/configure-an-ssl-certificate-for-multiple-domain-names.md)[HTTPS](products/cdn/documents/user-guide/configure-an-ssl-certificate-for-multiple-domain-names.md)[证书](products/cdn/documents/user-guide/configure-an-ssl-certificate-for-multiple-domain-names.md)。
...
私钥要求：如果您选择上传自定义证书，则上传的证书私钥必须是无密码保护的，请先[验证私钥文件是否已去除密码保护](products/cdn/documents/user-guide/faq-about-https.md)。

- 

国密证书（SM2）：CDN控制台目前不支持直接配置SM2国密双证证书。如需使用国密证书，请通过API接口[设置国密证书](products/cdn/documents/developer-reference/api-cdn-2018-05-10-setcdndomainsmcertificate.md)进行配置。
...
自定义上传证书对证书（公钥）和私钥格式要求严格。如果您出现配置错误或看不懂配置示例，可以参考[上传自定义证书](products/cdn/documents/user-guide/configure-an-ssl-certificate.md)处理证书（公钥）和私钥，然后上传。
...
回源协议的详细配置方法，请参见[配置回源协议](products/cdn/documents/user-guide/configure-the-origin-protocol-policy.md)。
...
CDN只支持上传PEM格式的证书。其他格式的证书需要参考[证书格式转换](products/cdn/documents/user-guide/certificate-formats.md)将其转换成PEM格式。针对不同证书颁发机构的证书，对证书内容的上传有不同的要求：
...
若证书链不完整，需将中间证书合并到主证书文件中一并上传。详细信息，请参见[证书格式说明](products/cdn/documents/user-guide/certificate-formats.md)。
...
| 文档 | 描述 |
| --- | --- |
| [配置协议重定向](products/cdn/documents/user-guide/configure-url-redirection.md) | 您可以通过配置强制跳转 HTTPS 功能，将客户端到 CDN 节点的请求强制重定向为更安全的 HTTPS 请求。 |
| [配置](products/cdn/documents/user-guide/configure-hsts.md) [HSTS](products/cdn/documents/user-guide/configure-hsts.md) | 开启 HSTS（HTTP Strict Transport Security）功能，您可以强制客户端（例如：浏览器）使用 HTTPS 与 CDN 节点创建连接，提高安全性。 |
| [配置](products/cdn/documents/user-guide/configure-ocsp-stapling.md) [OCSP Stapling](products/cdn/documents/user-guide/configure-ocsp-stapling.md) | CDN 节点预先缓存在线证书验证结果并下发给客户端，无需浏览器直接向 CA 站点查询证书状态，减少用户验证时间。 |
...
[私钥文件如何去除密码保护？](products/cdn/documents/user-guide/faq-about-https.md)

- 

[源站已经配置了](products/cdn/documents/user-guide/faq-about-https.md)[HTTPS，CDN](products/cdn/documents/user-guide/faq-about-https.md)[上还需要配置](products/cdn/documents/user-guide/faq-about-https.md)[HTTPS](products/cdn/documents/user-guide/faq-about-https.md)[吗？](products/cdn/documents/user-guide/faq-about-https.md)

- 

[源站的](products/cdn/documents/user-guide/faq-about-https.md)[HTTPS](products/cdn/documents/user-guide/faq-about-https.md)[证书更新了，CDN](products/cdn/documents/user-guide/faq-about-https.md)[上需要同步更新吗？](products/cdn/documents/user-guide/faq-about-https.md)

- 

[为什么大多数设备能够顺利访问通过](products/cdn/documents/user-guide/faq-about-https.md)[HTTPS](products/cdn/documents/user-guide/faq-about-https.md)[协议加速的域名，但是一些设备却无法访问？](products/cdn/documents/user-guide/faq-about-https.md)
...
可调用[SetCdnDomainSSLCertificate](products/cdn/documents/developer-reference/api-cdn-2018-05-10-setcdndomainsslcertificate.md)接口配置。
...
| API | 描述 |
| --- | --- |
| [SetCdnDomainCSRCertificate](products/cdn/documents/developer-reference/api-cdn-2018-05-10-setcdndomaincsrcertificate.md) | 设置 CSR 文件。 |
| [DescribeDomainCertificateInfo](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describedomaincertificateinfo.md) | 获取指定加速域名证书信息。 |
| [SetCdnDomainSSLCertificate](products/cdn/documents/developer-reference/api-cdn-2018-05-10-setcdndomainsslcertificate.md) | 设置某域名下证书功能是否启用及更新证书信息。 |
| [SetCdnDomainCSRCertificate](products/cdn/documents/developer-reference/api-cdn-2018-05-10-setcdndomaincsrcertificate.md) | 设置指定域名下的 HTTPS 证书。 |
| [DescribeCdnDomainByCertificate](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describecdndomainbycertificate.md) | 根据证书信息获取加速域名。 |
| [DescribeCdnCertificateDetail](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describecdncertificatedetail.md) | 查询 CDN 证书详细信息。 |
| [DescribeCdnCertificateList](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describecdncertificatelist.md) | 获取证书列表信息。 |
| [DescribeCertificateInfoByID](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describecertificateinfobyid.md) | 获取指定证书信息。 |
| [DescribeCdnHttpsDomainList](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describecdnhttpsdomainlist.md) | 获取用户所有证书信息。 |
| [DescribeUserCertificateExpireCount](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describeusercertificateexpirecount.md) | 获取用户证书过期的域名数。 |
| [SetCdnDomainSMCertificate](products/cdn/documents/developer-reference/api-cdn-2018-05-10-setcdndomainsmcertificate.md) | 设置国密证书。 |
| [DescribeCdnSMCertificateList](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describecdnsmcertificatelist.md) | 查询国密证书列表。 |
| [DescribeCdnSMCertificateDetail](products/cdn/documents/developer-reference/api-cdn-2018-05-10-describecdnsmcertificatedetail.md) | 查询国密证书详情。 |


[上一篇：HTTPS配置](products/cdn/documents/user-guide/https-for-cdn-or-dcdn.md)[下一篇：配置HTTP/2](products/cdn/documents/user-guide/enable-http-or-2.md)
