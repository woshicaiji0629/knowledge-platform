# CDN缓存命中率下降的原因分析-CDN-阿里云

Source: https://help.aliyun.com/zh/cdn/cache-hit-ratio-of-an-alibaba-cloud-cdn-pop-decreases
...
影响阿里云CDN缓存命中率下降的因素如下，更多场景关于影响缓存命中率的因素介绍请参见[提高CDN缓存命中率](products/cdn/documents/use-cases/increase-the-cache-hit-ratios-of-alibaba-cloud-cdn.md)。
