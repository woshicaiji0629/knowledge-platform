...
[产品竞争力](products/cdn/documents/product-overview/competitive-advantages-of-alibaba-cloud-cdn.md)

- 

[技术竞争力](products/cdn/documents/product-overview/competitive-advantages-of-alibaba-cloud-cdn.md)

- 

[价格竞争力](products/cdn/documents/product-overview/competitive-advantages-of-alibaba-cloud-cdn.md)

- 

[生态竞争力](products/cdn/documents/product-overview/competitive-advantages-of-alibaba-cloud-cdn.md)

- 

[服务竞争力](products/cdn/documents/product-overview/competitive-advantages-of-alibaba-cloud-cdn.md)
...
阿里云CDN是一个可编程CDN，既支持简单的一站式配置，又可以通过EdgeScript（[边缘脚本](products/cdn/documents/user-guide/edgescript-overview.md)，简称ES）实现自定义配置。当CDN控制台上的标准配置无法满足您的业务需求时，可通过ES编写简单脚本来快速实现定制化业务需求，解决定制化需求发布周期长、业务变更不敏捷等问题。

开放丰富的API接口

支持通过API实现CDN控制台上的所有功能。详细操作，请参见[API](products/cdn/documents/developer-reference/api-cdn-2018-05-10-overview.md)[概览](products/cdn/documents/developer-reference/api-cdn-2018-05-10-overview.md)。
...
计费方式灵活多样，详细信息，请参见[计费概述](products/cdn/documents/product-overview/billing-overview.md)。
...
| 如果您满足近 30 天内的带宽峰值超过 5 Gbps，并且流量曲线比较平稳，全天带宽利用率大于 30%。 | [按带宽峰值计费](products/cdn/documents/product-overview/billing-rules-of-basic-services.md) 。按照每日的带宽峰值计费。每 5 分钟统计一个带宽数据，每日得到 288 个值，取其中的最大值。 |
...
| 如果您已经购买了... | 推荐您... | 原因 |
| --- | --- | --- |
| [云服务器](products/ecs/documents/user-guide/what-is-ecs.md) [ECS](products/ecs/documents/user-guide/what-is-ecs.md) | 开通阿里云 CDN | 云服务器 ECS 作为 CDN 源站，使用 CDN 可以帮助您有效提高网站访问速度。 |
| [对象存储](products/oss/documents/user-guide/what-is-oss.md) [OSS](products/oss/documents/user-guide/what-is-oss.md) | 对象存储 OSS 作为 CDN 源站，使用 CDN 可以提高您网站的访问速度，有效降低 OSS 的外网流量费用。 |  |
...
| 帮助您提升运维、运营效率，建立 DT 时代海量日志处理能力。 | [日志服务](products/sls/documents/what-is-log-service.md) | 日志服务（简称 SLS）是针对日志类数据的一站式服务，在阿里巴巴集团经历大量大数据场景锤炼而成。您无需开发就能快捷完成日志数据采集、消费、投递以及查询分析等功能，提升运维、运营效率，建立 DT 时代海量日志处理能力。 |
...
学习产品知识：[什么是阿里云](products/cdn/documents/product-overview/what-is-alibaba-cloud-cdn.md)[CDN](products/cdn/documents/product-overview/what-is-alibaba-cloud-cdn.md)。
...
[上一篇：什么是阿里云CDN](products/cdn/documents/product-overview/what-is-alibaba-cloud-cdn.md)[下一篇：应用场景](products/cdn/documents/product-overview/scenarios.md)
