...
如果您需要购买CDN下行流量资源包，计费方式请选择“按流量计费”。如果您目前不是“按流量计费”，可以根据需要变更计费方式，具体方法，请参见[变更计费方式](products/cdn/documents/product-overview/change-the-metering-method.md)。
...
[查询资源包明细](products/cdn/documents/product-overview/query-the-details-of-resource-plans-1.md)

- 

[设置资源包预警](products/cdn/documents/product-overview/configure-low-capacity-alerts.md)
...
[上一篇：资源包介绍](products/cdn/documents/product-overview/resource-plan-overview.md)[下一篇：资源包抵扣规则](products/cdn/documents/product-overview/rules-for-applying-resource-plans.md)
