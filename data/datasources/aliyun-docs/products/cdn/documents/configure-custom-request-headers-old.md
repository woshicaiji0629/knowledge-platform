...
目前CDN提供了升级版的配置回源HTTP请求头功能（升级版功能支持替换、变更、删除等更加丰富的改写操作方式、是否允许重复和跨域校验等功能），具体操作，请参见[修改出站请求头](products/cdn/documents/user-guide/configure-custom-request-headers.md)。
