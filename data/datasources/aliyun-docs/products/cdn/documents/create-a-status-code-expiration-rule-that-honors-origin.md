...
[状态码过期时间](products/cdn/documents/user-guide/create-a-cache-rule-for-http-status-codes.md)功能（开启优选遵循源站缓存策略）已经能够完全覆盖状态码过期时间（源站优先）这个功能的使用场景，并且还支持引用规则条件等更灵活的功能，建议您优先使用状态码过期时间功能。
