...
更多信息，请参见[CDN](products/cdn/documents/developer-reference/api-cdn-2018-05-10-endpoint.md)[服务接入点](products/cdn/documents/developer-reference/api-cdn-2018-05-10-endpoint.md)。

### 用户身份

您阿里云账号登录OpenAPI网站后，默认使用您的阿里云账号进行在线OpenAPI调试。由于阿里云账号拥有所有API的访问权限，存在较高的风险。强烈建议您创建并使用RAM用户进行API访问或日常运维。请根据业务的实际情况按需分配权限后进行接口调用。RAM用户需具备操作CDN资源的权限。具体操作，请参见[使用](products/cdn/documents/security-and-compliance/identity-management-and-access-control-1.md)[RAM](products/cdn/documents/security-and-compliance/identity-management-and-access-control-1.md)[进行访问控制](products/cdn/documents/security-and-compliance/identity-management-and-access-control-1.md)。
...
| 调用方式 | 支持情况 |
| --- | --- |
| [阿里云](products/cdn/documents/developer-reference/using-openapi.md) [SDK](products/cdn/documents/developer-reference/using-openapi.md) （推荐） | 支持 |
| [阿里云](products/cdn/documents/developer-reference/using-openapi.md) [CLI](products/cdn/documents/developer-reference/using-openapi.md) | 支持 |
| [Terraform](products/cdn/documents/developer-reference/using-openapi.md) | 支持 |
| [资源编排](products/cdn/documents/developer-reference/using-openapi.md) [ROS](products/cdn/documents/developer-reference/using-openapi.md) | 支持 |
| [自定义封装](products/cdn/documents/developer-reference/using-openapi.md) [API](products/cdn/documents/developer-reference/using-openapi.md) [调用](products/cdn/documents/developer-reference/using-openapi.md) | 支持 |
...
快速使用Terraform编排CDN，请参见[Terraform](products/cdn/documents/developer-reference/terraform-integration-example.md)[集成示例](products/cdn/documents/developer-reference/terraform-integration-example.md)。
...
快速使用资源编排ROS编排CDN，请参见[资源编排](products/cdn/documents/developer-reference/resource-orchestration-ros-integration-example.md)[ROS](products/cdn/documents/developer-reference/resource-orchestration-ros-integration-example.md)[集成示例](products/cdn/documents/developer-reference/resource-orchestration-ros-integration-example.md)。
...
原生HTTP调用需要您自己实现签名算法，并构建自定义请求，发起HTTP调用。有关签名机制的更多详细信息，请参见文档[API](products/cdn/documents/developer-reference/api-cdn-2018-05-10-overview.md)[概览](products/cdn/documents/developer-reference/api-cdn-2018-05-10-overview.md)和[V3](https://help.aliyun.com/zh/sdk/product-overview/v3-request-structure-and-signature)[版本请求体&签名机制](https://help.aliyun.com/zh/sdk/product-overview/v3-request-structure-and-signature)。
...
[上一篇：关于2014旧版API下线的公告](products/cdn/documents/developer-reference/announcement-on-discontinuation-of-2014-api.md)[下一篇：API参考指南](products/cdn/documents/developer-reference/api-reference.md)
