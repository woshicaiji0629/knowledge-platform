...
[创建自定义权限策略](products/ram/documents/create-a-custom-policy.md)

- 

[修改自定义权限策略内容和备注](products/ram/documents/modify-the-document-and-description-of-a-custom-policy.md)

- 

[删除自定义权限策略](products/ram/documents/delete-a-custom-policy.md)

- 

[管理权限策略引用记录](products/ram/documents/manage-policy-references.md)

- 

[管理自定义权限策略版本](products/ram/documents/manage-custom-policy-versions.md)
...
使用自定义权限策略，您需要了解业务的权限管控需求，并了解CDN的授权信息。详细内容请参见[授权信息](products/cdn/documents/developer-reference/api-cdn-2018-05-10-ram.md)。

[上一篇：CDN系统权限策略参考](products/cdn/documents/security-and-compliance/cdn.md)[下一篇：安全合规资质](products/cdn/documents/security-and-compliance/cdn-compliance-certifications.md)
