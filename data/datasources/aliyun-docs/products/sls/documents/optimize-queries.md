...
增加Shard可以提升读写能力，但只对新写入的数据生效。Shard表示计算资源，Shard越多，计算越快，您需要保证平均每个Shard扫描的数据不多于5000万条。您可以通过分裂Shard，增加Shard数量。具体操作，请参见[分裂](products/sls/documents/manage-shards.md)[Shard](products/sls/documents/manage-shards.md)。Shard的计费信息，请参见[活跃](products/sls/documents/why-am-i-charged-for-active-shards.md)[Shard](products/sls/documents/why-am-i-charged-for-active-shards.md)[租用费用](products/sls/documents/why-am-i-charged-for-active-shards.md)。

- 

[SQL](products/sls/documents/dedicated-sql.md)[独享版](products/sls/documents/dedicated-sql.md)支持更多的分析操作并发数、更多的扫描数据量。
...
[上一篇：使用search函数进行全文检索](products/sls/documents/full-text-search-using-the-search-function.md)[下一篇：使用SQL语句查询分析日志](products/sls/documents/use-sql-statements-to-query-and-analyze-logs.md)
