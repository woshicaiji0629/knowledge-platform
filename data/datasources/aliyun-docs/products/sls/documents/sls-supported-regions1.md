# 日志服务支持的地域与RegionID列表-日志服务-阿里云

Source: https://help.aliyun.com/zh/sls/sls-supported-regions1
...
日志服务开服的地域名称、Region ID的对应关系如下表所示。
...
[上一篇：日志应用](products/sls/documents/log-applications.md)[下一篇：竞品对比](products/sls/documents/competitive-analysis.md)
