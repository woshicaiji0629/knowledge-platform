# 如何设置告警严重度-日志服务(SLS)-阿里云帮助中心

Source: https://help.aliyun.com/zh/sls/specify-severity-levels-for-alerts
...
[上一篇：设置评估表达式](products/sls/documents/syntax-of-evaluate-expressions.md)[下一篇：设置恢复通知](products/sls/documents/recovery-notifications.md)
