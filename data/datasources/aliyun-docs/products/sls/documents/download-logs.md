...
若当前LogStore的计费模式为按写入数据量计费时，下载查询和分析结果（SQL结果）时不产生费用。具体内容，可参见[按写入数据量计费](products/sls/documents/billing-per-amount-of-data-written.md)。

- 

若当前LogStore的计费模式为按使用功能计费时，下载查询和分析结果（SQL结果）时，会使用SQL独享版，因此会产生SQL独享版相关的费用。费用说明，请参见[按使用功能计费模式计费项](products/sls/documents/billable-items.md)。
...
| 授权 | [下载权限配置](products/sls/documents/download-logs.md) | [下载权限配置](products/sls/documents/download-logs.md) | 手动配置 | 自动配置 | 手动配置 |
...
您也可以将日志投递到OSS，通过OSS进行下载。关于投递的具体操作，请参见[创建](products/sls/documents/create-oss-shipping-tasks-new-version.md)[OSS](products/sls/documents/create-oss-shipping-tasks-new-version.md)[投递任务（新版）](products/sls/documents/create-oss-shipping-tasks-new-version.md)。
...
[CreateDownloadJob - 创建日志下载任务](products/sls/documents/developer-reference/api-sls-2020-12-30-createdownloadjob.md)：
...
索引配置要求：调用 GetLogs API 或执行 SQL 查询时，需确保查询字段已在 LogStore 的索引属性中配置。如果查询字段未配置索引，将报ParameterInvalid错误。索引配置方法请参见[创建索引](products/sls/documents/developer-reference/api-sls-2020-12-30-createdownloadjob.md)。
...
操作步骤，参见[使用](products/sls/documents/developer-reference/use-cloud-shell-to-download-logs-from-log-service.md)[Cloud Shell](products/sls/documents/developer-reference/use-cloud-shell-to-download-logs-from-log-service.md)[下载日志数据](products/sls/documents/developer-reference/use-cloud-shell-to-download-logs-from-log-service.md)。
...
安装命令行工具。具体操作，请参见[安装](products/sls/documents/developer-reference/install-log-service-cli.md)[CLI](products/sls/documents/developer-reference/install-log-service-cli.md)。

- 

获取当前账号的AccessKey。具体操作，请参见[访问密钥](products/sls/documents/developer-reference/access-key.md)。

- 

获取下载日志的命令。具体步骤，请参见[get_log_all](products/sls/documents/developer-reference/get-log-all.md)。
...
更多信息，请参见[使用日志服务](products/sls/documents/developer-reference/overview-of-log-service-cli.md)[CLI](products/sls/documents/developer-reference/overview-of-log-service-cli.md)。
...
更多信息，请参见[SDK](products/sls/documents/developer-reference/overview-of-log-service-sdk.md)[参考概述](products/sls/documents/developer-reference/overview-of-log-service-sdk.md)。

[上一篇：数据输出与集成](products/sls/documents/sls-log-output-and-integration.md)[下一篇：数据消费与订阅](products/sls/documents/data-consumption-and-subscription.md)
