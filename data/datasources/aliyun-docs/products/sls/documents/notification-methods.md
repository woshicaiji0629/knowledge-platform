...
在行动组中选择您已创建的Webhook。您可以在Webhook集成管理Webhook。更多信息，请参见[Webhook](products/sls/documents/create-a-webhook.md)[集成](products/sls/documents/create-a-webhook.md)。
...
已创建用户、用户组或值班组。具体操作，请参见[创建用户和用户组](products/sls/documents/create-users-and-user-groups.md)、[创建值班组](products/sls/documents/create-an-on-duty-group.md)。

- 

配置参数

选择短信渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
| 发送时段 | 告警通知的发送时间。更多信息，请参见 [通知发送时段机制](products/sls/documents/periods-for-sending-alert-notifications.md) 。 |
...
选择语音渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
选择邮件渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
选择钉钉-自定义渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
| 内容模板 | 告警通知的内容。日志服务根据您所选择的内容模板，发送告警通知的内容。 说明 钉钉支持 Markdown 格式。更多信息，请参见 [钉钉](products/sls/documents/non-customized-notification-content.md) 。 |
| 发送时段 | 告警通知的发送时间。更多信息，请参见 [通知发送时段机制](products/sls/documents/periods-for-sending-alert-notifications.md) 。 |
...
选择Webhook-自定义渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
选择消息中心渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
已创建Webhook。具体操作，请参见[Webhook](products/sls/documents/create-a-webhook.md)[集成](products/sls/documents/create-a-webhook.md)。

- 

配置参数

选择钉钉渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
| 提醒方式 | 支持在钉钉群里提醒指定成员，可选值为不提醒、所有人、指定成员。 配置为 指定成员 时，需选择被提醒的用户、用户组或值班组。 |
| 内容模板 | 告警通知的内容。日志服务根据您所选择的内容模板，发送告警通知的内容。 说明 钉钉支持 Markdown 格式。更多信息，请参见 [内容格式](products/sls/documents/custom-notification-content.md) 。 |
| 发送时段 | 告警通知的发送时间。更多信息，请参见 [通知发送时段机制](products/sls/documents/periods-for-sending-alert-notifications.md) 。 |
...
选择企业微信渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
| 内容模板 | 告警通知的内容。日志服务根据您所选择的内容模板，发送告警通知的内容。 说明 企业微信支持 Markdown 格式。更多信息，请参见 [内容格式](products/sls/documents/custom-notification-content.md) 。 |
| 发送时段 | 告警通知的发送时间。更多信息，请参见 [通知发送时段机制](products/sls/documents/periods-for-sending-alert-notifications.md) 。 |
...
选择飞书渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
| 内容模板 | 告警通知的内容。日志服务根据您所选择的内容模板，发送告警通知的内容。 说明 飞书支持 Markdown 格式。更多信息，请参见 [内容格式](products/sls/documents/custom-notification-content.md) 。 |
| 发送时段 | 告警通知的发送时间。更多信息，请参见 [通知发送时段机制](products/sls/documents/periods-for-sending-alert-notifications.md) 。 |
...
选择Slack渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。

| 参数 | 说明 |
| --- | --- |
| 渠道 | 选择 Slack 。 |
| 选择 Webhook | 选择您已创建的 Webhook。 |
| 内容模板 | 告警通知的内容。日志服务根据您所选择的内容模板，发送告警通知的内容。 说明 Slack 支持 Markdown 格式。更多信息，请参见 [内容格式](products/sls/documents/custom-notification-content.md) 。 |
| 发送时段 | 告警通知的发送时间。更多信息，请参见 [通知发送时段机制](products/sls/documents/periods-for-sending-alert-notifications.md) 。 |
...
选择通用Webhook渠道时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
选择事件总线（EventBridge）时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
选择函数计算（FC）时，需在行动组对话框中完成如下配置。具体操作，请参见[行动策略](products/sls/documents/create-an-action-policy.md)。
...
[上一篇：通知发送时段机制](products/sls/documents/periods-for-sending-alert-notifications.md)[下一篇：非定制的通知内容](products/sls/documents/non-customized-notification-content.md)
