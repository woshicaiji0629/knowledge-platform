...
如果日志字段的值为JSON类型且需要展开为多行，请使用unnest语法。更多信息，请参见[UNNEST](products/sls/documents/unnest-clause.md)[子句](products/sls/documents/unnest-clause.md)。
...
如果在采集过程中，JSON日志被截断，则在使用JSON函数进行查询与分析时，系统将报错且中止查询与分析。针对该错误，您可以使用TRY表达式捕获异常信息，使得系统继续执行查询和分析操作。例如* | select message, try(json_parse(message))。更多信息，请参见[TRY](products/sls/documents/conditional-expressions.md)[表达式](products/sls/documents/conditional-expressions.md)。

| 函数名称 | 语法 | 说明 | 支持 SQL | 支持 SPL |
| --- | --- | --- | --- | --- |
| [json_array_contains](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_array_contains( x , value ) | 判断 JSON 数组中是否包含某个值。 | √ | √ |
| [json_array_get](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_array_get( x , index ) | 获取 JSON 数组中某个下标对应的元素。 | √ | × |
| [json_array_length](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_array_length( x ) | 计算 JSON 数组中元素的数量。 | √ | √ |
| [json_extract](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_extract( x , json_path) | 从 JSON 对象或 JSON 数组中提取一组 JSON 值（数组或对象）。 | √ | √ |
| [json_extract_scalar](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_extract_scalar( x , json_path ) | 从 JSON 对象或 JSON 数组中提取一组标量值（字符串、整数或布尔值）。类似于 json_extract 函数。 | √ | √ |
| [json_extract_bool](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_extract_bool(x, json_path) | 从 JSON 对象或 JSON 数组中提取 boolean 值。 | √ | × |
| [json_extract_long](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_extract_long(x, json_path) | 从 JSON 对象或 JSON 数组中提取 bigint 值。 | √ | × |
| [json_extract_double](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_extract_double(x, json_path) | 从 JSON 对象或 JSON 数组中提取 double 值。 | √ | × |
| [json_format](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_format( x ) | 把 JSON 类型转换为字符串类型。 | √ | √ |
| [json_parse](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_parse( x ) | 把字符串类型转换为 JSON 类型。 | √ | √ |
| [json_size](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_size( x , json_path ) | 计算 JSON 对象或数组中元素的数量。 | √ | √ |
| [json_object_flatten](products/sls/documents/json-functions.md) [函数](products/sls/documents/json-functions.md) | json_object_flatten(x) | 将 JSON 对象压缩为单层键值结构。 | √ | × |
...
| json_path | JSON 路径，格式为$.store.book[0].title。更多信息，请参见 [如何设置](products/sls/documents/faq-about-the-query-and-analysis-of-json-logs.md) [json_path](products/sls/documents/faq-about-the-query-and-analysis-of-json-logs.md) 。 |
...
[上一篇：日期和时间函数](products/sls/documents/date-and-time-functions-1.md)[下一篇：正则式函数](products/sls/documents/regular-expression-functions-1.md)
