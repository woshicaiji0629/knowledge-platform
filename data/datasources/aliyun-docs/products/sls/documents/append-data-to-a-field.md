...
| --- | --- | --- | --- |
| Key | string | 是 | 字段名称。 |
| Value | string | 是 | 添加的字段值。日志服务支持在该字段值中添加模板变量。更多信息，请参见 [模板变量](products/sls/documents/append-data-to-a-field.md) 。 |
...
[上一篇：函数计算场景中使用Prometheus SDK上报时序数据](products/sls/documents/use-prometheus-sdk-report-metrics-data-in-function-compute-scenarios.md)[下一篇：事件数据采集（Event）](products/sls/documents/acquisition-events-sls.md)
