...
根据控制台界面，配置通知渠道及配置相关参数。更多信息，请参见[通知渠道说明](products/sls/documents/notification-methods.md)。
...
[渠道分派与发送机制](products/sls/documents/manage-methods-to-send-alert-notifications.md)

- 

[通知发送时段机制](products/sls/documents/periods-for-sending-alert-notifications.md)

- 

[通知渠道说明](products/sls/documents/notification-methods.md)

- 

[非定制的通知内容](products/sls/documents/non-customized-notification-content.md)

[上一篇：告警属性参考](products/sls/documents/alert-attributes.md)[下一篇：渠道分派与发送机制](products/sls/documents/manage-methods-to-send-alert-notifications.md)
