# 使用CLI delete_index命令删除Logstore索引-日志服务-阿里云

Source: https://help.aliyun.com/zh/sls/developer-reference/delete-index
...
如果返回报错信息，请参见具体接口的错误码处理。更多信息，请参见[错误码](products/sls/documents/developer-reference/api-sls-2020-12-30-deleteindex.md)。

## API参考

[DeleteIndex](products/sls/documents/developer-reference/api-sls-2020-12-30-deleteindex.md)

[上一篇：create_index](products/sls/documents/developer-reference/create-index.md)[下一篇：get_index_config](products/sls/documents/developer-reference/get-index-config.md)
