...
已安装日志服务Java SDK。具体操作，请参见[安装](products/sls/documents/developer-reference/install-log-service-sdk-for-java.md)[Java SDK](products/sls/documents/developer-reference/install-log-service-sdk-for-java.md)。

- 

已写入日志到LogStore。具体操作，请参见[数据采集概述](products/sls/documents/data-collection-overview.md)。
...
[上一篇：日志管理](products/sls/documents/developer-reference/log-management.md)[下一篇：使用Java SDK写入日志](products/sls/documents/developer-reference/use-the-java-sdk-to-write-logs.md)
