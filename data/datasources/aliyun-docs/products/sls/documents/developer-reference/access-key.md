# 了解并创建RAM用户的AccessKey-日志服务-阿里云

Source: https://help.aliyun.com/zh/sls/developer-reference/access-key
...
允许自主管理AccessKey的RAM用户。关于如何设置自主管理AccessKey的详情，请参见[管理](products/ram/documents/user-guide/manage-security-settings-of-ram-users.md)[RAM](products/ram/documents/user-guide/manage-security-settings-of-ram-users.md)[用户安全设置](products/ram/documents/user-guide/manage-security-settings-of-ram-users.md)。
...
阅读AccessKey使用场景及使用建议，强烈建议您遵从使用建议选择更合适的凭据方案。如果必须创建AccessKey，则选择对应使用场景后，勾选我确认必须创建AccessKey，然后单击继续创建，创建的AccessKey不受使用场景的影响。
...
[上一篇：VPC专用内网域名](products/sls/documents/developer-reference/vpc-private-intranet-domain-name.md)[下一篇：公共请求头](products/sls/documents/developer-reference/common-request-headers.md)
