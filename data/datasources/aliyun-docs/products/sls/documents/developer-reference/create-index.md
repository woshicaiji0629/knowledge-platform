# 使用CLI的create_index命令创建索引-日志服务-阿里云

Source: https://help.aliyun.com/zh/sls/developer-reference/create-index
...
如果返回报错信息，请参见具体接口的错误码处理。更多信息，请参见[错误码](products/sls/documents/developer-reference/api-sls-2020-12-30-createindex.md)。

## API参考

[CreateIndex](products/sls/documents/developer-reference/api-sls-2020-12-30-createindex.md)

[上一篇：索引管理](products/sls/documents/developer-reference/index-management.md)[下一篇：delete_index](products/sls/documents/developer-reference/delete-index.md)
