# 使用get_index_config命令获取Logstore索引配置-日志服务-阿里云

Source: https://help.aliyun.com/zh/sls/developer-reference/get-index-config
...
如果返回报错信息，请参见具体接口的错误码处理。更多信息，请参见[错误码](products/sls/documents/developer-reference/api-sls-2020-12-30-getindex.md)。

## API参考

[GetIndex](products/sls/documents/developer-reference/api-sls-2020-12-30-getindex.md)

[上一篇：delete_index](products/sls/documents/developer-reference/delete-index.md)[下一篇：update_index](products/sls/documents/developer-reference/update-index.md)
