# 基于AppendOnly模式的数据防篡改原理-日志服务-阿里云

Source: https://help.aliyun.com/zh/sls/data-tamper-proof
...
[上一篇：存储冗余](products/sls/documents/storage-redundancy.md)[下一篇：修改与删除日志数据](products/sls/documents/modifying-and-deleting-log-data.md)
