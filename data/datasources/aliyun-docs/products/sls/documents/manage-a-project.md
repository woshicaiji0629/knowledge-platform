...
提供日志服务资源的访问入口：日志服务为每个Project配置一个独立的访问入口。该访问入口支持通过网络写入、读取及管理日志。关于访问入口的更多信息，请参见[服务接入点](products/sls/documents/developer-reference/api-sls-2020-12-30-endpoint.md)。
...
[创建](products/sls/documents/developer-reference/api-sls-2020-12-30-createproject.md)[Project](products/sls/documents/developer-reference/api-sls-2020-12-30-createproject.md)。
...
当明确Project关联的云产品后，若想了解更多信息，如存储的数据内容等，请参考[云产品日志采集](products/sls/documents/collection-of-alibaba-cloud-service-logs.md)。
...
若希望分析Project的资源用量与计费，可以参考[使用](products/sls/documents/use-cloudlens-for-sls-to-analyze-resource-usage.md)[CloudLens for SLS](products/sls/documents/use-cloudlens-for-sls-to-analyze-resource-usage.md)[分析资源用量](products/sls/documents/use-cloudlens-for-sls-to-analyze-resource-usage.md)进行查看与预估。
...
修改[更新](products/sls/documents/developer-reference/api-sls-2020-12-30-updateproject.md)[Project](products/sls/documents/developer-reference/api-sls-2020-12-30-updateproject.md)接口中的recycleBinEnabled。
...
删除Project的当天仍会产生存储等费用，次日[停止计费](products/sls/documents/stop-billing.md)。即您在删除Project的第三天不会再收到日志服务的账单。
...
LogStore数据备份：若Project中包含需保留的日志数据，需通过SLS的[下载日志](products/sls/documents/download-logs.md)功能提前导出。
...
[删除指定](products/sls/documents/developer-reference/api-sls-2020-12-30-deleteproject.md)[Project](products/sls/documents/developer-reference/api-sls-2020-12-30-deleteproject.md)。
...
首先使用[配置传输加速](products/sls/documents/developer-reference/api-sls-2020-12-30-putprojecttransferacceleration.md)。

- 

在后续使用时将endpoint配置为传输加速域名才能获得加速效果。传输加速域名仅支持HTTP/HTTPS协议的API接入，暂不支持Kafka、GRPC等协议接入。在不需要传输加速的场景中，建议使用[服务接入点](products/sls/documents/developer-reference/api-sls-2020-12-30-endpoint.md)以减少传输费用。
...
[修改资源组](products/sls/documents/developer-reference/api-sls-2020-12-30-changeresourcegroup.md)。
...
[绑定标签](products/sls/documents/developer-reference/api-sls-2020-12-30-tagresources.md)。
...
[创建自定义域名](products/sls/documents/developer-reference/api-sls-2020-12-30-createdomain.md)。
...
Project中存储不同类型的数据需要创建不同的Store，具体请参考[管理](products/sls/documents/manage-sls-store.md)[Store](products/sls/documents/manage-sls-store.md)。

[上一篇：基础资源使用限制](products/sls/documents/basic-resources.md)[下一篇：管理Store](products/sls/documents/manage-sls-store.md)
