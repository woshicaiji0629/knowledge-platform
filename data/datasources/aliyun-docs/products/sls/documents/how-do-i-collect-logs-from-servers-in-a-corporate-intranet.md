...
已创建Project和LogStore。具体操作，请参见[管理](products/sls/documents/manage-a-project.md)[Project](products/sls/documents/manage-a-project.md)和[创建基础](products/sls/documents/manage-a-logstore.md)[LogStore](products/sls/documents/manage-a-logstore.md)。

- 

已在服务器上安装Linux Logtail 1.5.0及以上版本或Window Logtail 1.5.0.0及以上版本。具体操作，请参见[安装](products/sls/documents/install-logtail-on-a-linux-server.md)[Logtail（Linux](products/sls/documents/install-logtail-on-a-linux-server.md)[系统）](products/sls/documents/install-logtail-on-a-linux-server.md)、[安装](products/sls/documents/install-logtail-on-a-windows-server.md)[Logtail（Windows](products/sls/documents/install-logtail-on-a-windows-server.md)[系统）](products/sls/documents/install-logtail-on-a-windows-server.md)。
...
关于环境变量的更多信息，请参见[附录：网络代理相关的环境变量](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)。
...
重复执行步骤[1](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)~[3](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)，为其他内网服务器设置代理相关的环境变量。
...
重复执行步骤[1](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)~[4](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)，为其他内网服务器配置代理相关的环境变量。
...
例如以ALL_PROXY为例，代理服务器地址为192.168.1.0，监听端口为9000，内网服务器与代理服务器之间通过HTTP协议进行通信。关于环境变量的更多信息，请参见[附录：网络代理相关的环境变量](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)。例如输入ALL_PROXY=http://192.168.1.0:9000。
...
重复执行步骤[1](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)和[2](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)，验证其他企业内网服务器的网络。
...
端口（可选）：设置为您在nginx.conf文件中配置的代理服务器监听端口。更多信息，请参见配置代理服务器中的步骤[5](products/sls/documents/how-do-i-collect-logs-from-servers-in-a-corporate-intranet.md)。如果不设置，默认使用80。
...
[上一篇：通过私网连接（PrivateLink）访问日志服务](products/sls/documents/sls-private-network-connection.md)[下一篇：采集客户端数据的高可用方案](products/sls/documents/high-availability-solutions-to-collect-data-from-clients.md)
