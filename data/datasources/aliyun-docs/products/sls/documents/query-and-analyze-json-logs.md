...
为了进行后续的日志分析，您需要先[采集](products/sls/documents/collect-json-formatted-text-logs.md)[JSON](products/sls/documents/collect-json-formatted-text-logs.md)[格式文本日志](products/sls/documents/collect-json-formatted-text-logs.md)。
...
在LogStore的查询和分析页面的右上角，选择查询分析属性>属性。如果还未创建索引，需要先单击开启索引。全文索引和字段索引的更多信息、创建索引的详细步骤，请参见[创建索引](products/sls/documents/create-indexes.md)。
...
__topic__、__source__、__tag__是系统的保留字段，更多信息请参见[保留字段](products/sls/documents/reserved-fields.md)。
...
[上一篇：查询和分析网站日志](products/sls/documents/query-and-analyze-website-logs.md)[下一篇：关联LogStore与MySQL数据库进行查询分析](products/sls/documents/associate-a-logstore-with-a-mysql-database-to-perform-query-and-analysis.md)
