...
| 计费项 | 说明 | 单次计量 | 单价 | 单次计费 |
| --- | --- | --- | --- | --- |
| SQL 独享版 | 单次查询和分析操作消耗的 CPU 时间为 3.6 秒。如何获取 CPU 时间，请参见 [获取](products/sls/documents/dedicated-sql.md) [CPU](products/sls/documents/dedicated-sql.md) [时间](products/sls/documents/dedicated-sql.md) 。 | 3.6 秒/3600=0.001 小时 | 0.35 元/核*小时 | 0.00035 元 |
...
[上一篇：用量查询](products/sls/documents/query-resource-usage.md)[下一篇：欠费说明](products/sls/documents/overdue-payments.md)
