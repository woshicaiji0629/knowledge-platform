...
调用[TagResources](products/vpc/documents/developer-reference/api-vpc-2016-04-28-tagresources.md)为指定的资源统一创建并绑定标签。

- 

调用[UnTagResources](products/vpc/documents/developer-reference/api-vpc-2016-04-28-untagresources.md)为指定的资源列表统一解绑标签。

[上一篇：使用流量镜像对VPC流量进行安全审查](products/vpc/documents/use-traffic-mirroring-to-perform-security-audit-on-vpc-traffic.md)[下一篇：管理VPC配额](products/vpc/documents/manage-vpc-quotas.md)
