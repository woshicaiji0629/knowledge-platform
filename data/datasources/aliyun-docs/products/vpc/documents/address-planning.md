...
自动导入发现的资源：开启后，IPAM将通过[资源发现](products/vpc/documents/use-ipam-to-create-a-vpc.md)持续查找生效地域内的VPC，将网段在当前地址池范围内且在 IPAM 中未分配的资源纳入地址管理。
...
预置CIDR：预置 CIDR 的 IPAM 地址池，才可以从中[为资源分配 CIDR](products/vpc/documents/use-ipam-to-create-a-vpc.md)。
...
已预置 CIDR 的地址池，可以创建该地址池的子地址池、[结合](products/vpc/documents/use-ipam-to-create-a-vpc.md)[IPAM](products/vpc/documents/use-ipam-to-create-a-vpc.md)[规划创建](products/vpc/documents/use-ipam-to-create-a-vpc.md)[VPC](products/vpc/documents/use-ipam-to-create-a-vpc.md)。
...
调用[OpenVpcIpamService](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-openvpcipamservice.md)开通IPAM。

- 

调用[CreateIpam](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-createipam.md)创建IPAM。

- 

调用[CreateIpamScope](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-createipamscope.md)创建IPAM私网作用范围。

创建IPAM地址池并预置CIDR

- 

调用[CreateIpamPool](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-createipampool.md)创建IPAM地址池。

- 

调用[AddIpamPoolCidr](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-addipampoolcidr.md)为IPAM地址池预置CIDR地址段。

资源清理

- 

调用[DeleteIpamPoolCidr](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-deleteipampoolcidr.md)删除IPAM地址池预置的CIDR地址段。

- 

调用[DeleteIpamPool](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-deleteipampool.md)删除IPAM地址池。

- 

调用[DeleteIpamScope](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-deleteipamscope.md)删除自建的IPAM作用范围。

- 

调用[DeleteIpam](products/vpc/documents/developer-reference/api-vpcipam-2023-02-28-deleteipam.md)删除IPAM。
...
共享成功后，地址池使用者可以在IPAM地址池页面共享给我的池页签中查看，可使用该地址池[结合](products/vpc/documents/use-ipam-to-create-a-vpc.md)[IPAM](products/vpc/documents/use-ipam-to-create-a-vpc.md)[规划并创建专有网络](products/vpc/documents/use-ipam-to-create-a-vpc.md)或[结合](products/vpc/documents/use-ipam-to-create-a-vpc.md)[IPAM](products/vpc/documents/use-ipam-to-create-a-vpc.md)[规划并创建专有网络](products/vpc/documents/use-ipam-to-create-a-vpc.md)。
...
地址池所有者可以[管理地址池的分配](products/vpc/documents/use-ipam-to-create-a-vpc.md)，包括释放地址池使用者创建的专有网络类型的分配以及自定义分配。
...
[上一篇：IP地址管理（IPAM）](products/vpc/documents/ip-address-management-ipam.md)[下一篇：地址资源管理](products/vpc/documents/shared-resource-discovery-for-multi-account-address-resource-conflict-management.md)
