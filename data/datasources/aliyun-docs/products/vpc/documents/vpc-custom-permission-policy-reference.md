...
[管理权限策略授权](products/ram/documents/manage-policy-references.md)
...
[上一篇：专有网络VPC系统权限策略参考](products/vpc/documents/vpc-1694081077178.md)[下一篇：使用专有网络VPC访问控制功能](products/vpc/documents/access-control-1.md)
