...
使用共享VPC实现存量云资源的网络互通时，请先参考[支持在共享交换机下创建的云资源类型](products/vpc/documents/vpc-sharing.md)和[交换机所有者和使用者的权限](products/vpc/documents/vpc-sharing.md)，判断是否适用。如果适用，建议优先在共享VPC中重建存量云资源；若云资源本身支持跨VPC迁移，也可直接迁移至共享VPC。如果不适用或重建、迁移不可行，请使用[VPC](products/vpc/documents/create-and-manage-vpc-peering-connection.md)[对等连接](products/vpc/documents/create-and-manage-vpc-peering-connection.md)或[云企业网](products/cen/documents/getting-started/use-enterprise-edition-transit-routers-to-connect-vpcs-across-regions-and-accounts.md)[CEN](products/cen/documents/getting-started/use-enterprise-edition-transit-routers-to-connect-vpcs-across-regions-and-accounts.md)实现跨账号网络互通。
...
| 弹性网卡 | 可以使用 [DescribeNetworkInterfaces](products/ecs/documents/developer-reference/api-ecs-2014-05-26-describenetworkinterfaces.md) 查看使用者创建的弹性网卡，无法管理使用者创建的弹性网卡。 | 只可查看和管理自身创建的弹性网卡，无法查看其他账号的弹性网卡。 |
...
其他[支持在共享交换机下创建的云资源类型](products/vpc/documents/vpc-sharing.md)，请在创建时选择共享交换机。
...
调用[DescribeVSwitches](products/vpc/documents/developer-reference/api-vpc-2016-04-28-describevswitches.md)获取交换机列表。
...
调用云资源的创建接口（例如ECS的[RunInstances](products/ecs/documents/developer-reference/api-ecs-2014-05-26-runinstances.md)），基于共享交换机创建云资源。
...
[上一篇：前缀列表](products/vpc/documents/vpc-prefix-lists.md)[下一篇：网络互通](products/vpc/documents/network-interworking.md)
