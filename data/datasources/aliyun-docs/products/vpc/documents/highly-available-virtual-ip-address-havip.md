...
调用[CreateHaVip](products/vpc/documents/developer-reference/api-vpc-2016-04-28-createhavip.md)创建 HaVip。

- 

调用[AssociateHaVip](products/vpc/documents/developer-reference/api-vpc-2016-04-28-associatehavip.md)绑定 HaVip 和 ECS 实例或弹性网卡。

- 

调用[UnassociateHaVip](products/vpc/documents/developer-reference/api-vpc-2016-04-28-unassociatehavip.md)解绑 HaVip 和 ECS 实例或弹性网卡。

- 

调用[DeleteHaVip](products/vpc/documents/developer-reference/api-vpc-2016-04-28-deletehavip.md)删除 HaVip。
...
HaVip 是交换机内的私网 IP 资源，如需公网访问，可以将 HaVip 与弹性公网IP（EIP）绑定。EIP 的使用会[产生费用](products/eip/documents/billing-overview.md)。
...
绑定 EIP 前，确保已调用[AllocateEipAddress](products/eip/documents/developer-reference/api-vpc-2016-04-28-allocateeipaddress-eips.md)创建 EIP。

- 

调用[AssociateEipAddress](products/eip/documents/developer-reference/api-vpc-2016-04-28-associateeipaddress-eips.md)绑定 HaVip 和 EIP。

- 

调用[UnassociateEipAddress](products/eip/documents/developer-reference/api-vpc-2016-04-28-unassociateeipaddress-eips.md)解绑 HaVip 和 EIP。
...
HaVip 绑定的云资源，如[ECS 实例](products/ecs/documents/billing-overview.md)、[EIP](products/eip/documents/billing-overview.md)，将按其各自的计费规则独立计费。
...
[上一篇：DHCP选项集与DNS主机名](products/vpc/documents/dhcp-option-set-and-dns-hostname.md)[下一篇：路由表](products/vpc/documents/vpc-route-table.md)
