...
在本场景下，使用[流量镜像](products/vpc/documents/traffic-mirroring-overview.md)，将ECS的网络流量复制到另一台部署着网络威胁检测系统的ECS上，通过配置安全规则，实时检测镜像网络流量。
...
镜像源和镜像目的不属于同一个VPC时，需要确保VPC间互通。本文示例通过[VPC](products/vpc/documents/create-and-manage-vpc-peering-connection.md)[对等连接](products/vpc/documents/create-and-manage-vpc-peering-connection.md)连通两个VPC。
...
[上一篇：流量镜像](products/vpc/documents/traffic-mirroring-overview.md)[下一篇：管理标签](products/vpc/documents/manage-vpc-tags.md)
