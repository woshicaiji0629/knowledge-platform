...
ossfs分为1.0和2.0两个版本。2.0版本是面向新形态计算密集型应用进行了全面重构的版本，实现了性能的全面升级，但对POSIX语义进行了部分限制，是未来的主线演进版本。如果您正在开展AI训练、推理、自动驾驶仿真等新型应用，且不方便使用OSS SDK和[使用](products/oss/documents/developer-reference/oss-connector-overview.md)[OSS Connector for AI/ML](products/oss/documents/developer-reference/oss-connector-overview.md)[加速模型训练](products/oss/documents/developer-reference/oss-connector-overview.md)，强烈建议使用[ossfs 2.0](products/oss/documents/developer-reference/ossfs-2-0.md)。相较之下，[ossfs 1.0](products/oss/documents/developer-reference/ossfs-overview.md)对POSIX语义支持更为全面，适合对性能无特殊需求的场景日常使用。
...
已[开通](https://oss.console.aliyun.com/overview)[OSS](https://oss.console.aliyun.com/overview)[服务](https://oss.console.aliyun.com/overview)并[创建](products/oss/documents/user-guide/create-a-bucket-4.md)[OSS Bucket](products/oss/documents/user-guide/create-a-bucket-4.md)。
...
[创建拥有](products/ram/documents/create-an-accesskey-pair-1.md)[OSS](products/ram/documents/create-an-accesskey-pair-1.md)[管理权限的](products/ram/documents/create-an-accesskey-pair-1.md)[RAM](products/ram/documents/create-an-accesskey-pair-1.md)[用户](products/ram/documents/create-an-accesskey-pair-1.md)[AccessKey](products/ram/documents/create-an-accesskey-pair-1.md)。
...
[ossfs 2.0](products/oss/documents/developer-reference/ossfs-2-0.md)[概述](products/oss/documents/developer-reference/ossfs-2-0.md)。

- 

[配置](products/oss/documents/developer-reference/configure-ossfs-2-0.md)[ossfs 2.0](products/oss/documents/developer-reference/configure-ossfs-2-0.md)。

- 

[ossfs 2.0](products/oss/documents/developer-reference/description-of-mount-options.md)[挂载选项说明](products/oss/documents/developer-reference/description-of-mount-options.md)。

- 

[ossfs 2.0](products/oss/documents/developer-reference/mount-buckets-using-ossfs-2-0.md)[挂载](products/oss/documents/developer-reference/mount-buckets-using-ossfs-2-0.md)[Bucket](products/oss/documents/developer-reference/mount-buckets-using-ossfs-2-0.md)[到本地系统](products/oss/documents/developer-reference/mount-buckets-using-ossfs-2-0.md)。

[上一篇：图形化管理工具ossbrowser 2.0快速入门](products/oss/documents/user-guide/ossbrowser.md)[下一篇：SDK快速入门](products/oss/documents/user-guide/oss-sdk-quick-start.md)
