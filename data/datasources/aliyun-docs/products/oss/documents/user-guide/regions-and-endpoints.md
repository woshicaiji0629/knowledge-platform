...
OSS在全球多个地域部署服务，每个地域提供外网、内网和双栈等不同类型的Endpoint。以下表格列出各地域对应的Endpoint和内网VIP网段，供快速查阅。如需了解各Endpoint类型的适用场景和使用方式，请参见[通过](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[Endpoint](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[和](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[Bucket](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[域名访问](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[OSS](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)。

重要

通过OSS提供的访问域名访问HTML、图片等文件时，浏览器会强制下载而非在线预览。如需实现文件预览功能，请[通过自定义域名访问](products/oss/documents/user-guide/access-buckets-via-custom-domain-names.md)[OSS](products/oss/documents/user-guide/access-buckets-via-custom-domain-names.md)。
...
| [无地域属性](products/oss/documents/user-guide/region-attribute-of-buckets.md) | rg-china-mainland | oss-rg-china-mainland.aliyuncs.com | 不支持 | 不支持 | 不支持 |
...
产品功能：新功能在发布初期通常在部分地域进行公测，如需使用最新功能，应在指定地域创建Bucket。详见[新功能发布记录](products/oss/documents/release-notes.md)。
...
若您因全球业务分发、异地容灾备份等场景，确实存在不可避免的少量跨境远距离访问需求，这 部分 访问建议您使用阿里云 OSS 传输加速（Transfer Acceleration）功能。详情请参见[通过传输加速访问](products/oss/documents/user-guide/transfer-acceleration.md)[OSS](products/oss/documents/user-guide/transfer-acceleration.md)。

## 相关文档

- 

[访问域名与网络连接概述](products/oss/documents/user-guide/access-and-network-overview.md)

- 

[通过](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[Endpoint](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[和](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[Bucket](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[域名访问](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)[OSS](products/oss/documents/user-guide/access-oss-via-bucket-domain-name.md)

- 

[通过传输加速访问](products/oss/documents/user-guide/transfer-acceleration.md)[OSS](products/oss/documents/user-guide/transfer-acceleration.md)

- 

[无地域属性](products/oss/documents/user-guide/region-attribute-of-buckets.md)[Bucket](products/oss/documents/user-guide/region-attribute-of-buckets.md)

- 

[使用限制及性能指标](products/oss/documents/user-guide/limits.md)

[上一篇：在Cursor中使用OSS文档](products/oss/documents/user-guide/use-the-oss-document-in-cursor.md)[下一篇：使用限制及性能指标](products/oss/documents/user-guide/limits.md)
