...
关于所有资源包类型的使用场景，请参见[资源包类型](products/oss/documents/resource-plan.md)。
...
一种类型的资源包只能抵扣使用该资源包对应计费项产生的费用，不能抵扣所有费用。更多信息，请参见[资源包类型](products/oss/documents/resource-plan.md)。

- 

OSS指定地域的资源包仅支持抵扣对应地域该资源包对应计费项产生的费用，中国内地通用资源包支持跨地域抵扣多个中国内地各地域该资源包对应计费项产生的费用。更多信息，请参见[抵扣地域](products/oss/documents/resource-plan.md)。
...
③关于中国内地通用资源包支持抵扣的中国内地地域，请参见[中国内地通用资源包支持的地域](products/oss/documents/resource-plan.md)。
...
| 资源包 | [购买](products/oss/documents/purchase-resource-plans.md) | [换购](products/oss/documents/resource-pack-exchange-guide.md) ① | [升级](products/oss/documents/upgrade-resource-plans.md) | [续费](products/oss/documents/renew-resource-plans.md) | [叠加](products/oss/documents/purchase-resource-plans.md) ② | [明细](products/oss/documents/view-the-usage-details-of-a-resource-plan.md) | [预警](products/oss/documents/configure-alerts-for-resource-plans.md) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 标准-同城冗余存储包 | ✓ | × | ✓ | ✓ | ✓ | ✓ | × |
| 低频-同城冗余存储包 | ✓ | × | ✓ | ✓ | ✓ | ✓ | × |
| 归档-同城冗余存储包 | ✓ | × | ✓ | ✓ | ✓ | ✓ | × |
...
[资源包购买指南](products/oss/documents/purchase-resource-plans.md)

- 

[资源包换购指南](products/oss/documents/resource-pack-exchange-guide.md)

- 

[资源包升级指南](products/oss/documents/upgrade-resource-plans.md)

- 

[资源包续费指南](products/oss/documents/renew-resource-plans.md)

- 

[资源包使用明细](products/oss/documents/view-the-usage-details-of-a-resource-plan.md)

- 

[资源包预警设置](products/oss/documents/configure-alerts-for-resource-plans.md)

- 

[资源包退款指南](products/oss/documents/refund-resource-plans.md)

- 

[资源包](products/oss/documents/package-faq.md)

[上一篇：按量付费](products/oss/documents/pay-as-you-go-1.md)[下一篇：资源包购买指南](products/oss/documents/purchase-resource-plans.md)
