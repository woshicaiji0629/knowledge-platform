...
您可以使用AccessKey ID与AccessKey Secret登录ossbrowser来验证正确性。具体步骤，请参见[安装并登录](products/oss/documents/developer-reference/install-ossbrowser-1-0.md)[ossbrowser](products/oss/documents/developer-reference/install-ossbrowser-1-0.md)。

- 

检查签名算法是否正确。

OSS提供两种携带签名的请求方式，分别为[在](products/oss/documents/developer-reference/include-signatures-in-the-authorization-header.md)[Header](products/oss/documents/developer-reference/include-signatures-in-the-authorization-header.md)[中包含签名](products/oss/documents/developer-reference/include-signatures-in-the-authorization-header.md)和[在](products/oss/documents/developer-reference/ddd-signatures-to-urls.md)[URL](products/oss/documents/developer-reference/ddd-signatures-to-urls.md)[中包含签名](products/oss/documents/developer-reference/ddd-signatures-to-urls.md)。关于这两种签名方式的算法说明如下：
...
如果业务场景允许，推荐您使用SDK访问OSS，免去手动计算签名的过程。具体步骤，请参见[使用阿里云](products/oss/documents/developer-reference/overview-63.md)[SDK](products/oss/documents/developer-reference/overview-63.md)[发起请求](products/oss/documents/developer-reference/overview-63.md)。
...
关于签名错误常见场景的更多信息，请参见[0002-00000040](products/oss/documents/user-guide/0002-00000040.md)。

[上一篇：URL签名](products/oss/documents/developer-reference/signed-urls.md)[下一篇：产品计费](products/oss/documents/billing.md)
