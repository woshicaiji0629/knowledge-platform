...
| GPU jobs | [工作流指定](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/run-a-workflow-using-a-specified-ecs-specification.md) [GPU](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/run-a-workflow-using-a-specified-ecs-specification.md) [机型运行工作流](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/run-a-workflow-using-a-specified-ecs-specification.md) |  |
| Volumes | [Volumes](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-volumes.md) |  |
...
| 计算环境（Compute Environment) | [Serverless Kubernetes](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/overview-12.md) [集群](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/overview-12.md) |  |
| 生态集成 | 事件驱动 | [事件驱动](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/turn-on-event-driven-functions.md) |
| 可观测性 | [可观测性](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/observability.md) |  |
...
具体操作，请参见[工作流集群快速入门](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/workflow-cluster-quickstart.md)。
...
确保容器Argo工作流集群可以访问工作流运行所需要的数据，工作流集群可以挂载访问阿里云OSS、NAS、CPFS、云盘等存储资源。更多信息，请参见[使用存储卷](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-volumes.md)。
...
开启容器Argo工作流集群[可观测能力](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/observability.md)，查看工作流运行状态和日志。
...
了解工作流集群的功能原理及相关操作，请参见[容器](products/ack/documents/ack-argo-workflow-cluster/product-overview/container-argo-workflow-cluster-overview.md)[Argo](products/ack/documents/ack-argo-workflow-cluster/product-overview/container-argo-workflow-cluster-overview.md)[工作流集群概述](products/ack/documents/ack-argo-workflow-cluster/product-overview/container-argo-workflow-cluster-overview.md)。

- 

创建工作流集群，具体操作，请参见[创建工作流集群](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-a-workflow-cluster.md)。

- 

创建工作流，具体操作，请参见[创建工作流](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-a-workflow.md)。

- 

在工作流集群中挂载存储卷，具体操作，请参见[使用存储卷](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-volumes.md)。

[上一篇：实践教程](products/ack/documents/ack-argo-workflow-cluster/use-cases.md)[下一篇：使用Argo Workflow编排动态DAG Fan-out/Fan-in任务](products/ack/documents/ack-argo-workflow-cluster/use-cases/use-argo-workflows-to-orchestrate-dynamic-dag-fan-out-fan-in-tasks.md)
