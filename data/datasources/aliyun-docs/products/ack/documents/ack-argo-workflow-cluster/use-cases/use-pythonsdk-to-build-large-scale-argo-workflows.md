...
[配置](products/ack/documents/ack-argo-workflow-cluster/user-guide/configure-artifacts.md)[Artifacts](products/ack/documents/ack-argo-workflow-cluster/user-guide/configure-artifacts.md)。
...
[上一篇：使用Argo Workflows安全高效管理文件](products/ack/documents/ack-argo-workflow-cluster/use-cases/manage-files-securely-and-efficiently-with-argo-workflows.md)[下一篇：基于EventBridge的事件驱动CI Pipeline](products/ack/documents/ack-argo-workflow-cluster/use-cases/event-driven-ci-pipeline-via-eventbridge.md)
