...
如需确认Pod运行状态，请参见[管理容器组（Pod）](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/manage-pods.md)。

[上一篇：节点池应用集管理](products/ack/documents/ack-edge/user-guide/node-pool-yurtappset-management.md)[下一篇：ENS管理](products/ack/documents/ack-edge/user-guide/ens-management-overview.md)
