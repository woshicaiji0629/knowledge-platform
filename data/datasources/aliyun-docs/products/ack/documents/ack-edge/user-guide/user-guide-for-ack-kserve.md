...
已创建ACK Edge集群，且集群版本为1.22及以上。具体操作，请参见[创建](products/ack/documents/ack-edge/user-guide/create-an-ack-edge-cluster-1.md)[ACK Edge](products/ack/documents/ack-edge/user-guide/create-an-ack-edge-cluster-1.md)[集群](products/ack/documents/ack-edge/user-guide/create-an-ack-edge-cluster-1.md)。

- 

已安装Nginx Ingress Controller组件。具体操作，请参见[如何在](products/ack/documents/ack-edge/user-guide/edge-cluster-ingress-overview.md)[ACK Edge](products/ack/documents/ack-edge/user-guide/edge-cluster-ingress-overview.md)[集群部署](products/ack/documents/ack-edge/user-guide/edge-cluster-ingress-overview.md)[Ingress Controller](products/ack/documents/ack-edge/user-guide/edge-cluster-ingress-overview.md)。
...
在Helm页面，单击kserve，然后单击inferenceservice-config，单击YAML 编辑，修改YAML文件中的ingressClassName字段，使其与[安装](products/ack/documents/ack-edge/user-guide/edge-cluster-ingress-overview.md)[Nginx Ingress Controller](products/ack/documents/ack-edge/user-guide/edge-cluster-ingress-overview.md)时指定的ingressClassResource.name一致。
...
如集群中没有cert-manager的CRD资源，请参见[步骤一](products/ack/documents/cloud-native-ai-suite/user-guide/installing-ack-kserve-components.md)安装cert-manager组件。
...
[上一篇：使用共享GPU调度能力](products/ack/documents/ack-edge/user-guide/enable-gpu-sharing.md)[下一篇：使用Fluid加速边缘节点访问OSS文件](products/ack/documents/ack-edge/user-guide/use-fluid-to-accelerate-access-to-oss-files-from-edge-nodes.md)
