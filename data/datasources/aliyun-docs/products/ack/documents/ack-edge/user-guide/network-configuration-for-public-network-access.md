...
为了确保IDC设备或边缘设备能顺利接入ACK Edge集群，您需要放通下表域名。其中{region}为集群所在地域的Region ID，例如杭州地域为cn-hangzhou。具体各地域所对应的Region ID，请参见[开服地域](products/ack/documents/product-overview/supported-regions.md)。
...
[上一篇：网络管理](products/ack/documents/ack-edge/user-guide/network-management-overview.md)[下一篇：专线环境下的网元配置](products/ack/documents/ack-edge/user-guide/network-element-configuration-in-leased-line-environment.md)
