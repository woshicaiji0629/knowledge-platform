...
已创建Kubernetes托管版集群，具体操作，请参见[创建](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/create-an-ack-managed-cluster-2.md)[ACK](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/create-an-ack-managed-cluster-2.md)[托管集群](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/create-an-ack-managed-cluster-2.md)。

- 

已通过kubectl工具连接Kubernetes集群。具体操作，请参见[获取集群](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[KubeConfig](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[并通过](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[kubectl](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[工具连接集群](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)。

- 

集群使用Terway网络模式。更多信息，请参见[使用](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/work-with-terway.md)[Terway](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/work-with-terway.md)[网络插件](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/work-with-terway.md)。
...
登录[RDS](https://rdsnext.console.aliyun.com/?spm=5176.2020520152.nav-right.2.469016ddzrU6KW#/detail/rm-bp12685y16w4zjz9d/security/whiteList?region=cn-hangzhou)[控制台](https://rdsnext.console.aliyun.com/?spm=5176.2020520152.nav-right.2.469016ddzrU6KW#/detail/rm-bp12685y16w4zjz9d/security/whiteList?region=cn-hangzhou)，查看Annotation中RDS实例中的白名单。有关如何查看RDS的白名单，请参见[高安全白名单模式](products/rds/documents/apsaradb-rds-for-postgresql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-postgresql-instance.md)[IP](products/rds/documents/apsaradb-rds-for-postgresql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-postgresql-instance.md)[白名单](products/rds/documents/apsaradb-rds-for-postgresql/configure-an-ip-address-whitelist-for-an-apsaradb-rds-for-postgresql-instance.md)。

此时，控制台显示规则已经自动添加。

- 

将[步骤](products/ack/documents/ack-edge/security-and-compliance/dynamically-add-the-ip-addresses-of-pods-to-the-whitelists-of-alibaba-cloud-services.md)[1](products/ack/documents/ack-edge/security-and-compliance/dynamically-add-the-ip-addresses-of-pods-to-the-whitelists-of-alibaba-cloud-services.md)中的Deployment的副本数设置为0，再次查看RDS白名单。
...
如果您不再使用ack-kubernetes-webhook-injector，可以在ACK发布功能中将其删除。具体操作，请参见[基于](products/ack/documents/manage-releases-by-using-helm.md)[Helm](products/ack/documents/manage-releases-by-using-helm.md)[的发布管理](products/ack/documents/manage-releases-by-using-helm.md)。同时，请执行以下命令清理配置信息。
...
[上一篇：使用自定义Worker RAM角色](products/ack/documents/ack-edge/security-and-compliance/use-custom-worker-ram-roles.md)[下一篇：自定义集群API Server证书SAN](products/ack/documents/ack-edge/security-and-compliance/customize-the-san-of-the-api-server-certificate-when-you-create-an-ack-cluster.md)
