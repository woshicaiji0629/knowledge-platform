# 使用CLI添加已有ECS实例到集群-容器服务 Kubernetes 版 ACK-阿里云

Source: https://help.aliyun.com/zh/ack/ack-edge/developer-reference/add-an-existing-ecs-instance
...
具体的API描述，请参见[添加已有实例至节点池](products/ack/documents/api-add-existing-instances-to-a-node-pool.md)。
...
[上一篇：创建集群](products/ack/documents/ack-edge/developer-reference/create-a-cluster.md)[下一篇：删除集群实例](products/ack/documents/ack-edge/developer-reference/deleting-a-cluster.md)
