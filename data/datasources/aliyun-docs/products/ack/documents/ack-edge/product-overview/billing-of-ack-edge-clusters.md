...
默认情况下，节点管理费用采用按量付费的方式，也可以购买[容器服务边缘节点资源包](products/ack/documents/ack-edge/product-overview/billing-of-ack-edge-clusters.md)来抵扣。
...
| --- | --- | --- | --- | --- | --- |
| [云服务器](products/ecs/documents/user-guide/what-is-ecs.md) [ECS](products/ecs/documents/user-guide/what-is-ecs.md) | 必选项 | 用于为 ACK Edge 集群 创建节点。 | 支持 | 不支持 | [计费概述](products/ecs/documents/billing-overview.md) |
...
| [弹性公网](products/eip/documents/product-overview/what-is-eip.md) [IP](products/eip/documents/product-overview/what-is-eip.md) | 建议项 | 用于云资源与公网通信。 | 不支持 | 不支持 | [计费概述](products/eip/documents/billing-overview.md) |
...
| [日志服务](products/sls/documents/what-is-log-service.md) [SLS](products/sls/documents/what-is-log-service.md) | 建议项 | 用于集群组件和应用的日志采集和检索。 | 不支持 | 支持 说明 可参考如下文档，根据业务需要选购合适的资源包： [选购资源包](products/sls/documents/purchase-a-resource-plan.md) 。 | [计费概述](products/sls/documents/billing-overview.md) |
...
| [可观测监控 Prometheus 版](products/arms/documents/prometheus-monitoring/product-overview/what-is-prometheus.md) | 建议项 | 基于 Prometheus 实现对集群的监控和告警。 | 不支持 | 不支持 | [按量计费](products/arms/documents/prometheus-monitoring/product-overview/pay-as-you-go.md) |
| [NAT 网关服务](products/nat-gateway/documents/product-overview/what-is-nat-gateway.md) | 可选项 | 用于为集群开启公网访问和公网镜像拉取。 | 不支持 | 支持 说明 可参考如下文档，根据业务需要选购合适的资源包： [NAT 网关资源包](products/nat-gateway/documents/nat-resource-plans.md) 。 | [NAT 网关计费](products/nat-gateway/documents/nat-gateway-billing.md) |
...
| [对象存储](products/oss/documents/user-guide/what-is-oss.md) [OSS](products/oss/documents/user-guide/what-is-oss.md) | 可选项 | 基于 OSS 实现集群应用数据的对象存储方案。 | 不支持 | 支持 说明 可参考如下文档，根据业务需要选购合适的资源包： [资源包购买指南](products/oss/documents/purchase-resource-plans.md) 。 | [计费概述](products/oss/documents/billing-overview.md) |
| [KMS](products/kms/documents/key-management-service/support/what-is-key-management-service.md) [密钥管理服务](products/kms/documents/key-management-service/support/what-is-key-management-service.md) | 可选项 | 用于集群应用密钥的管理以及 Pro 版集群开启密钥的落盘加密能力。 | 不支持 | 不支持 | [KMS 1.0](products/kms/documents/key-management-service/support/billing-of-kms.md) [计费说明](products/kms/documents/key-management-service/support/billing-of-kms.md) |
...
| [云企业网](products/cen/documents/product-overview/what-is-cen.md) | 可选项 | 用于在跨地域专有网络之间，以及专有网络与本地数据中心间搭建私网通信通道。 | 支持 说明 带宽包支持包年包月。 | 支持带宽包 说明 可参考如下文档，根据需求选择合适的带宽包操作： [使用带宽包](products/cen/documents/user-guide/work-with-a-bandwidth-plan.md) 。 | [计费说明](products/cen/documents/product-overview/billing-rules.md) |
...
关于查看账单的具体操作，请参见[查看账单](products/ack/documents/ack-managed-and-ack-dedicated/product-overview/view-your-bills.md)。
...
[上一篇：什么是容器服务 Edge 版](products/ack/documents/ack-edge/product-overview/ack-edge-overview.md)[下一篇：快速入门](products/ack/documents/ack-edge/quick-start.md)
