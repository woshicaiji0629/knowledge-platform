# 使用Terraform开通ACK后授权服务角色-容器服务 Kubernetes 版 ACK-阿里云

Source: https://help.aliyun.com/zh/ack/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-assign-default-roles-to-ack-when-you-use-ack-for-the-first-time
...
在示例中，variable表示作为参数提供给Terraform使用的输入变量，关于参数如何传值，请参见[Variable](https://help.aliyun.com/zh/terraform/variable-introduction)。本示例中参数值请参见[附录](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-assign-default-roles-to-ack-when-you-use-ack-for-the-first-time.md)，其中，服务角色是必选参数，可选角色请根据实际情况选择。
...
[AliyunCSManagedCsiPluginRole](products/ram/documents/developer-reference/aliyuncsmanagedcsipluginrolepolicy.md)
...
Terraform介绍，请参见[Terraform](https://help.aliyun.com/zh/terraform/what-is-terraform)[产品介绍](https://help.aliyun.com/zh/terraform/what-is-terraform)。
...
[上一篇：Terraform概述](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/terraform-overview.md)[下一篇：通过Terraform创建ACK托管集群](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-ack-managed-cluster.md)
