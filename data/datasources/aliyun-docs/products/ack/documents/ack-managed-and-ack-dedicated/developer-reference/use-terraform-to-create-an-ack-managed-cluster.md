...
创建ACK托管集群时需要安装额外组件，请参见[使用](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-manage-plug-ins.md)[Terraform](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-manage-plug-ins.md)[管理组件](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-manage-plug-ins.md)。

- 

关于节点池创建的更多内容，请参见[通过](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-auto-scaling-node-pool.md)[Terraform](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-auto-scaling-node-pool.md)[创建具备自动伸缩功能的节点池](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-auto-scaling-node-pool.md)。
...
[上一篇：通过Terraform开通ACK并授权角色](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-assign-default-roles-to-ack-when-you-use-ack-for-the-first-time.md)[下一篇：通过Terraform创建ACK专有集群](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/use-terraform-to-create-an-ack-proprietary-cluster.md)
