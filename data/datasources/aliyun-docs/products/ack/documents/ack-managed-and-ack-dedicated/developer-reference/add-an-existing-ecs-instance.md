# 使用CLI添加已有ECS实例到ACK集群-容器服务 Kubernetes 版 ACK-阿里云

Source: https://help.aliyun.com/zh/ack/ack-managed-and-ack-dedicated/developer-reference/add-an-existing-ecs-instance
...
[上一篇：创建集群](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/create-a-cluster-2.md)[下一篇：删除集群实例](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/delete-a-cluster-3.md)
