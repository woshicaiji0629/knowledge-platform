# 使用aliyun cs命令删除集群实例-容器服务 Kubernetes 版 ACK-阿里云

Source: https://help.aliyun.com/zh/ack/ack-managed-and-ack-dedicated/developer-reference/delete-a-cluster-3
...
根据集群ID，删除集群实例，并释放集群所有节点资源。

具体的API描述，请参见[删除集群](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/api-cs-2015-12-15-deletecluster.md)。
...
[上一篇：添加已有ECS实例](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/add-an-existing-ecs-instance.md)[下一篇：SDK参考](products/ack/documents/ack-managed-and-ack-dedicated/developer-reference/sdk-examples-1.md)
