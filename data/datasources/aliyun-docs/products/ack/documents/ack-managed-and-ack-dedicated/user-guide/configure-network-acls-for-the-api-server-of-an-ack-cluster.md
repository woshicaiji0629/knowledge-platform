...
负载均衡提供监听级别的访问控制。您可以在创建监听时配置访问控制，也可以在监听创建后修改或重新配置访问控制。更多信息，请参见[访问控制](products/slb/documents/classic-load-balancer/user-guide/access-control.md)。
...
在此开启访问控制之前，您需要首先[访问控制](products/slb/documents/classic-load-balancer/user-guide/access-control.md)，并[访问控制](products/slb/documents/classic-load-balancer/user-guide/access-control.md)。更多CLB访问控制信息，请参见[访问控制](products/slb/documents/classic-load-balancer/user-guide/access-control.md)。
...
[上一篇：在Workbench或CloudShell上使用kubectl连接集群](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/use-kubectl-on-cloud-shell-to-manage-ack-clusters-1690962464408.md)[下一篇：实现从公网访问API Server](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/control-public-access-to-the-api-server-of-a-cluster.md)
