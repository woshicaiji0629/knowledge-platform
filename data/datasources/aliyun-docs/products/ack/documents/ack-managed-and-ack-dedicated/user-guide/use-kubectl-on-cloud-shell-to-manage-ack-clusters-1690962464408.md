...
[Workbench](products/ecs/documents/user-guide/workbench-overview.md)：阿里云提供的ECS实例远程连接工具，无需额外安装软件。支持通过公网和内网连接集群。
...
RAM用户使用CloudShell前需要被授予AliyunCloudShellFullAccess权限，如需创建并绑定NAS文件系统，还需被授予AliyunNASFullAccess权限，请参见[为](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)[RAM](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)[用户授权](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)。
...
请按需对KubeConfig进行吊销、清除等操作，避免KubeConfig泄露带来的数据泄露等安全风险，请参见[管理](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/kubeconfig-operation-guide.md)[KubeConfig](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/kubeconfig-operation-guide.md)。
...
关于Workbench的一些基础操作，例如文件的上传、查看、删除等，请参见[Workbench](products/ecs/documents/user-guide/basic-operations-in-workbench.md)[基础操作](products/ecs/documents/user-guide/basic-operations-in-workbench.md)。

[上一篇：获取集群KubeConfig并通过kubectl工具连接集群](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/obtain-the-kubeconfig-file-of-a-cluster-and-use-kubectl-to-connect-to-the-cluster.md)[下一篇：配置API Server的访问控制策略](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/configure-network-acls-for-the-api-server-of-an-ack-cluster.md)
