...
[关键指标](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)：快速查看集群关键指标。

- 

[概览](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)：分析API Server的响应时延、当前处理请求数和是否有限流发生。

- 

[资源分析](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)：查看托管侧组件的资源水位。

- 

[QPS](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)[和时延](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)：通过多维度深入分析QPS、RT。

- 

[APF](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)[限流](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)：根据[APF](https://kubernetes.io/docs/concepts/cluster-administration/flow-control/)指标确认API Server的请求流量分布、限流状态以及系统性能瓶颈。

- 

[注入控制器和](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)[Webhook](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)：分析准入控制器和Webhook的QPS、RT。

- 

[客户端分析](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)：通过客户端多维度分析QPS。
...
APF相关指标仅支持1.20及以上版本集群。如需升级，请参见[手动升级集群](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/update-the-kubernetes-version-of-an-ack-cluster.md)。
...
[ack-arms-prometheus](products/arms/documents/prometheus-monitoring/prometheus-monitoring-change-records-2.md)组件：v1.1.31及以上版本。
...
参见[准入](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)[Webhook](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)[时延](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)，分析是否由于Webhook执行较慢，导致API Server请求延时长。
...
查看[QPS](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)[和时延](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)和[客户端分析](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)，分析请求中占比位于头部的请求，评估是否符合预期。如果请求为实际业务发起，您可以判断是否需降低请求量。

- 

参见[准入](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)[Webhook](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)[时延](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-apiserver.md)，分析是否因为Webhook执行慢导致API Server请求处理慢。
...
[etcd](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-etcd.md)[组件监控指标说明](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-etcd.md)

- 

[kube-scheduler](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-scheduler.md)[组件监控指标说明](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-scheduler.md)

- 

[kube-controller-manager](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-controller-manager.md)[组件监控指标说明](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-kube-controller-manager.md)

- 

[cloud-controller-manager](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-cloud-controller-manager.md)[组件监控指标说明](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-cloud-controller-manager.md)

- 

关于如何通过控制台或API获取Prometheus监控数据，请参见[通过](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/use-promql-to-query-prometheus-monitoring-data.md)[PromQL](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/use-promql-to-query-prometheus-monitoring-data.md)[查询](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/use-promql-to-query-prometheus-monitoring-data.md)[Prometheus](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/use-promql-to-query-prometheus-monitoring-data.md)[监控数据](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/use-promql-to-query-prometheus-monitoring-data.md)。

- 

关于如何通过阿里云Prometheus监控自定义PromQL配置报警规则，请参见[创建](products/arms/documents/prometheus-monitoring/create-an-alert-rule-for-a-prometheus-instance.md)[Prometheus](products/arms/documents/prometheus-monitoring/create-an-alert-rule-for-a-prometheus-instance.md)[告警规则](products/arms/documents/prometheus-monitoring/create-an-alert-rule-for-a-prometheus-instance.md)。

[上一篇：查看集群控制面组件监控大盘](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/view-control-plane-component-dashboards-in-ack-pro-clusters.md)[下一篇：etcd组件监控指标说明](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/monitor-etcd.md)
