...
${base64CAKey}为[步骤](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/update-expired-certificates-of-a-kubernetes-cluster.md)[2](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/update-expired-certificates-of-a-kubernetes-cluster.md)获取的通过base64编码后的集群根私钥。

- 

在集群的每个Worker节点重复此步骤，完成所有Worker节点的证书更新。

[上一篇：更新ACK专有集群即将过期的证书](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/renew-expiring-kubernetes-cluster-certificates.md)[下一篇：轮转ACK专有集群etcd证书](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/renew-etcd-certificates-in-ack-dedicated-clusters.md)
