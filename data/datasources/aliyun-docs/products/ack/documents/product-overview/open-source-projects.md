...
| --- | --- | --- | --- | --- |
| 核心组件 | Kubernetes Cloud Controller Manager for Alibaba Cloud | 为 Kubernetes 应用创建负载均衡，管理节点路由条目。 | [Cloud-Provider-Alibaba-Cloud](https://github.com/kubernetes/cloud-provider-alibaba-cloud) | [Cloud Controller Manager](products/ack/documents/product-overview/cloud-controller-manager.md) |
| 网络 | Terway CNI Network Plugin | Terway 网络插件是阿里云容器服务自研的网络插件，使用原生的弹性网卡分配给 Pod，实现 Pod 网络。 | [Terway](https://github.com/AliyunContainerService/terway) | [使用](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/work-with-terway.md) [Terway](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/work-with-terway.md) [网络插件](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/work-with-terway.md) |
...
| 存储 | Alibaba Cloud Kubernetes CSI Plugin | 容器存储接口，实现存储卷生命周期管理。 | [Alibaba-Cloud-CSI-Driver](https://github.com/kubernetes-sigs/alibaba-cloud-csi-driver) | [存储](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/csi-overview-1.md) [CSI](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/csi-overview-1.md) [概述](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/csi-overview-1.md) |
| 阿里云容器服务 Kubernetes Flexvolume 插件 | 提供挂载和卸载 Kubernetes 存储卷能力的组件（早期版）。 | [Flexvolume](https://github.com/AliyunContainerService/flexvolume) | [存储](products/ack/documents/flexvolume-overview.md) [Flexvolume](products/ack/documents/flexvolume-overview.md) [概述](products/ack/documents/flexvolume-overview.md) |  |
...
| 弹性 | Kubernetes-CronHPA-Controller | Kubernetes 中的容器水平定时伸缩组件。 | [Kubernetes-CronHPA-Controller](https://github.com/AliyunContainerService/kubernetes-cronhpa-controller) | [容器定时伸缩（CronHPA）](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/cronhpa.md) |
| Kubernetes Autoscaler | Kubernetes 中的容器节点水平伸缩组件。 | [Autoscaler](https://github.com/kubernetes/autoscaler) | [节点自动伸缩](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/auto-scaling-of-nodes.md) |  |
| 安全 | KMS provider plugin for Alibaba Cloud | 基于阿里云 KMS 服务的密钥管理能力，实现 Kubernetes Secret 的落盘加密能力。 | [Ack-KMS-Plugin](https://github.com/AliyunContainerService/ack-kms-plugin) | [使用阿里云](products/ack/documents/ack-managed-and-ack-dedicated/security-and-compliance/use-kms-to-encrypt-kubernetes-secrets-2.md) [KMS](products/ack/documents/ack-managed-and-ack-dedicated/security-and-compliance/use-kms-to-encrypt-kubernetes-secrets-2.md) [进行](products/ack/documents/ack-managed-and-ack-dedicated/security-and-compliance/use-kms-to-encrypt-kubernetes-secrets-2.md) [Secret](products/ack/documents/ack-managed-and-ack-dedicated/security-and-compliance/use-kms-to-encrypt-kubernetes-secrets-2.md) [的落盘加密](products/ack/documents/ack-managed-and-ack-dedicated/security-and-compliance/use-kms-to-encrypt-kubernetes-secrets-2.md) |
...
| SGX-Device-Plugin | 在机密计算场景中，专用于 SGX 设备 EPC 加密内存资源扩展的 Kubernetes 设备插件。 | [SGX-Device-Plugin](https://github.com/AliyunContainerService/sgx-device-plugin) | [SGX-Device-Plugin](products/ack/documents/product-overview/sgx-device-plugin.md) |  |
...
| Image Build Specification of Alibaba Cloud Container Service for Kubernetes (ACK) | 快速制作符合 Kubernetes 集群节点要求的自定义镜像的工具。 | [ACK-Image-Builder](https://github.com/AliyunContainerService/ack-image-builder) | [使用自定义镜像创建](products/ack/documents/use-a-custom-image-to-create-an-ack-cluster.md) [ACK](products/ack/documents/use-a-custom-image-to-create-an-ack-cluster.md) [集群](products/ack/documents/use-a-custom-image-to-create-an-ack-cluster.md) |  |
...
| 应用管理 | Kube-eventer | 开源 Kubernetes 事件收集工具，支持 Kafka、MySQL、钉钉、飞书等多种离线链路。 | [Kube-Eventer](https://github.com/AliyunContainerService/kube-eventer) | [事件监控](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/event-monitoring.md) |
...
[上一篇：配额与限制](products/ack/documents/product-overview/limits.md)[下一篇：操作指南](products/ack/documents/ack-user-guide.md)
