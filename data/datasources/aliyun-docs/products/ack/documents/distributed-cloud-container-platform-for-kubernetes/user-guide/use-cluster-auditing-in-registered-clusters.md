...
已创建注册集群，并将自建Kubernetes集群接入注册集群。具体操作，请参见[创建注册集群](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-ack-one-registered-clusters.md)。
...
若您的集群版本低于1.24，apiVersion请使用audit.k8s.io/v1beta1，若集群版本大于等于1.24，则使用audit.k8s.io/v1。更多详细信息，请参见[Kubernetes 1.24](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/kubernetes-1-24-release-notes.md)[版本说明](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/kubernetes-1-24-release-notes.md)。
...
需要将{cluster_id}替换为您集群的Cluster ID。关于集群ID的获取，请参见[查看集群信息](products/ack/documents/ack-managed-and-ack-dedicated/user-guide/view-cluster-information.md)。
...
关于安装logtail-ds日志组件的具体操作，请参见[步骤二：安装](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/enable-log-service-for-an-external-kubernetes-cluster.md)[logtail-ds](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/enable-log-service-for-an-external-kubernetes-cluster.md)[组件](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/enable-log-service-for-an-external-kubernetes-cluster.md)。

## 后续步骤

关于如何使用和查看集群API Server审计功能，请参见[使用集群](products/ack/documents/ack-managed-and-ack-dedicated/security-and-compliance/work-with-cluster-auditing.md)[API Server](products/ack/documents/ack-managed-and-ack-dedicated/security-and-compliance/work-with-cluster-auditing.md)[审计功能](products/ack/documents/ack-managed-and-ack-dedicated/security-and-compliance/work-with-cluster-auditing.md)。

[上一篇：在注册集群中安装和使用云安全中心](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/install-and-use-security-center-in-registered-clusters.md)[下一篇：使用配置巡检功能检查注册集群Workload安全隐患](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-the-inspection-feature-to-check-for-security-risks-in-the-workloads-of-a-registered-kubernetes-cluster.md)
