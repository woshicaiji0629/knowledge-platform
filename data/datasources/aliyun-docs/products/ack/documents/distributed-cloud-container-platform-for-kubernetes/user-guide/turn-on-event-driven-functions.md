...
[创建工作流集群](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-a-workflow-cluster.md)
...
请将ClusterId后的***替换为您在[步骤](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/turn-on-event-driven-functions.md)[1](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/turn-on-event-driven-functions.md)中实际获取的工作流集群ID。
...
[通过轻量消息队列（原 MNS）触发工作流](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-mns-messages-to-trigger-workflows.md)

- 

[通过向](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/trigger-a-workflow-by-uploading-a-file-to-oss.md)[OSS](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/trigger-a-workflow-by-uploading-a-file-to-oss.md)[上传文件触发工作流](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/trigger-a-workflow-by-uploading-a-file-to-oss.md)

[上一篇：事件驱动](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/event-driven.md)[下一篇：通过轻量消息队列（原 MNS）触发工作流](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-mns-messages-to-trigger-workflows.md)
