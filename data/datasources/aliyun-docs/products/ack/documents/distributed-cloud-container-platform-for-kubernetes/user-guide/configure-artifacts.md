# 配置Argo工作流Artifacts使用OSS实现步骤间参数传递-容器服务 Kubernetes 版 ACK-阿里云

Source: https://help.aliyun.com/zh/ack/distributed-cloud-container-platform-for-kubernetes/user-guide/configure-artifacts
...
已开通阿里云对象存储（OSS）服务。具体操作，请参见[开通](products/oss/documents/getting-started/activate-oss.md)[OSS](products/oss/documents/getting-started/activate-oss.md)[服务](products/oss/documents/getting-started/activate-oss.md)。
...
[上一篇：持久化工作流](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/persistence-workflow.md)[下一篇：镜像](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/images.md)
