...
[创建分布式工作流](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-a-workflow-cluster.md)[Argo](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-a-workflow-cluster.md)[集群](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-a-workflow-cluster.md)
...
[安装阿里云](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-a-workflow.md)[Argo CLI](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/create-a-workflow.md)
...
使用以下内容在工作流集群中创建PV/PVC。具体操作，请参见[使用](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-volumes.md)[NAS](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-volumes.md)[存储卷](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/user-guide/use-volumes.md)。
...
参数填写请参考[模板参数说明](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/use-cases/building-a-ci-pipeline-of-golang-project-based-on-workflow-cluster.md)将参数值设置为您实际使用的参数值。
...
使用以下内容创建workflow.yaml文件，按照[模板参数说明](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/use-cases/building-a-ci-pipeline-of-golang-project-based-on-workflow-cluster.md)将参数值修改为您实际使用的参数值。
...
[上一篇：CI/CD](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/use-cases/ci-cd.md)[下一篇：在CI Pipeline中Clone私有Git仓库](products/ack/documents/distributed-cloud-container-platform-for-kubernetes/use-cases/clone-private-git-repository-in-ci-pipeline.md)
