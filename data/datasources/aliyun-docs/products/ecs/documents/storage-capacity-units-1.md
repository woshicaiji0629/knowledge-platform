...
云盘仅支持使用SCU抵扣按量存储费用，以节约使用成本。云盘存储费用的抵扣顺序为：SCU ＞ 按量付费。关于云盘更多的计费信息，请参见[块存储计费](products/ecs/documents/block-storage-devices.md)。
...
关于快照更多的计费信息，请参见[快照计费](products/ecs/documents/snapshots-1.md)。
...
您可以调用API[PurchaseStorageCapacityUnit](products/ecs/documents/developer-reference/api-ecs-2014-05-26-purchasestoragecapacityunit.md)接口购买一个或多个存储容量单位包。

- 

您可以调用API[ModifyStorageCapacityUnitAttribute](products/ecs/documents/developer-reference/api-ecs-2014-05-26-modifystoragecapacityunitattribute.md)接口修改存储容量单位包的名称或者描述信息。

- 

您可以调用API[DescribeStorageCapacityUnits](products/ecs/documents/developer-reference/api-ecs-2014-05-26-describestoragecapacityunits.md)接口查询存储容量单位包详细信息，包括SCU容量大小和状态等。

## 常见问题

关于存储容量单位包SCU的常见问题，请参见[计费](products/ecs/documents/billing-faq.md)[FAQ](products/ecs/documents/billing-faq.md)。

[上一篇：资源保障](products/ecs/documents/resource-assurance-1.md)[下一篇：OSS资源包](products/ecs/documents/oss-storage-bag.md)
