...
[我的包年包月](products/ecs/documents/billing-method-faqs.md)[ECS](products/ecs/documents/billing-method-faqs.md)[实例为什么会产生按量付费费用？只购买了包年包月](products/ecs/documents/billing-method-faqs.md)[ECS](products/ecs/documents/billing-method-faqs.md)[为什么还没到期就欠费了？](products/ecs/documents/billing-method-faqs.md)

- 

[包年包月实例未到期但提示欠费，是什么原因？](products/ecs/documents/billing-method-faqs.md)

- 

[包年包月和预留实例券和或节省计划对比有什么差异？](products/ecs/documents/billing-method-faqs.md)

## 按量付费实例计费问题

- 

[按量付费实例能使用代金券结算吗？](products/ecs/documents/billing-method-faqs.md)

- 

[按量付费实例能备案吗？](products/ecs/documents/billing-method-faqs.md)

- 

[按量付费实例结算时间怎么算？](products/ecs/documents/billing-method-faqs.md)

- 

[按量付费](products/ecs/documents/billing-method-faqs.md)[ECS](products/ecs/documents/billing-method-faqs.md)[实例停机或欠费停机后，会产生费用吗？](products/ecs/documents/billing-method-faqs.md)
...
[包年包月转按量付费失败时如何处理？](products/ecs/documents/billing-method-faqs.md)

- 

[新创建的包年包月实例在](products/ecs/documents/billing-method-faqs.md)[5](products/ecs/documents/billing-method-faqs.md)[天内转为按量付费，属于](products/ecs/documents/billing-method-faqs.md)[5](products/ecs/documents/billing-method-faqs.md)[天无理由退款吗？](products/ecs/documents/billing-method-faqs.md)

- 

[临时升级包年包月实例的带宽，计费方式是什么？](products/ecs/documents/billing-method-faqs.md)

### 按量付费转包年包月

- 

[按量付费转包年包月时下单失败如何处理？](products/ecs/documents/billing-method-faqs.md)

- 

[我有一个按量付费转包年包月订单，但是还没有支付，这时我升级了实例的配置，转换订单还有效吗？](products/ecs/documents/billing-method-faqs.md)

- 

[为什么无法将按量付费实例转为包年包月实例？](products/ecs/documents/billing-method-faqs.md)

## 节省停机模式问题

- 

[什么类型的](products/ecs/documents/billing-method-faqs.md)[ECS](products/ecs/documents/billing-method-faqs.md)[实例支持节省停机模式？](products/ecs/documents/billing-method-faqs.md)

- 

[打开默认启用节省停机模式后，是否支持单台](products/ecs/documents/billing-method-faqs.md)[ECS](products/ecs/documents/billing-method-faqs.md)[实例关机时不释放计算资源和网络资源？](products/ecs/documents/billing-method-faqs.md)

- 

[在](products/ecs/documents/billing-method-faqs.md)[ECS](products/ecs/documents/billing-method-faqs.md)[实例操作系统内关机能否触发节省停机效果？](products/ecs/documents/billing-method-faqs.md)

- 

[本地盘实例是否支持自动触发节省停机效果？](products/ecs/documents/billing-method-faqs.md)

- 

[ECS](products/ecs/documents/billing-method-faqs.md)[实例触发节省停机效果后，为什么立刻启动时会报错](products/ecs/documents/billing-method-faqs.md)[OperationConflict？](products/ecs/documents/billing-method-faqs.md)

- 

[ECS](products/ecs/documents/billing-method-faqs.md)[实例触发节省停机效果后，为什么](products/ecs/documents/billing-method-faqs.md)[StartInstance](products/ecs/documents/billing-method-faqs.md)[时会报错](products/ecs/documents/billing-method-faqs.md)[OperationDenied.NoStock？](products/ecs/documents/billing-method-faqs.md)

- 

[启用了节省停机模式后，停机再开机时公网](products/ecs/documents/billing-method-faqs.md)[IP](products/ecs/documents/billing-method-faqs.md)[会变化，怎么保持公网](products/ecs/documents/billing-method-faqs.md)[IP](products/ecs/documents/billing-method-faqs.md)[不变？](products/ecs/documents/billing-method-faqs.md)
...
实例为突发性能实例，开启了无性能约束模式，若实例超额使用了CPU积分，则会产生[额外积分费用](products/ecs/documents/user-guide/billing.md)。
...
如果您想将此类按量付费资源转为包年包月计费，请参见[转换计费方式](products/ecs/documents/change-the-billing-method.md)。
...
如需临时升级包年包月实例的带宽，请确保公网带宽计费方式为按固定带宽。具体操作，请参见[包年包月实例临时升级固定公网带宽（连续时间段）](products/ecs/documents/user-guide/temporary-bandwidth-upgrade.md)和[包年包月实例临时升级固定公网带宽（周期性）](products/ecs/documents/user-guide/temporary-upgrade-bandwidth-on-a-daily-basis.md)。
...
购买包年包月实例后，如果您继续使用了涉及后付费的服务，例如快照容量、按使用流量类型公网带宽等，将仍然会产生后付费账单。这类费用并未在购买包年包月实例时收取，因此，当您的账户不能支付后付费账单时会导致欠费。您可以查看消费明细，确认是否有后付费账单，具体操作，请参见[账单查询](products/ecs/documents/view-billing-details.md)。
...
欠费停机：指实例因账号欠费而自动停止服务，处于欠费停机状态的实例不计费。但账号欠费后，实例不会一直处于欠费停机状态，详情请参见[按量付费](products/ecs/documents/pay-as-you-go-1.md)。
...
启用节省停机模式：从创建开始计费，实例处于已停止状态时部分资源停止计费，实例启动后又重新计费。按量付费实例节省停机模式只适用于实例的计算资源（即vCPU和内存）和固定公网IP地址，但云盘、EIP等其它资源仍然正常计费。更多信息，请参见[节省停机模式](products/ecs/documents/user-guide/economical-mode.md)。
...
不变。按量付费转包年包月功能只支持转换实例和云盘的计费方式，带宽计费方式的变更方法请参见[升降配方式概述](products/ecs/documents/user-guide/overview-of-instance-configuration-changes.md)。
...
实例非[已停售的实例规格](products/ecs/documents/user-guide/retired-instance-types.md)或抢占式实例。
...
未若为实例设置了自动释放时间，须先[关闭自动释放设置](products/ecs/documents/user-guide/release-an-instance.md)。
...
更多信息，请参见[节省停机模式](products/ecs/documents/user-guide/economical-mode.md)。
...
ECS管理控制台。具体操作，请参见[停止实例](products/ecs/documents/user-guide/stop-an-instance.md)。

- 

通过阿里云CLI或SDK发起的API请求。更多信息，请参见[StopInstance](products/ecs/documents/api-stopinstance.md)。
...
[上一篇：计费](products/ecs/documents/billing-faqs.md)[下一篇：计费项](products/ecs/documents/billing-item-faqs.md)
