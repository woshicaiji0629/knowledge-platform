...
以在指定标签的ECS实例上执行云助手命令为例，具体操作，请参见[使用标签控制云助手命令的执行](products/ecs/documents/user-guide/control-the-executions-of-cloud-assistant-commands-based-on-tags.md)。
...
[使用标签对](products/ram/documents/use-cases/use-tags-to-grant-access-to-ecs-instances-by-group.md)[ECS](products/ram/documents/use-cases/use-tags-to-grant-access-to-ecs-instances-by-group.md)[实例进行分组授权](products/ram/documents/use-cases/use-tags-to-grant-access-to-ecs-instances-by-group.md)
...
使用标签对ECS实例进行分组并授权，以满足RAM用户只能查看和操作被授权资源的需求。具体操作，请参见[使用标签对](products/ram/documents/use-cases/use-tags-to-grant-access-to-ecs-instances-by-group.md)[ECS](products/ram/documents/use-cases/use-tags-to-grant-access-to-ecs-instances-by-group.md)[实例进行分组授权](products/ram/documents/use-cases/use-tags-to-grant-access-to-ecs-instances-by-group.md)。

- 

通过RAM的自定义策略指定授权的标签，利用标签限制RAM用户只能查看和管理指定的ECS实例。具体操作，请参见[使用标签限制](products/ram/documents/use-cases/use-tags-to-control-access-to-ecs-resources-1.md)[RAM](products/ram/documents/use-cases/use-tags-to-control-access-to-ecs-resources-1.md)[用户管理指定的](products/ram/documents/use-cases/use-tags-to-control-access-to-ecs-resources-1.md)[ECS](products/ram/documents/use-cases/use-tags-to-control-access-to-ecs-resources-1.md)[实例](products/ram/documents/use-cases/use-tags-to-control-access-to-ecs-resources-1.md)。
...
您还可以通过资源组根据资源的用途、权限和归属等维度对您拥有的云资源进行分组，从而实现企业内部多用户、多项目的资源分级管理。更多信息，请参见[什么是资源组](https://help.aliyun.com/zh/resource-management/resource-group/product-overview/resource-group-overview)或[资源组](products/ecs/documents/user-guide/resource-groups.md)。

- 

调用接口[创建并绑定标签](products/ecs/documents/developer-reference/api-ecs-2014-05-26-tagresources.md)。

- 

调用接口[查询资源已经绑定的标签列表](products/ecs/documents/developer-reference/api-ecs-2014-05-26-listtagresources.md)。

- 

调用接口[为指定资源列表统一解绑标签](products/ecs/documents/developer-reference/api-ecs-2014-05-26-untagresources.md)。

- 

调用接口[将一个](products/ecs/documents/developer-reference/api-ecs-2014-05-26-joinresourcegroup.md)[ECS](products/ecs/documents/developer-reference/api-ecs-2014-05-26-joinresourcegroup.md)[资源或者服务加入一个资源组](products/ecs/documents/developer-reference/api-ecs-2014-05-26-joinresourcegroup.md)。

[上一篇：标签与资源](products/ecs/documents/user-guide/tags-and-resources.md)[下一篇：资源](products/ecs/documents/user-guide/resources.md)
