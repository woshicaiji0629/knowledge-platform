...
下载后需[在阿里云客户端配置登录身份凭证](products/ecs/documents/user-guide/add-one-or-more-accounts-to-alibaba-cloud-client.md)，用于管理该账号下的资源。
...
[通过阿里云客户端管理](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-ecs-instances.md)[ECS](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-ecs-instances.md)[实例](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-ecs-instances.md)

- 

[通过阿里云客户端管理](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-elastic-container-instances.md)[ECI](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-elastic-container-instances.md)[容器实例](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-elastic-container-instances.md)

- 

[通过阿里云客户端管理轻量应用服务器](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-simple-application-servers.md)

- 

[通过阿里云客户端管理托管实例](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-managed-instances.md)

- 

（可选）根据实际需要灵活[配置阿里云客户端](products/ecs/documents/user-guide/use-alibaba-cloud-client.md)（包括本地终端和SSH的系统设置）。

[上一篇：图说阿里云客户端](products/ecs/documents/user-guide/illustration-of-alibaba-cloud-client.md)[下一篇：在阿里云客户端配置登录身份凭证](products/ecs/documents/user-guide/add-one-or-more-accounts-to-alibaba-cloud-client.md)
