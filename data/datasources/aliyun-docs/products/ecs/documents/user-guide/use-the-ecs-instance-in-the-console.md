...
MYSQL_PASSWORD：填写为[上一步](products/ecs/documents/user-guide/use-the-ecs-instance-in-the-console.md)设置的MySQL密码。
...
编辑wp-config.php，将WORDPRESS_PASSWORD替换为设置的[WordPress 用户密码](products/ecs/documents/user-guide/use-the-ecs-instance-in-the-console.md)。
...
[重置实例登录密码](products/ecs/documents/user-guide/reset-the-logon-password-of-an-instance.md)
...
[搭建](products/ecs/documents/user-guide/manually-build-an-ftp-site-on-a-linux-instance.md)[FTP](products/ecs/documents/user-guide/manually-build-an-ftp-site-on-a-linux-instance.md)[站点（Linux）](products/ecs/documents/user-guide/manually-build-an-ftp-site-on-a-linux-instance.md)上传WordPress主题或者插件。

- 

直接使用IP地址访问网站不专业且不安全，建议为网站[绑定域名并启用](products/ecs/documents/user-guide/manually-build-a-wordpress-website-on-a-centos-7-ecs-instance.md)[HTTPS](products/ecs/documents/user-guide/manually-build-a-wordpress-website-on-a-centos-7-ecs-instance.md)[加密](products/ecs/documents/user-guide/manually-build-a-wordpress-website-on-a-centos-7-ecs-instance.md)。

- 

[手动部署](products/ecs/documents/user-guide/deploy-the-lnmp-environment.md)[LNMP](products/ecs/documents/user-guide/deploy-the-lnmp-environment.md)[环境](products/ecs/documents/user-guide/deploy-the-lnmp-environment.md)。
...
通过ROS，云市场镜像或Terraform[快速搭建](products/ecs/documents/user-guide/quickly-build-a-wordpress-website.md)[WordPress](products/ecs/documents/user-guide/quickly-build-a-wordpress-website.md)。

- 

[在](products/ecs/documents/user-guide/install-and-use-docker.md)[Docker](products/ecs/documents/user-guide/install-and-use-docker.md)[中部署](products/ecs/documents/user-guide/install-and-use-docker.md)[WordPress](products/ecs/documents/user-guide/install-and-use-docker.md)。

- 

在宝塔面板中安装WordPress，请参见[手动部署宝塔面板](products/ecs/documents/user-guide/deploy-bt-panel-for-linux.md)。

[上一篇：控制台购买Linux实例并部署宝塔面板](products/ecs/documents/user-guide/purchase-a-linux-instance-and-deploy-bt-panel-from-the-console.md)[下一篇：免费试用指南](products/ecs/documents/user-guide/ecs-free-trial-kit-series.md)
