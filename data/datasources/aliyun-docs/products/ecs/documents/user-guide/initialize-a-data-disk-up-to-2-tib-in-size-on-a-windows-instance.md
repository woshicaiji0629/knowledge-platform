...
已[创建空数据盘](products/ecs/documents/user-guide/create-a-disk.md)。
...
若弹出初始化磁盘对话框，表示云盘已联机。可直接[初始化云盘](products/ecs/documents/user-guide/initialize-a-data-disk-up-to-2-tib-in-size-on-a-windows-instance.md)。若数据盘已联机且分区状态良好，无需其余操作，可直接使用。
...
若磁盘显示没有初始化，目标分区显示未分配，需要[初始化](products/ecs/documents/user-guide/initialize-a-data-disk-up-to-2-tib-in-size-on-a-windows-instance.md)后才可存储数据。
...
当云盘使用空间不足时，可以[扩容云盘](products/ecs/documents/user-guide/resize-windows-cloud-disks.md)容量增加云盘存储空间。

- 

若想为Linux实例初始化数据盘，请参考[初始化数据盘（Linux）](products/ecs/documents/user-guide/initialize-a-data-disk-whose-size-does-not-exceed-2-tib-on-a-linux-instance.md)。

[上一篇：初始化数据盘（Linux）](products/ecs/documents/user-guide/initialize-a-data-disk-whose-size-does-not-exceed-2-tib-on-a-linux-instance.md)[下一篇：更换系统盘（更换操作系统）](products/ecs/documents/user-guide/replace-the-operating-system-of-an-instance-1.md)
