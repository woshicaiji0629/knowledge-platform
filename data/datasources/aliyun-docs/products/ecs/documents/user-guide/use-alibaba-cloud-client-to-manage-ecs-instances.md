...
[配置阿里云客户端身份凭证](products/ecs/documents/user-guide/add-one-or-more-accounts-to-alibaba-cloud-client.md)后，可免密、免公网连接并管理ECS实例。可通过端口转发实现在本地安全访问实例上部署的服务。
...
使用会话管理连接ECS实例前，需[确保会话管理已开启](products/ecs/documents/user-guide/connect-to-an-instance-by-using-session-manager-1.md)。
...
在ECS控制台[创建密钥对](products/ecs/documents/user-guide/ssh-key-pairs.md)（.pem文件），并绑定到ECS实例。

- 

[手动绑定密钥对](products/ecs/documents/user-guide/bind-a-key-pair-to-enable-ssh-passwordless-logon.md)，并绑定到ECS实例。
...
若按量付费实例承载了关键业务，可[开启实例释放保护](products/ecs/documents/user-guide/enable-or-disable-release-protection-for-ecs-instances.md)，防止被意外释放。
...
填写详细的规则信息。参数信息 ，请参见[安全组规则](products/ecs/documents/user-guide/security-group-rules.md)。
...
通过客户端可在ECS实例与OSS Bucket间[互传文件](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-ecs-instances.md)。
...
实例一旦释放，数据将无法恢复。释放实例前，请确认数据是否需要保留。如需保留，可[创建快照](products/ecs/documents/user-guide/create-a-snapshot.md)来备份数据。
...
在客户端查看监控数据前需要先[为登录的](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)[RAM](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)[用户授予](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)[AliyunCloudMonitorMetricDataReadOnlyAccess](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)权限。
...
需要先为[登录的](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)[RAM](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)[用户授予](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)[AliyunOSSFullAccess](products/ram/documents/user-guide/grant-permissions-to-the-ram-user.md)的权限。
...
该功能依赖云助手在实例内部正常运行。自2017年12月1日起，通过公共镜像创建的ECS实例已预装云助手Agent，若实例未安装云助手请[手动安装云助手](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)[Agent](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)。

[上一篇：在阿里云客户端配置登录身份凭证](products/ecs/documents/user-guide/add-one-or-more-accounts-to-alibaba-cloud-client.md)[下一篇：通过阿里云客户端管理ECI容器实例](products/ecs/documents/user-guide/use-alibaba-cloud-client-to-manage-elastic-container-instances.md)
