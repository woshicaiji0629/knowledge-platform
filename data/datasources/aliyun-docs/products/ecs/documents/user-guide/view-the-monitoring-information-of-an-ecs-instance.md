...
Linux实例请参见[Linux](products/ecs/documents/support/query-and-case-analysis-linux-cpu-load.md)[系统](products/ecs/documents/support/query-and-case-analysis-linux-cpu-load.md)[CPU](products/ecs/documents/support/query-and-case-analysis-linux-cpu-load.md)[负载的查询和案例分析](products/ecs/documents/support/query-and-case-analysis-linux-cpu-load.md)。

- 

Windows实例请参见[Windows](products/ecs/documents/what-do-i-do-if-cpu-utilization-is-high-on-a-windows-instance.md)[实例中](products/ecs/documents/what-do-i-do-if-cpu-utilization-is-high-on-a-windows-instance.md)[CPU](products/ecs/documents/what-do-i-do-if-cpu-utilization-is-high-on-a-windows-instance.md)[使用率较高问题的排查及解决方法](products/ecs/documents/what-do-i-do-if-cpu-utilization-is-high-on-a-windows-instance.md)。
...
[DescribeInstanceMonitorData](products/ecs/documents/api-describeinstancemonitordata.md)

- 

[DescribeDiskMonitorData](products/ecs/documents/api-describediskmonitordata.md)

- 

[DescribeEniMonitorData](products/ecs/documents/api-describeenimonitordata.md)

[上一篇：状态和报警](products/ecs/documents/user-guide/status-and-alerts.md)[下一篇：设置ECS实例报警规则](products/ecs/documents/user-guide/configure-alerts-for-an-ecs-instance.md)
