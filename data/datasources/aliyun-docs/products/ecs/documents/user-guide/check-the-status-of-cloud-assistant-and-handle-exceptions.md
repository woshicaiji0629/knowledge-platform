...
手动安装云助手Agent，具体操作，请参见[安装云助手](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)[Agent](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)。

在 ECS 云助手控制台的实例列表中，若目标实例的云助手状态列显示为未安装，可单击对应的一键安装按钮完成安装。

- 

异常：出现异常的原因较多，需要根据具体原因来分析。更多信息，请参见[云助手异常状态处理](products/ecs/documents/user-guide/check-the-status-of-cloud-assistant-and-handle-exceptions.md)。

在ECS 云助手控制台的ECS实例页签中，实例列表的云助手状态列会展示各实例的云助手运行状态，状态为异常时以黄色图标标识。

## API

调用[DescribeCloudAssistantStatus](products/ecs/documents/developer-reference/api-ecs-2014-05-26-describecloudassistantstatus.md)，返回参数中"CloudAssistantStatus": "true"代表云助手状态正常，如果状态异常，请参见[云助手异常状态处理](products/ecs/documents/user-guide/check-the-status-of-cloud-assistant-and-handle-exceptions.md)。
...
如果aliyun-assist文件夹存在，请继续执行步骤[3](products/ecs/documents/user-guide/check-the-status-of-cloud-assistant-and-handle-exceptions.md)。

- 

如果aliyun-assist文件夹不存在，说明云助手被卸载，需要重新[安装云助手](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)[Agent](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)。
...
如果启动时报错或无法启动，请卸载云助手后重新安装。具体操作，请参见[停止和卸载云助手](products/ecs/documents/user-guide/stop-and-uninstall-the-cloud-assistant-agent.md)[Agent](products/ecs/documents/user-guide/stop-and-uninstall-the-cloud-assistant-agent.md)和[安装云助手](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)[Agent](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)。
...
当云助手状态为active (running)，说明云助手服务正常运行中，请继续执行步骤[4](products/ecs/documents/user-guide/check-the-status-of-cloud-assistant-and-handle-exceptions.md)。
...
当云助手状态为start/running，说明云助手服务正常运行中，请继续执行步骤[4](products/ecs/documents/user-guide/check-the-status-of-cloud-assistant-and-handle-exceptions.md)。
...
当云助手状态为Running，说明云助手服务正常运行中，请继续执行步骤[4](products/ecs/documents/user-guide/check-the-status-of-cloud-assistant-and-handle-exceptions.md)。
...
如果assist文件夹存在，请继续执行[步骤](products/ecs/documents/user-guide/check-the-status-of-cloud-assistant-and-handle-exceptions.md)[3](products/ecs/documents/user-guide/check-the-status-of-cloud-assistant-and-handle-exceptions.md)。

- 

如果assist文件夹不存在，说明云助手被卸载，需要重新安装云助手，具体操作，请参见[安装云助手](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)[Agent](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)。
...
请将<region-id>替换为地域的ID。更多信息，请参见[地域和可用区](products/ecs/documents/user-guide/regions-and-zones.md)。
...
若不能解析或者不能正常返回实例ID，则说明实例网络存在问题，需要进行排查。具体操作，请参见[配置云助手](products/ecs/documents/user-guide/configure-network-permissions-for-the-cloud-assistant-agent.md)[Agent](products/ecs/documents/user-guide/configure-network-permissions-for-the-cloud-assistant-agent.md)[网络权限](products/ecs/documents/user-guide/configure-network-permissions-for-the-cloud-assistant-agent.md)。
...
出现该错误是由于托管实例上的时间戳和实际时间有误差导致，可以尝试校准ECS实例时间解决。更多信息，请参见[手动同步时间](products/ecs/documents/user-guide/alibaba-cloud-ntp-server.md)。

## 相关文档

您可以通过[ListPluginStatus](products/ecs/documents/developer-reference/api-ecs-2014-05-26-listpluginstatus.md)来查询实例中云助手插件的状态。同时，您也可以在接口的返回信息中，查看云助手第一次上报插件状态的时间（FirstHeartbeatTime参数）和云助手最近一次上报插件状态的时间（LastHeartbeatTime参数）。

[上一篇：安装云助手Agent](products/ecs/documents/user-guide/install-the-cloud-assistant-agent.md)[下一篇：停止和卸载云助手Agent](products/ecs/documents/user-guide/stop-and-uninstall-the-cloud-assistant-agent.md)
