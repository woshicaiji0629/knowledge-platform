...
使用资源组管理ECS资源的具体操作，请参见[使用资源组限制](products/ram/documents/use-cases/use-a-resource-group-to-manage-an-ecs-instance.md)[RAM](products/ram/documents/use-cases/use-a-resource-group-to-manage-an-ecs-instance.md)[用户管理指定的](products/ram/documents/use-cases/use-a-resource-group-to-manage-an-ecs-instance.md)[ECS](products/ram/documents/use-cases/use-a-resource-group-to-manage-an-ecs-instance.md)[实例](products/ram/documents/use-cases/use-a-resource-group-to-manage-an-ecs-instance.md)。
...
您也可以使用标签对ECS资源进行分类，实现资源的精细化管理。更多信息，请参见[标签](products/ecs/documents/user-guide/label-overview.md)。

- 

您可以调用[JoinResourceGroup](products/ecs/documents/developer-reference/api-ecs-2014-05-26-joinresourcegroup.md)接口将一个ECS资源或者服务加入一个资源组。

[上一篇：概述](products/ecs/documents/user-guide/overview-47.md)[下一篇：ECS配额管理](products/ecs/documents/user-guide/quota-management.md)
