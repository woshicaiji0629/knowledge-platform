...
目前仅g7t、c7t或r7t实例规格族支持SGX功能。更多信息，请参见[实例规格族](products/ecs/documents/user-guide/overview-of-instance-families.md)。
...
执行如下命令，自动化完成/etc/sgx_default_qcnl.conf文件的配置。更多命令信息，请参见[实例元数据](products/ecs/documents/user-guide/view-instance-metadata.md)。
...
[上一篇：机密计算解决方案](products/ecs/documents/user-guide/confidential-computing-solutions.md)[下一篇：构建TDX机密计算环境](products/ecs/documents/user-guide/build-a-tdx-confidential-computing-environment.md)
