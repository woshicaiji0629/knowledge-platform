...
在弹性网卡创建完成后，您可以将其绑定至同一VPC内的同一可用区的ECS实例上。具体操作，请参见[创建并使用弹性网卡](products/ecs/documents/user-guide/create-and-use-an-eni.md)。
...
[上一篇：通过Terraform创建并使用ECS实例](products/ecs/documents/developer-reference/create-and-use-an-ecs-instance-by-using-terraform.md)[下一篇：ROS参考](products/ecs/documents/developer-reference/ros-reference.md)
