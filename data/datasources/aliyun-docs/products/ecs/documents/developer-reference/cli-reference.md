...
调用[DescribeInstances](products/ecs/documents/developer-reference/api-ecs-2014-05-26-describeinstances.md)，通过<实例ID>获取实例的公网IP信息。
...
[上一篇：CLI参考](products/ecs/documents/developer-reference/create-and-manage-an-ecs-instance-by-using-cli-commands.md)[下一篇：Terraform参考](products/ecs/documents/developer-reference/terraform.md)
