# 文件管理-大模型服务平台百炼(Model Studio)-阿里云帮助中心
...
[上一篇：删除导入任务](products/model-studio/documents/delete-import-job-api.md)[下一篇：文件对象](products/model-studio/documents/file-object-api.md)
