...
运行代码前，请[配置](products/model-studio/documents/first-api-call-to-qwen.md)[API Key](products/model-studio/documents/first-api-call-to-qwen.md)[到环境变量](products/model-studio/documents/first-api-call-to-qwen.md)并[安装最新版](products/model-studio/documents/install-sdk.md)[SDK](products/model-studio/documents/install-sdk.md)。
...
DashScope Python SDK 支持通过传入自定义 Session 实现连接复用，提供[HTTP](products/model-studio/documents/connection-multiplexing-configuration.md)[异步](products/model-studio/documents/connection-multiplexing-configuration.md)（协程）和[HTTP](products/model-studio/documents/connection-multiplexing-configuration.md)[同步](products/model-studio/documents/connection-multiplexing-configuration.md)两种调用方式。
...
如果模型调用失败并返回报错信息，请参见[错误码](products/model-studio/documents/error-code.md)进行解决。

[上一篇：上传文件获取临时URL](products/model-studio/documents/get-temporary-file-url.md)[下一篇：API参考（应用）](products/model-studio/documents/applicantion-api-reference.md)
