...
如果实例的引擎版本不满足要求，您可以评估业务后升级实例的引擎版本，详情请参见[升级大版本](products/redis/documents/user-guide/upgrade-the-major-version-1.md)。
...
| 配置 | 说明 |
| --- | --- |
| 账号类型 | 本地账号 ：表示您需要额外记录该账号口令，或在应用代码中通过明文配置数据库账号口令。 KMS 托管账号 ：通过 [KMS](products/kms/documents/key-management-service/product-overview/what-is-key-management-service-1.md) 托管实例的账号密码，应用程序将无需配置静态数据库账号口令，应用程序访问实例时，调用相关 KMS 接口获取实例账号和口令信息，更多信息请参见 [通过](products/redis/documents/use-cases/use-kms-to-manage-redis-credentials.md) [KMS](products/redis/documents/use-cases/use-kms-to-manage-redis-credentials.md) [托管实例密码凭证](products/redis/documents/use-cases/use-kms-to-manage-redis-credentials.md) 。 |
| 账号 | 账号名需满足以下条件： 以英文字母开头，由小写英文字母、数字或下划线（_）组成。 长度不超过 35 个字符。 不能为 [Redis](products/redis/documents/user-guide/create-and-manage-database-accounts.md) [账号名保留字](products/redis/documents/user-guide/create-and-manage-database-accounts.md) 。 |
...
新建账号的密码格式为user:password，例如新建账号为testaccount，密码为Rp829dlwa，实例的登录密码需填写为testaccount:Rp829dlwa，更多信息请参见[实例的登录方式](products/redis/documents/user-guide/logon-methods.md)。
...
| API 接口 | 说明 |
| --- | --- |
| [CreateAccount](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-createaccount-redis.md) | 在实例中创建有特定权限的账号。 |
| [GrantAccountPrivilege](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-grantaccountprivilege-redis.md) | 修改实例中账号的权限。 |
| [ModifyAccountDescription](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-modifyaccountdescription-redis.md) | 修改实例中账号的描述。 |
| [ModifyAccountPassword](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-modifyaccountpassword-redis.md) | 修改实例中指定账号的密码。 |
| [DeleteAccount](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-deleteaccount-redis.md) | 删除实例中的指定账号。 |
...
[上一篇：账号与安全](products/redis/documents/user-guide/security-management.md)[下一篇：修改或重置密码](products/redis/documents/user-guide/change-or-reset-the-password.md)
