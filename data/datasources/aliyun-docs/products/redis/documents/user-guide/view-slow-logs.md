...
参数设置方法请参见[设置实例参数](products/redis/documents/user-guide/modify-the-values-of-parameters-for-an-instance.md)。
...
集群架构与读写分离架构实例的连接数据库的主机地址默认为Proxy IP地址，若您希望获取具体的客户端IP地址，可在参数设置中将ptod_enabled参数设置为1，具体操作请参见[设置实例参数](products/redis/documents/user-guide/modify-the-values-of-parameters-for-an-instance.md)。
...
| API | 说明 |
| --- | --- |
| [DescribeSlowLogRecords - 查看慢日志明细](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-describeslowlogrecords-redis.md) | 查询实例在指定时间内产生的慢日志。 |


## 相关文档

[使用慢日志排查超时问题](products/redis/documents/user-guide/use-slow-logs-to-troubleshoot-timeout-issues.md)

[上一篇：订阅审计日志报表](products/redis/documents/user-guide/subscribe-to-audit-log-reports.md)[下一篇：查询运行日志](products/redis/documents/user-guide/view-active-logs.md)
