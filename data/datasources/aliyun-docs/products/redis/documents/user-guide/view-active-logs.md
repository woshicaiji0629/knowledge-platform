# 在控制台查询实例运行日志-云数据库 Tair（兼容 Redis®）-阿里云

Source: https://help.aliyun.com/zh/redis/user-guide/view-active-logs
...
在控制台的日志管理中，您可以查看72小时内的运行日志，寻找解决运维问题的线索。

## 注意事项

Redis开源版2.8版本、Redis倚天版、Tair（企业版）内存型（兼容Redis 6.0）与磁盘型实例暂不支持查询运行日志。
...
| API | 说明 |
| --- | --- |
| [DescribeRunningLogRecords](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-describerunninglogrecords-redis.md) | 查询实例的运行日志。 |


[上一篇：查询慢日志](products/redis/documents/user-guide/view-slow-logs.md)[下一篇：使用慢日志排查超时问题](products/redis/documents/user-guide/use-slow-logs-to-troubleshoot-timeout-issues.md)
