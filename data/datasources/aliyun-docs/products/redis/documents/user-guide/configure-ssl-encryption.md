...
2023年4月07日云数据库 Tair（兼容 Redis）将SSL加密功能升级为TLS加密功能，同时不再支持开通SSL加密功能。若您已开通SSL加密功能，您可以继续使用也可以关闭SSL，但关闭后无法再次开启，更多信息请参见[【通知】SSL](products/redis/documents/product-overview/encryption-upgrade-from-ssl-to-tls.md)[功能升级至](products/redis/documents/product-overview/encryption-upgrade-from-ssl-to-tls.md)[TLS](products/redis/documents/product-overview/encryption-upgrade-from-ssl-to-tls.md)[功能](products/redis/documents/product-overview/encryption-upgrade-from-ssl-to-tls.md)。
...
A：您需要将实例的小版本升级至最新，具体操作请参见[升级小版本与代理版本](products/redis/documents/user-guide/update-the-minor-version.md)。
...
| API | 说明 |
| --- | --- |
| [ModifyInstanceSSL](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-modifyinstancessl-redis.md) | 设置实例的 SSL 加密功能。 |


[上一篇：开启TLS加密](products/redis/documents/user-guide/enable-tls-encryption.md)[下一篇：开启透明数据加密TDE](products/redis/documents/user-guide/enable-tde.md)
