...
除非特别说明，实例内核的小版本均会确保兼容性，因此您无需担心升级可能带来的兼容型问题，更多信息请参见[Tair](products/redis/documents/support/apsaradb-for-redis-enhanced-edition-1.md)[小版本发布日志](products/redis/documents/support/apsaradb-for-redis-enhanced-edition-1.md)、[Redis](products/redis/documents/support/apsaradb-for-redis-community-edition.md)[开源版小版本发布日志](products/redis/documents/support/apsaradb-for-redis-community-edition.md)与[Proxy](products/redis/documents/support/apsaradb-for-redis-proxy-nodes.md)[小版本发布日志](products/redis/documents/support/apsaradb-for-redis-proxy-nodes.md)。
...
A：不会立即升级。系统会周期性检查版本发布状态，如发现新版本则将在60天内的可升级时间段内进行自动升级。如遇特殊情况需延后升级，例如近期同一账号下运维事件过多则需要顺延等待。您可以在[事件中心](products/redis/documents/user-guide/query-and-manage-pending-events.md)查询升级计划，也可以立即执行手动升级。
...
| API | 说明 |
| --- | --- |
| [DescribeEngineVersion](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-describeengineversion-redis.md) | 查询实例的大版本和小版本信息，同时可查询到小版本的发布日志信息。 |
| [ModifyInstanceMinorVersion](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-modifyinstanceminorversion-redis.md) | 升级实例的小版本。 |


[上一篇：升级大版本](products/redis/documents/user-guide/upgrade-the-major-version-1.md)[下一篇：释放按量付费实例](products/redis/documents/user-guide/release-pay-as-you-go-instances.md)
