...
低版本实例可在升级小版本后使用该功能，更多信息请参见[升级小版本与代理版本](products/redis/documents/user-guide/update-the-minor-version.md)。
...
[上一篇：设置可维护时段](products/redis/documents/user-guide/set-a-maintenance-window.md)[下一篇：导出实例列表](products/redis/documents/user-guide/export-the-instance-list.md)
