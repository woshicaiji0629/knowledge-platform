...
如需创建用于生产环境的实例，您可以在[选型必读文档](products/redis/documents/product-overview/select-an-apsaradb-for-redis-instance.md)中选择、评估满足业务需求的实例规格。本示例旨在帮助您快速入门，仅需设置关键参数即可完成创建。
...
若您已创建[云服务器](products/ecs/documents/user-guide/what-is-ecs.md)[ECS](products/ecs/documents/user-guide/what-is-ecs.md)，推荐选择ECS所在地域与可用区。
...
下一步，请设置实例的IP白名单，更多信息请参见[步骤](products/redis/documents/getting-started/step-2-configure-whitelists.md)[2：设置白名单](products/redis/documents/getting-started/step-2-configure-whitelists.md)。

## 相关文档

若您希望创建其他架构、规格实例，您可根据控制台界面提示进行配置，更多参数介绍请参见[基本概念](products/redis/documents/product-overview/terms.md)。
...
A：可以，Tair实例支持升级、降级配置，同时也支持变更实例架构，例如从标准架构变更为集群架构。更多信息请参见[变更实例配置](products/redis/documents/user-guide/change-the-configurations-of-an-instance.md)。
...
| API | 说明 |
| --- | --- |
| [CreateInstance](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-createinstance-redis.md) | 创建一个 Redis 开源版 或 Tair 内存型经典版实例。 |
| [CreateTairInstance](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-createtairinstance-redis.md) | 创建 Tair 云原生 版实例。 |


[上一篇：快速入门概览](products/redis/documents/getting-started/overview.md)[下一篇：步骤2：设置白名单](products/redis/documents/getting-started/step-2-configure-whitelists.md)
