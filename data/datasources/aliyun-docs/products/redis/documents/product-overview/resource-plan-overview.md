...
关于如何购买按量付费实例和资源包，请参见[创建实例](products/redis/documents/getting-started/step-1-create-an-apsaradb-for-redis-instance.md)和[购买资源包](products/redis/documents/product-overview/purchase-a-resource-plan.md)。

- 

关于如何查看资源包的抵扣情况，请参见[查看资源包抵扣情况](products/redis/documents/product-overview/view-fees-offset-by-resource-plans.md)。
...
[上一篇：计费方式](products/redis/documents/product-overview/billing-methods.md)[下一篇：购买资源包](products/redis/documents/product-overview/purchase-a-resource-plan.md)
