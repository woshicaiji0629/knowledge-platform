...
Tair Serverless KVRedis兼容版实例为分布式集群架构，兼容Redis开源版6.0，更多信息请参见[Redis](products/redis/documents/product-overview/commands-supported-by-tair-serverless-kv-instances.md)[兼容版命令支持](products/redis/documents/product-overview/commands-supported-by-tair-serverless-kv-instances.md)。以下为架构图和组件说明。
...
当实例流量超出限流阈值时，超出部分将被限流，限流行为默认为排队等待（与传统Redis行为一致），可选返回错误，更多信息请参考[客户端限流处理](products/redis/documents/product-overview/best-practices-in-client-side-throttling.md)。
...
Tair Serverless KV的费用主要包含两部分：计算资源费用 (RCU/WCU)和存储空间费用。[Tair Serverless KV](products/redis/documents/product-overview/billing-for-tair-serverless-kv.md)[计费说明](products/redis/documents/product-overview/billing-for-tair-serverless-kv.md)
...
[设置白名单](products/redis/documents/getting-started/step-2-configure-whitelists.md)

- 

[连接](products/redis/documents/product-overview/connect-to-a-tair-serverless-kv-instance.md)[Redis](products/redis/documents/product-overview/connect-to-a-tair-serverless-kv-instance.md)[兼容版实例](products/redis/documents/product-overview/connect-to-a-tair-serverless-kv-instance.md)
...
| 类别 | 实施方案 | 说明 |
| --- | --- | --- |
| 数据备份 | [自动或手动备份](products/redis/documents/user-guide/automatic-or-manual-backup.md) | 实例会按照默认的策略自动备份数据，您可以根据业务需求修改自动备份策略，也可以手动发起备份。 |
| 数据恢复 | [从备份集恢复至新实例](products/redis/documents/user-guide/restore-data-from-a-backup-set-to-a-new-instance.md) | 支持从指定的备份集创建新实例，新实例中的数据将和该备份集中的数据一致，可用于数据恢复、快速部署业务或数据验证等场景。 |
...
[上一篇：Tair Serverless KV](products/redis/documents/product-overview/serverless-kv.md)[下一篇：Redis兼容版命令支持](products/redis/documents/product-overview/commands-supported-by-tair-serverless-kv-instances.md)
