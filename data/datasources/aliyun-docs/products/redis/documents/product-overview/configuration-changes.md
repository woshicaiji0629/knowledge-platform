...
变更分片的内存规格，变更经典部署实例的架构、分片数和只读节点数，请参见[变更实例配置](products/redis/documents/user-guide/change-the-configurations-of-an-instance.md)。

- 

云原生集群架构的实例，增加或减少集群的分片数，请参见[调整集群分片数](products/redis/documents/user-guide/adjust-the-number-of-cluster-shards.md)。

- 

云原生实例开启读写分离功能，请参见[开启读写分离](products/redis/documents/user-guide/enable-read-write-splitting.md)。

[上一篇：续费实例](products/redis/documents/product-overview/renewal.md)[下一篇：退款说明](products/redis/documents/product-overview/refunds.md)
