...
A：可能是实例未释放经典网络连接地址，该实例仍存在相关限制。请释放经典网络连接地址后重试。更多信息请参见[【通知】云数据库 Tair（兼容 Redis）下线经典网络](products/redis/documents/product-overview/notice-apsaradb-for-redis-instances-deployed-in-classic-network-discontinued.md)。

## 相关API

| API | 说明 |
| --- | --- |
| [RenewInstance](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-renewinstance-redis.md) | 为实例续费。 |
| [ModifyInstanceAutoRenewalAttribute](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-modifyinstanceautorenewalattribute-redis.md) | 调用该 API 可以开启或关闭实例的自动续费功能。 |
| [DescribeInstanceAutoRenewalAttribute](products/redis/documents/developer-reference/api-r-kvstore-2015-01-01-describeinstanceautorenewalattribute-redis.md) | 调用该 API 可以查看实例的自动续费详情。 |


[上一篇：到期与欠费](products/redis/documents/product-overview/expiration-and-overdue-payments.md)[下一篇：变配说明](products/redis/documents/product-overview/configuration-changes.md)
