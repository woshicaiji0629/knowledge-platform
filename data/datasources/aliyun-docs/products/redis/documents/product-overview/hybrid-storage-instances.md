...
混合存储型已停止售卖，更多信息，请参见[【通知】Redis](products/redis/documents/product-overview/end-of-sale-for-apsaradb-for-redis-hybrid-storage-instances.md)[混合存储型实例停止售卖](products/redis/documents/product-overview/end-of-sale-for-apsaradb-for-redis-hybrid-storage-instances.md)。推荐选择[持久内存型](products/redis/documents/product-overview/persistent-memory-optimized-instances-1.md)实例。
...
[上一篇：磁盘型](products/redis/documents/product-overview/essd-based-instances-1.md)[下一篇：产品架构](products/redis/documents/product-overview/product-architecture.md)
