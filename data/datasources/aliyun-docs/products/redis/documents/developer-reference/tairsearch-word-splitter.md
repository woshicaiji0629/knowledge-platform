...
| --- | --- | --- | --- |
| [Standard](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Stop](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Jieba](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [IK](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Pattern](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Whitespace](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Simple](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Keyword](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Language](products/redis/documents/developer-reference/tairsearch-word-splitter.md) | [Mapping](products/redis/documents/developer-reference/tairsearch-word-splitter.md) | [Whitespace Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Standard Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Classic Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Letter Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [LowerCase Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Keyword Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Jieba Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Pattern Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [IK Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) | [Classic Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Elision Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [LowerCase Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Snowball Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Stop Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Asciifolding Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Length Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Normalization Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) |
...
Tokenizer（分词器）：[Standard Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。

- 

Token Filter（词元过滤器）：[LowerCase Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md)和[Stop Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。
...
Tokenizer：[LowerCase Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。

- 

Token Filter：[Stop Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。
...
Tokenizer：[Jieba Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。

- 

Token Filter：[LowerCase Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md)和[Stop Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。
...
Tokenizer：[IK Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。
...
Tokenizer：[Pattern Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。
...
Tokenizer：[Whitespace Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。
...
Tokenizer：[Keyword Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。
...
stopwords：停用词，分词器会过滤这些词。配置时，停用词词典必须是一个数组，每个停用词必须是字符串，配置停用词后会覆盖默认停用词。各语言的默认停用词请参见[附录](products/redis/documents/developer-reference/tairsearch-word-splitter.md)[4：内置分词器](products/redis/documents/developer-reference/tairsearch-word-splitter.md)[Language](products/redis/documents/developer-reference/tairsearch-word-splitter.md)[各语言的默认停用词（Stopwords）](products/redis/documents/developer-reference/tairsearch-word-splitter.md)。
...
| char_filter （可选） | 字符过滤器，在开始 Tokenizer 流程前，对文档进行预处理，默认为空，表示不进行预处理，当前仅支持 Mapping。 参数说明： type （必填）：固定为 mapping ，更多信息请参见 [附录](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [1：支持的](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Character Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) 。 |
| tokenizer （必选） | 分词器，必选且只能选择一个，取值为： whitespace 、 lowercase 、 standard 、 classic 、 letter 、 keyword 、 jieba 、 pattern 、 ik_max_word 和 ik_smart ，更多信息请参见 [附录](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [2：支持的](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Tokenizer](products/redis/documents/developer-reference/tairsearch-word-splitter.md) 。 |
| filter （可选） | 词元过滤器，对 Token（Tokenizer 的结果）进行处理，例如删除停用词、将词元转换为小写等，支持多选，默认为空，表示不进行处理。 取值为： classic 、 elision 、 lowercase 、 snowball 、 stop 、 asciifolding 、 length 、 arabic_normalization 和 persian_normalization ，更多信息请参见 [附录](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [3：支持的](products/redis/documents/developer-reference/tairsearch-word-splitter.md) [Token Filter](products/redis/documents/developer-reference/tairsearch-word-splitter.md) 。 |
...
[上一篇：Search](products/redis/documents/developer-reference/tairsearch.md)[下一篇：Vector](products/redis/documents/developer-reference/tairvector.md)
